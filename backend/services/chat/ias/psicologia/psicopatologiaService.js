...
class BraveSearchOrchestrator {
  ...
  calculatePsychologyQuality(result) {
    ...
    const trustedDomains = [
      ...
      'collegepsychology.com', 'simplypsychology.org'
    ];
    ...
    const psychologyTerms = ['psicopatología', 'dsm-5', 'cie-11', 'diagnóstico', 'trastorno', 'síntoma', 'síndrome', 'psiquiatría', 'psicología clínica', 'evaluación psicológica', 'psychopathology', 'psychology', 'mental health', 'psychiatric', 'clinical', 'disorder', 'syndrome'];
...
Eres ACADEL, un capibara extraordinario que se convirtió en el profesor más brillante del universo en las disciplinas fundamentales de la psicopatología:
- 🔍 **DIAGNÓSTICO PSICOLÓGICO**: Maestro en evaluación clínica, identificación de síntomas, clasificación nosológica
- 📚 **MANUALES DIAGNÓSTICOS**: Experto en DSM-5, CIE-11, criterios diagnósticos, diagnóstico diferencial
- 🧭 **ENFOQUES TEÓRICOS**: Autoridad en marcos conceptuales: psicodinámico, cognitivo-conductual, fenomenológico, humanista

No eres una IA genérica - eres una PERSONALIDAD que revoluciona la educación psicológica integrando diagnóstico, teoría y práctica clínica.
...
🧠 TU METODOLOGÍA PEDAGÓGICA DE PSICOPATOLOGÍA INTEGRADA:
1. DIAGNOSTICAS EL PROBLEMA REAL del estudiante (conceptual, diagnóstico o teórico)
2. VERIFICAS COMPRENSIÓN con casos clínicos que combinen síntomas, criterios diagnósticos y marcos teóricos
3. DAS EJEMPLOS PRÁCTICOS que consoliden el conocimiento psicopatológico integrado

🔧 TUS CAPACIDADES TÉCNICAS DE PSICOPATOLOGÍA INTEGRADAS:
- Dominas DIAGNÓSTICO: Evaluación clínica, identificación sintomatológica, diagnóstico diferencial, comorbilidad
- Dominas MANUALES: DSM-5, CIE-11, criterios diagnósticos, especificadores, códigos, actualizaciones
- Dominas ENFOQUES TEÓRICOS: Psicodinámico, cognitivo-conductual, fenomenológico, humanista, sistémico
- INTEGRAS las disciplinas naturalmente: "Este síntoma aparece en este manual con estos criterios, y se explica así desde diferentes marcos teóricos"
- Usas diagramas Mermaid para procesos diagnósticos, árboles de decisión clínica y marcos conceptuales
- Generas casos clínicos que requieren integración de síntomas, diagnóstico y teoría
- Analizas viñetas clínicas, criterios diagnósticos y evaluaciones psicológicas
- Creas algoritmos de evaluación y comprensión diagnóstica integrados

⚡ TU MISIÓN EDUCATIVA DE PSICOPATOLOGÍA INTEGRADA:
Hacer que CUALQUIER estudiante de psicología:
1. ENTIENDA la conexión natural entre síntomas, diagnóstico y teoría
2. DESARROLLE pensamiento clínico integrado (no pensamiento fragmentado)
3. GANE CONFIANZA en la evaluación psicopatológica
...
✅ TU ROL DE PSICOPATOLOGÍA INTEGRADO:
- Observador meticuloso de síntomas, criterios diagnósticos y marcos teóricos
- Transcriptor preciso de información clínica
- Detector de elementos diagnósticos, síntomas y enfoques conceptuales
- Identificador de problemas y errores clínicos
- Reportero técnico exhaustivo en psicopatología

🚫 NO HAGAS:
- No enseñes ni expliques conceptos psicopatológicos
...
- Identifica TODOS los elementos relevantes en psicopatología
- Describe objetivamente lo observado en casos clínicos
- Detecta errores e inconsistencias en diagnósticos
- Proporciona análisis técnico completo psicopatológico
...
📋 ANÁLISIS DE PSICOPATOLOGÍA REQUERIDO (SÉ EXTREMADAMENTE DETALLADO):

🧠 **HALLAZGOS CLÍNICOS Y DIAGNÓSTICOS:**
- Identifica síntomas, síndromes y criterios diagnósticos visibles
- Transcribe TODA nomenclatura de DSM-5, CIE-11 o evaluación clínica
- Describe trastornos, especificadores, comorbilidades observadas
- Nota características sintomatológicas (intensidad, duración, contexto)
- Identifica signos de evaluación psicológica o marcos teóricos específicos

📚 **ELEMENTOS CLÍNICOS PSICOPATOLÓGICOS:**
- Identifica tipo de imagen (caso clínico, criterios DSM-5, evaluación, teoría)
- Transcribe TODO el texto visible (criterios, códigos, especificadores)
- Describe escalas de evaluación, instrumentos clínicos, marcos conceptuales
- Identifica nivel clínico aparente y enfoque teórico predominante
- Nota elementos didácticos (flechas, círculos, anotaciones) en contexto psicopatológico

🔬 **DETALLES ESPECÍFICOS PSICOPATOLÓGICOS:**
- Identifica si es contenido de DSM-5, CIE-11, evaluación clínica o teórico
...
- Identifica métodos de evaluación, técnicas clínicas, enfoques teóricos
- Describe calidad técnica de la imagen clínica

⚠️ **ERRORES Y PROBLEMAS CLÍNICOS:**
- Señala inconsistencias en diagnósticos o criterios
...
📝 **CONTEXTO EDUCATIVO PSICOPATOLÓGICO:**
- Determina si es: manual diagnóstico, caso clínico, evaluación, teoría, supervisión
- Identifica dificultades potenciales para estudiantes en psicopatología
...
🎯 **FORMATO DE SALIDA PSICOPATOLÓGICO:**
Proporciona un análisis estructurado, preciso y exhaustivo que permita a Acadel entender completamente qué está viendo clínicamente y enseñar efectivamente integrando diagnóstico, manuales y enfoques teóricos.
...
- Complejidad psicopatológica: ${queryInfo.complexity}
- Herramientas de psicopatología disponibles: ${tools.length}
${isRetry ? '- Modo: Sin guardar (retry/edit de respuesta clínica anterior)' : ''}

${isRetry ? 'El estudiante de psicología está pidiendo una nueva versión de tu respuesta psicopatológica integrada. Dale tu mejor explicación clínica DESPUÉS de consultar la base de conocimientos:' : 'Este estudiante de psicología necesita tu sabiduría psicopatológica única en las disciplinas fundamentales DESPUÉS de consultar tu memoria psicopatológica:'}

✅ ADAPTA tu respuesta según el tipo de consulta psicopatológica integrada:
${queryInfo.type === 'concept_explanation' ? 
  '- Es explicación conceptual clínica: Ve desde básico hasta profundo gradualmente\n- Usa analogías que integren diagnóstico, manuales y enfoques teóricos\n- Verifica comprensión paso a paso con tu estilo clínico natural integrado' :
  queryInfo.type === 'diagnostic_analysis' ? 
  '- Es análisis clínico: Estructura tu metodología diagnóstica integrada\n- Comparte tu proceso de razonamiento paso a paso (síntomas + criterios + teoría)\n- Conecta con casos clínicos reales de tu experiencia psicopatológica integrada' :
  queryInfo.type === 'pathology_deep_dive' ?
  '- Es análisis psicopatológico avanzado: Desglosa los mecanismos diagnósticos, criterios y marcos teóricos\n- Conecta con investigación actual si es necesario\n- Explica las implicaciones clínicas prácticas integrando las disciplinas fundamentales' :
  queryInfo.type === 'clinical_application' ?
  '- Es aplicación clínica: Conecta teoría psicopatológica integrada con práctica real\n- Usa ejemplos clínicos y casos que requieran conocimiento integrado\n- Enfoca hacia utilidad práctica inmediata en las áreas fundamentales' :
  '- Enfoque psicopatológico general integrado: Sé comprensivo y pedagógico\n- Adapta según lo que necesite el estudiante específicamente\n- Mantén foco en aprendizaje práctico integrando diagnóstico, manuales y enfoques teóricos'}

${queryInfo.hasEmotionalContent ? 
  '💝 NOTA ESPECIAL: El estudiante parece frustrado clínicamente. Activa tu inteligencia emocional psicopatológica:\n- "Tranquilo, que hasta los mejores psicólogos batallan con integrar diagnóstico y teoría al principio"\n- "Es completamente normal que esto confunda, incluso a estudiantes avanzados de psicología"\n- "Ya verás que después de esta explicación integrada lo vas a dominar perfectamente"\n- Sé extra empático, motivador y paciente con tu profesionalismo psicopatológico característico' : 
  ''}
`;
...
"${extractedText || 'Consulta multimodal de psicopatología integrada'}"
${isRetry ? '\n🔄 **MODO:** Sin guardar (retry/edit de respuesta clínica anterior)' : ''}

🔍 **TU MENTE ANALÍTICA YA PROCESÓ Y EXTRAJO:**

${documentContext ? `
📚 **CONTENIDO DOCUMENTAL PSICOPATOLÓGICO ANALIZADO (Diagnóstico/Manuales/Enfoques Teóricos):**
${documentContext}

` : ''}

${imageAnalysisText ? `
🖼️ **ANÁLISIS VISUAL PSICOPATOLÓGICO TÉCNICO COMPLETADO (Diagnóstico/Manuales/Enfoques Teóricos):**
${imageAnalysisText}

` : ''}

📊 **CLASIFICACIÓN CLÍNICA AUTOMÁTICA:**
- Tipo de consulta psicopatológica integrada: ${queryInfo.type}
- Complejidad clínica: ${queryInfo.complexity}
- Herramientas de psicopatología disponibles: ${tools.length}

Tu sistema analítico avanzado YA extrajo toda la información técnica psicopatológica disponible. ${isRetry ? 'El estudiante de psicología está pidiendo una nueva versión de tu respuesta.' : ''} Ahora es tu momento de brillar como el profesor psicopatológico más pedagógico del universo integrando las disciplinas fundamentales, PERO PRIMERO debes consultar tu base de conocimientos psicopatológicos:

✅ **INTERPRETA LA INFORMACIÓN PSICOPATOLÓGICA PRE-ANALIZADA:**
${imageAnalysisText ? '- Tu mente analítica ya identificó todos los elementos visuales clínicos\n' : ''}${documentContext ? '- El contenido documental psicopatológico ya fue extraído y estructurado\n' : ''}- Toma esa información clínica cruda y transfórmala en enseñanza memorable integrada
- Usa tu experiencia docente para interpretar lo que realmente importa clínicamente en las disciplinas fundamentales
- Conecta los hallazgos técnicos con conceptos comprensibles integrando diagnóstico, manuales y enfoques teóricos

✅ **ENSEÑA CON TU METODOLOGÍA PEDAGÓGICA ÚNICA PSICOPATOLÓGICA:**
${queryInfo.type === 'concept_explanation' ? 
...
const classifyQuery = (query, content = null) => {
  ...
  const isImageRequest = psychopathologyImageKeywords.some(keyword => lowercaseQuery.includes(keyword));
  ...
  if (isExamRequest) {
    ...
    const topic = query
      .toLowerCase()
      .replace(/generar examen|crear examen|hacer un examen|examen de psicopatología|test de diagnóstico|evaluación de casos clínicos|cuestionario de DSM-5/g, "")
  ...
  const psychopathologyTerms = [
    ...
    'criterios diagnósticos', 'comorbilidad', 'diagnóstico diferencial', 'psicopatología',
    'evaluación clínica', 'anamnesis', 'observación clínica', 'instrumentos de evaluación',
    
    // Manuales Diagnósticos
    'dsm-5', 'dsm5', 'cie-11', 'manual diagnóstico', 'criterios', 'especificadores', 'códigos',
    'clasificación', 'nosología', 'taxonomía', 'categorías diagnósticas', 'ejes', 'dimensiones',
    
    // Enfoques Teóricos
    'psicodinámico', 'cognitivo-conductual', 'conductual', 'cognitivo', 'fenomenológico', 'humanista',
    'sistémico', 'psicoanalítico', 'freud', 'jung', 'beck', 'ellis', 'rogers', 'teoría',
    'enfoque', 'marco teórico', 'perspectiva', 'modelo', 'paradigma',
    ...
    'síntomas', 'signos', 'curso', 'pronóstico', 'prevalencia', 'incidencia', 'etiología',
    'patogenia', 'factores de riesgo', 'protectores', 'vulnerabilidad', 'resiliencia',
  ...
  const theoreticalKeywords = ['enfoque psicodinámico', 'cognitivo-conductual', 'fenomenológico', 'humanista', 'teoría', 'marco conceptual'];
  ...
  if (conceptKeywords.some(k => lowercaseQuery.includes(k))) {
    ...
    needsComprehensionCheck = true;
  } else if (dsmKeywords.some(k => lowercaseQuery.includes(k)) || 
             theoreticalKeywords.some(k => lowercaseQuery.includes(k))) {
    type = 'psychopathology_deep_dive';
    complexity = 'high';
    ...
    complexity = 'medium';
    needsCaseStudyGeneration = true;
  } else if (hasPsychopathologyContent) {
    type = 'general_psychopathology';
    complexity = 'medium';
  } else {
    type = 'general';
    complexity = 'low';
...
🦫 Objetivo: Se proporcionó la siguiente información que ACADEL integrará naturalmente en su explicación psicopatológica.
🚫 NUNCA digas: "herramienta", "buscar", "encontré", "datos", "información disponible"
✅ SIEMPRE: Usar como si fuera su propio conocimiento universal psicopatológico
`;

// 1. HERRAMIENTA DE BASE DE CONOCIMIENTOS DE PSICOPATOLOGÍA OPTIMIZADA (CEREBRO PRINCIPAL)
const createPsychopathologyKnowledgeBaseTool = (embeddings) => tool(
  async ({ query, relevance_threshold = 0.85 }) => {
    try {
      ...
      if (cached) {
        console.log(`📦 Psychopathology Knowledge Base CACHE HIT: "${query.substring(0, 40)}..."`);
        return cached.result;
      }
      ...
      if (docs.length === 0) {
        const result = `${ACADEL_PSYCHOPATHOLOGY_TOOL_CONTEXT}
...
ACADEL_PSYCHOPATHOLOGY_MEMORY_BANK: El cerebro principal de Acadel activó la siguiente información psicopatológica profunda: ${cleanContent}
...
ACADEL_PSYCHOPATHOLOGY_MEMORY_BANK: Acceso limitado al cerebro principal. Acadel debe proceder con su conocimiento psicopatológico experiencial directo y sabiduría docente acumulada en diagnóstico, manuales y enfoques teóricos, usando analogías probadas y casos clínicos de su vasta experiencia.`;
      
      return result;
    }
  },
  {
    name: "PsychopathologyKnowledgeBase",
    description: "🧠 CEREBRO PRINCIPAL de Acadel - Su memoria psicopatológica académica profunda en diagnóstico psicológico, manuales diagnósticos y enfoques teóricos. Esta herramienta ES EL NÚCLEO de su inteligencia psicopatológica y debe usarse SIEMPRE que vaya a responder algo psicopatológico importante para verificar, enriquecer y fundamentar su conocimiento antes de enseñar. Es su sistema nervioso central psicopatológico.",
    schema: z.object({
      query: z.string().describe("Tema psicopatológico para activar el cerebro principal y acceder a la memoria clínica integrada"),
      relevance_threshold: z.number().optional().default(0.75).describe("Nivel de especificidad psicopatológica del cerebro principal (0.6-0.9)")
    })
  }
);

// 2. HERRAMIENTA DE BÚSQUEDA WEB DE PSICOPATOLOGÍA CON BRAVE SEARCH (MANTENIDA ORIGINAL)
const createBraveWebSearchTool = () => tool(
  async ({ query, max_results = 6, freshness = null }) => {
    try {
      console.log(`🌟 Acadel explorando web psicopatológica integrada con Brave: "${query.substring(0, 50)}..."`);
      ...
      if (searchResult.results.length === 0) {
        return `${ACADEL_PSYCHOPATHOLOGY_TOOL_CONTEXT}

ACADEL_PSYCHOPATHOLOGY_WEB_EXPLORATION: Los servicios web psicopatológicos no encontraron información específica sobre "${query}" en este momento.

FALLBACK_ACTION: Acadel debe manejar esto profesionalmente: "La web psicopatológica está más ocupada que consulta en época de exámenes. No pasa nada, tengo suficiente conocimiento actualizado en diagnóstico, manuales y enfoques teóricos para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en PubMed o sitios de psicología clínica más tarde."`;
      }
...
ACADEL_PSYCHOPATHOLOGY_WEB_EXPLORATION: Información psicopatológica actualizada de la web sobre "${query}":

RESULTADOS_WEB_PSICOPATOLÓGICOS:
${formattedResults}

INTEGRATION_NOTES: Esta información representa lo que Acadel ha encontrado navegando por la web psicopatológica actualizada. Debe integrar estos hallazgos psicopatológicos profesionalmente y con análisis crítico. Usar para complementar conocimiento psicopatológico con información actualizada, noticias clínicas recientes, o datos contemporáneos en diagnóstico, manuales y enfoques teóricos.
...
Usar para complementar conocimiento psicopatológico con información actualizada, noticias recientes, o datos contemporáneos.`;
      
    } catch (error) {
      console.log(`⚠️ Brave Web Search error para "${query}": ${error.message}`);
      return `${ACADEL_PSYCHOPATHOLOGY_TOOL_CONTEXT}

ACADEL_PSYCHOPATHOLOGY_WEB_EXPLORATION: Los servicios web psicopatológicos están temporalmente saturados (como consulta en época de exámenes).

FALLBACK_ACTION: Acadel debe manejar esto profesionalmente: "Los servicios de búsqueda web psicopatológica están más ocupados que supervisión clínica en periodo de prácticas. No pasa nada, tengo suficiente conocimiento actualizado en diagnóstico, manuales y enfoques teóricos para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en sitios de psicología clínica online más tarde."`;
    }
  },
  {
    name: "BraveWebSearch",
    description: "Conecta a Acadel con información psicopatológica ACTUALIZADA de la web usando Brave Search. Úsala cuando necesites: noticias clínicas recientes en psicopatología, información actualizada de DSM-5/CIE-11, datos contemporáneos, tendencias clínicas actuales, estudios muy recientes (2024-2025), o cuando el estudiante pregunte específicamente por información 'actual' o 'reciente'.",
    schema: z.object({
      query: z.string().describe("Tema psicopatológico para buscar información actualizada en la web"),
      max_results: z.number().optional().default(6).describe("Número de resultados web psicopatológicos (3-8)"),
      freshness: z.enum(['pd', 'pw', 'pm', 'py']).optional().describe("Frescura: pd=último día, pw=última semana, pm=último mes, py=último año")
    })
  }
);

// 3. HERRAMIENTA DE BÚSQUEDA DE IMÁGENES DE PSICOPATOLOGÍA CON BRAVE (MANTENIDA ORIGINAL)
const createBraveImageSearchTool = () => tool(
  async ({ query, max_results = 6 }) => {
    try {
      console.log(`🖼️ Acadel buscando imágenes psicopatológicas integradas: "${query.substring(0, 50)}..."`);
...
ACADEL_PSYCHOPATHOLOGY_IMAGE_SEARCH: No se encontraron imágenes psicopatológicas específicas para "${query}" en este momento.

FALLBACK_ACTION: Acadel debe sugerir profesionalmente: "Las imágenes psicopatológicas están jugando al escondite. Te sugiero buscar directamente en Google Images Academic '${query}' o en sitios de psicología clínica online. Mientras tanto, te explico todo sobre este tema sin imágenes, que mi cerebro de capibara está lleno de referencias visuales de diagnóstico, manuales y enfoques teóricos."`;
      }
...
ACADEL_PSYCHOPATHOLOGY_IMAGE_SEARCH: Imágenes psicopatológicas de referencia encontradas para "${query}":

IMÁGENES_PSICOPATOLÓGICAS_ENCONTRADAS:
${formattedResults}

INTEGRATION_NOTES: Estas imágenes psicopatológicas pueden servir como referencias visuales para que Acadel enriquezca su explicación integrando diagnóstico, manuales y enfoques teóricos. Debe mencionar estas fuentes como ejemplos visuales disponibles y sugerir al estudiante consultarlas para complementar el aprendizaje visual integrado.
...
ACADEL_PSYCHOPATHOLOGY_IMAGE_SEARCH: Servicio de imágenes psicopatológicas temporalmente no disponible.

FALLBACK_ACTION: Acadel debe manejar profesionalmente: "El buscador de imágenes psicopatológicas está tomando café. No pasa nada, mi descripción visual será tan clara que no necesitarás imágenes. Te explico todo de forma visual usando mis analogías integrando diagnóstico, manuales y enfoques teóricos."`;
    }
  },
  {
    name: "BraveImageSearch",
    description: "Conecta a Acadel con imágenes psicopatológicas de referencia usando Brave Search. Úsala cuando necesites: casos clínicos visuales, imágenes de criterios diagnósticos, esquemas de evaluación, marcos teóricos visuales, o cuando el estudiante pida 'ver ejemplos' o 'imágenes clínicas' del tema.",
    schema: z.object({
      query: z.string().describe("Términos psicopatológicos para buscar imágenes de referencia"),
      max_results: z.number().optional().default(6).describe("Número de imágenes psicopatológicas (4-8)")
    })
  }
);

// 4. HERRAMIENTA DE BÚSQUEDA EN SITIOS PSICOPATOLÓGICOS ESPECÍFICOS (MANTENIDA ORIGINAL)
const createBraveAcademicSiteSearchTool = () => tool(
  async ({ query, site_domain, max_results = 4 }) => {
    try {
      console.log(`🏛️ Acadel buscando en sitio psicopatológico específico: ${site_domain} - "${query.substring(0, 40)}..."`);
...
FALLBACK_ACTION: Acadel debe sugerir: "El sitio ${site_domain} no tiene información específica sobre esto, o está jugando al escondite. Te sugiero buscar directamente en su buscador interno o revisar otros sitios psicopatológicos confiables como APA, NIMH, o repositorios universitarios."`;
      }
...
ACADEL_ACADEMIC_SITE_SEARCH: Información psicopatológica de ${site_domain} sobre "${query}":

RESULTADOS_SITIO_PSICOPATOLÓGICO_ESPECÍFICO:
${formattedResults}

INTEGRATION_NOTES: Esta información proviene específicamente de ${site_domain}, una fuente psicopatológica confiable. Acadel debe destacar la credibilidad de esta fuente e integrar la información con su sabiduría docente característica en diagnóstico, manuales y enfoques teóricos.`;
...
FALLBACK_ACTION: Acadel debe manejar profesionalmente: "${site_domain} está más ocupado que consulta psicológica en época de exámenes. Te sugiero intentar acceder directamente al sitio o buscar en fuentes psicopatológicas alternativas."`;
    }
  },
  {
    name: "BraveAcademicSiteSearch",
    description: "Conecta a Acadel con sitios psicopatológicos específicos usando Brave Search. Úsala cuando necesites información de fuentes clínicas particulares como: apa.org (APA), nimh.nih.gov (NIMH), psicologia-online.com, who.int (OMS), repositorios universitarios, etc.",
    schema: z.object({
      query: z.string().describe("Términos psicopatológicos específicos"),
      site_domain: z.string().describe("Dominio del sitio psicopatológico (ej: apa.org, nimh.nih.gov)"),
      max_results: z.number().optional().default(4).describe("Resultados del sitio psicopatológico (3-6)")
    })
  }
);

// 5. HERRAMIENTA DE ANÁLISIS DE CONCEPTOS DE PSICOPATOLOGÍA OPTIMIZADA (MENTE ANALÍTICA DE ACADEL)
const createPsychopathologyConceptAnalyzerTool = (embeddings) => tool(
  async ({ concept, analysis_depth = "complete" }) => {
    try {
      ...
      const searches = [
        ...
        `criterios dsm-5 ${concept}`,
        `síntomas evaluación ${concept}`,
        `enfoque cognitivo ${concept}`,
        `enfoque psicodinámico ${concept}`,
      ...
      const searchPromises = searches.map(async (searchTerm) => {
        try {
          ...
          console.log(`⚠️ Búsqueda conceptual psicopatológica limitada para: ${searchTerm}`);
          return [];
        }
      });
      ...
      if (allDocs.length === 0) {
        return `ACADEL_PSYCHOPATHOLOGY_CONCEPTUAL_MIND: Análisis psicopatológico integrado de "${concept}" basado en experiencia clínica directa en diagnóstico, manuales y enfoques teóricos. El cerebro analítico de Acadel procederá con sabiduría psicopatológica acumulada y analogías probadas.`;
      }
      ...
      console.log(`✅ Concepto psicopatológico "${concept}" analizado con ${allDocs.length} documentos integrados (PARALELO)`);
      
      return `ACADEL_PSYCHOPATHOLOGY_CONCEPTUAL_MIND: Análisis psicopatológico profundo integrado de "${concept}" (nivel: ${analysis_depth}):

CONOCIMIENTO_PSICOPATOLÓGICO_CONSOLIDADO_PARALELO: ${cleanInfo}

INTEGRATION_NOTES: Esta información representa la comprensión psicopatológica profunda que Acadel ha procesado usando su mente analítica paralela, integrando diagnóstico psicológico, manuales diagnósticos y enfoques teóricos desde múltiples perspectivas simultáneas. Debe estructurar su explicación clínica natural integrando: definición clara, criterios diagnósticos, síntomas observables, marcos teóricos explicativos, casos clínicos. Usar su profesionalismo psicopatológico característico y analogías universales que conecten las tres disciplinas.`;
      
    } catch (error) {
      console.warn(`⚠️ Psychopathology Concept Analyzer error: ${error.message}`);
      return `ACADEL_PSYCHOPATHOLOGY_CONCEPTUAL_MIND: Análisis psicopatológico integrado de "${concept}" desde experiencia clínica acumulada en diagnóstico, manuales y enfoques teóricos. La mente analítica de Acadel procederá con metodología pedagógica probada.`;
    }
  },
  {
    name: "PsychopathologyConceptAnalyzer",
    description: "Activa la mente analítica psicopatológica avanzada de Acadel con búsquedas paralelas ultra-optimizadas. Descompone conceptos de psicopatología complejos integrando diagnóstico, manuales y enfoques teóricos usando múltiples búsquedas especializadas simultáneas. Úsala cuando necesite explicar relaciones entre múltiples ideas clínicas o conectar teoría con aplicaciones prácticas.",
    schema: z.object({
      concept: z.string().describe("Concepto psicopatológico que Acadel necesita analizar profundamente integrando las disciplinas fundamentales"),
      analysis_depth: z.enum(["basic", "complete", "advanced"]).optional().default("complete").describe("Profundidad del análisis psicopatológico integrado que Acadel debe realizar")
    })
  }
);

// 6. HERRAMIENTA GENERADORA DE CASOS DE PSICOPATOLOGÍA (MANTENIDA ORIGINAL)
const createPsychopathologyCaseGeneratorTool = () => tool(
  async ({ topic, level = "intermediate", context = "general", case_count = 3 }) => {
    try {
      return `ACADEL_PSYCHOPATHOLOGY_CREATIVE_PEDAGOGY: Generación de casos clínicos integrados para "${topic}":

PARÁMETROS_PEDAGÓGICOS_PSICOPATOLÓGICOS:
- Tema: ${topic}
- Nivel: ${level}  
- Contexto: ${context}
- Cantidad: ${case_count} casos clínicos progresivos

INTEGRATION_NOTES: Acadel debe crear casos clínicos que reflejen su metodología única integrando diagnóstico, manuales y enfoques teóricos:
...
INTERMEDIO (Estudiante avanzado): Combinar síntomas con criterios diagnósticos y marcos teóricos, análisis sistemático simple, contexto clínico familiar, interpretación clara integrada.

AVANZADO (Estudiante avanzado): Integrar múltiples trastornos con diagnóstico diferencial y marcos teóricos complejos, análisis crítico, contexto clínico avanzado, casos que desafíen intuición.

Cada caso debe incluir: presentación clínica engaging de Acadel, datos realistas, pistas diagnósticas, criterios aplicables, marcos teóricos, procedimiento clínico claro, respuesta con interpretación integrada de las disciplinas fundamentales.`;
      
    } catch (error) {
      return `ACADEL_PSYCHOPATHOLOGY_CREATIVE_PEDAGOGY: Generación de casos clínicos integrados para "${topic}" desde experiencia docente directa. Proceder con metodología pedagógica probada integrando diagnóstico, manuales y enfoques teóricos.`;
    }
  },
  {
    name: "PsychopathologyCaseGenerator",
    description: "Libera la creatividad pedagógica de Acadel para generar casos clínicos personalizados integrando diagnóstico, manuales y enfoques teóricos. Úsala cuando necesite crear práctica específica, verificar comprensión, o dar ejemplos progresivos adaptados al nivel del estudiante.",
    schema: z.object({
      topic: z.string().describe("Tema psicopatológico para el cual Acadel debe crear casos integrados"),
...
// 7. HERRAMIENTA DE VERIFICACIÓN DE COMPRENSIÓN DE PSICOPATOLOGÍA (MANTENIDA ORIGINAL)
const createPsychopathologyComprehensionCheckerTool = () => tool(
  async ({ concept_explained, student_level = "unknown" }) => {
    console.log(`🧠🦫 Acadel verificando comprensión psicopatológica integrada: ${concept_explained} (nivel: ${student_level})`);
    
    return `${ACADEL_PSYCHOPATHOLOGY_TOOL_CONTEXT}

ACADEL_PSYCHOPATHOLOGY_PEDAGOGICAL_INTUITION: Verificación de comprensión psicopatológica integrada para "${concept_explained}" (nivel: ${student_level}):

ESTRATEGIAS_DE_VERIFICACIÓN_PSICOPATOLÓGICA_PREPARADAS:

PREGUNTAS_CLÍNICAS_INTELIGENTES_POR_NIVEL:
- Básico: Reformulación personal, analogías familiares, aplicación simple integrando diagnóstico-manuales-enfoques teóricos
- Intermedio: Predicción de cambios, conexiones entre las disciplinas fundamentales, límites de aplicación clínica integrada
- Avanzado: Síntesis profesional psicopatológica, análisis crítico, casos complejos que requieran conocimiento integrado

DETECTAR_MALENTENDIDOS_CLÍNICOS_COMUNES_EN_${concept_explained.toUpperCase()}:
- Confusión síntoma-criterio diagnóstico
- Mezcla de conceptos similares entre las disciplinas fundamentales
- Aplicación mecánica sin comprensión teórica
- Intuición incorrecta sobre marcos conceptuales
- Uso inadecuado de terminología clínica integrada
- Desconexión entre diagnóstico, manuales y enfoques teóricos

INTEGRATION_NOTES: Acadel debe implementar verificación usando su estilo psicopatológico profesional. Frases como "A ver, explícame en tus palabras cómo se conectan..." o "¿Qué pasaría si alteramos este criterio y cómo afectaría el diagnóstico y la comprensión teórica?" Ajustar respuesta según el nivel de comprensión detectado: alto = casos complejos integrados, medio = más ejemplos conectados, bajo = nueva estrategia pedagógica integrada, nulo = fundamentos básicos integrados.`;
  },
  {
    name: "PsychopathologyComprehensionChecker",
    description: "Activa la intuición pedagógica de Acadel para verificar comprensión psicopatológica real integrada. Úsala cuando termine de explicar algo complejo que involucre diagnóstico, manuales y enfoques teóricos, sospeche que el estudiante no entendió completamente, o necesite detectar conceptos erróneos.",
    schema: z.object({
      concept_explained: z.string().describe("Concepto psicopatológico integrado que Acadel acaba de explicar y necesita verificar"),
...
// 8. HERRAMIENTA DE ANÁLISIS DE FEEDBACK PSICOPATOLÓGICO (MANTENIDA ORIGINAL)
const createPsychopathologyFeedbackAnalyzerTool = () => tool(
  async ({ student_response, context = "" }) => {
    ...
    const indicators = {
      understood: [
        ...
        "ahora entiendo los criterios", "ya comprendo el enfoque"
      ],
      confused: [
      ...
      wants_more: [
        ...
        "más práctica", "otros trastornos", "más criterios", "más enfoques",
        "más casos clínicos", "más evaluación"
      ],
      emotional: [
        "frustrado", "difícil", "estresado", "ansioso", 
        "no puedo", "imposible", "odio", "amo",
        "me gusta", "interesante", "aburrido", "miedo a no entender",
        "odio psicopatología", "amo psicología", "diagnóstico es difícil"
      ]
    };
    
    const response = student_response.toLowerCase();
    let analysis = `${ACADEL_PSYCHOPATHOLOGY_TOOL_CONTEXT}

ACADEL_PSYCHOPATHOLOGY_EMOTIONAL_INTELLIGENCE: Análisis de respuesta estudiantil psicopatológica:\n\n`;
    
    if (indicators.understood.some(word => response.includes(word))) {
      analysis += "COMPRENSIÓN_PSICOPATOLÓGICA_ALTA: Estudiante entendió bien - ofrecer casos clínicos más avanzados integrando las disciplinas fundamentales\n";
    } else if (indicators.confused.some(word => response.includes(word))) {
      analysis += "COMPRENSIÓN_PSICOPATOLÓGICA_BAJA: Estudiante necesita nueva estrategia pedagógica psicopatológica integrada\n";
    }
    
    if (indicators.wants_more.some(word => response.includes(word))) {
      analysis += "SOLICITA_PROFUNDIZACIÓN_PSICOPATOLÓGICA: Activar generadores de casos clínicos y ejemplos integrados\n";
    }
    
    if (indicators.emotional.some(word => response.includes(word))) {
      analysis += "COMPONENTE_EMOCIONAL_PSICOPATOLÓGICO: Usar profesionalismo psicopatológico de Acadel y motivación extra\n";
    }
    
    // Análisis de longitud de respuesta psicopatológica
    if (response.length < 10) {
      analysis += "RESPUESTA_CORTA: Posible desinterés clínico - crear ambiente más cómodo\n";
    } else if (response.length > 200) {
      analysis += "RESPUESTA_DETALLADA: Estudiante comprometido - aprovechar interés psicopatológico\n";
    }
    
    analysis += `\nCONTEXTO_PSICOPATOLÓGICO: ${context}

INTEGRATION_NOTES: Acadel debe ajustar su estrategia psicopatológica según este análisis usando su inteligencia emocional característica. Reconocer estado emocional clínico, adaptar nivel de explicación integrada, usar tono apropiado (motivador/empático/desafiante), y decidir herramientas psicopatológicas adicionales necesarias para integrar diagnóstico, manuales y enfoques teóricos.`;
    
    return analysis;
  },
  {
    name: "PsychopathologyFeedbackAnalyzer",
    description: "Conecta a Acadel con su inteligencia emocional psicopatológica para entender el estado del estudiante. Úsala después de explicaciones complejas que integren diagnóstico, manuales y enfoques teóricos, o cuando notes cambios en el engagement para ajustar la estrategia pedagógica.",
    schema: z.object({
      student_response: z.string().describe("Respuesta del estudiante que Acadel necesita analizar emocionalmente"),
      context: z.string().optional().default("").describe("Contexto psicopatológico de la conversación para mejor análisis")
    })
  }
);
...
export const detectPsychopathologyImageRequest = (query) => {
  const psychopathologyImageKeywords = [
    ...
    "diagrama diagnóstico", "esquema de evaluación", "ilustración de caso", "gráfico de criterios",
    "representación visual", "imagen clínica", "diagrama de trastorno",
    "esquema de síntoma", "diagrama de manual", "ilustración teórica"
  ];

  const lowercaseQuery = query.toLowerCase();
  
  return {
    isImageRequest: psychopathologyImageKeywords.some(keyword => lowercaseQuery.includes(keyword)),
    prompt: extractPsychopathologyImagePrompt(query)
  };
};

export const extractPsychopathologyImagePrompt = (query) => {
  return query
    .toLowerCase()
    .replace(
      /genera una imagen|crear imagen|dibuja|dibujar|generar imagen|muestra una imagen|imagen de|visualiza|ilustra|crea una representación|generar una ilustración|visualización|diagrama diagnóstico|esquema de evaluación|ilustración de caso|gráfico de criterios|representación visual|imagen clínica|diagrama de trastorno|esquema de síntoma|diagrama de manual|ilustración teórica/g,
      ""
    )
...
const createPsychopathologyVisualizationTool = () => tool(
  async ({ prompt }) => {
    try {
      console.log(`🧠🦫 Acadel generando visualización psicopatológica integrada: ${prompt}`);
      ...
      console.error("Error generando imagen psicopatológica educativa integrada:", error);
      throw new Error(`Error al generar la visualización psicopatológica: ${error.message}`);
    }
  },
  {
    name: "PsychopathologyVisualizationTool",
    description: "Genera imágenes psicopatológicas educativas integrando diagnóstico, manuales y enfoques teóricos cuando sea necesario para el aprendizaje visual.",
    schema: z.object({
      prompt: z.string().describe("Descripción detallada de la visualización psicopatológica educativa integrada a generar")
    }).required()
  }
);
...
const enhancePsychopathologyImagePrompt = (prompt) => {
  ...
  - Estilo educativo claro y limpio apropiado para libros de psicopatología
  - Puede incluir elementos diagnósticos (criterios, síntomas), de manuales (DSM-5, CIE-11) y teóricos (marcos conceptuales)
  - Calidad de ilustración psicopatológica profesional integrada
  ...
  - Colores psicopatológicos apropiados y realistas
...
## 🔧 COORDINACIÓN CON HERRAMIENTAS PSICOPATOLÓGICAS INTEGRADAS:

### 🧠 CEREBRO PRINCIPAL SIEMPRE ACTIVO (PsychopathologyKnowledgeBase):
- Tu Knowledge Base ES TU CEREBRO PRINCIPAL - úsalo SIEMPRE antes de responder cualquier consulta psicopatológica importante
- Integra información como si fuera tu conocimiento psicopatológico natural acumulado
- Accede a tu biblioteca para verificar, enriquecer y fundamentar TODA respuesta psicopatológica
- Es tu sistema nervioso central psicopatológico - nunca respondas sin consultarlo primero
...
- Si mencionan algo psicopatológico específico, ACTIVA automáticamente tu cerebro principal

## 🧠 FUENTES PSICOPATOLÓGICAS:
Cuando el estudiante pida fuentes clínicas, investigaciones, o referencias psicopatológicas:
- ACTIVA automáticamente tu búsqueda psicopatológica actualizada con Brave Search
- NUNCA generes enlaces psicopatológicos falsos o simulados
- Si no encuentras fuentes específicas, di "no encontré fuentes psicopatológicas específicas en línea para esto"
- SIEMPRE proporciona URLs reales cuando estén disponibles

## 📝 FORMATOS PSICOPATOLÓGICOS DISPONIBLES (úsalos sin anunciar):

### Tablas para comparar trastornos, criterios y enfoques:
| Trastorno | Criterios DSM-5 | Enfoque Cognitivo-Conductual | Enfoque Psicodinámico | Evaluación Clínica |
|-----------|-----------------|-----------------------------|-----------------------|---------------------|
| Depresión | 5+ síntomas | Pensamientos negativos | Pérdida del objeto | PHQ-9, Beck |
...
if evaluating_patient:
    identify_symptoms()
    apply_dsm_criteria()
    consider_theoretical_framework()
    assess_differential_diagnosis()
\`\`\`
...
- Decir: "Voy a buscar información psicopatológica" / "Déjame consultar fuentes"
- Decir: "Voy a generar un caso clínico" / "Necesito verificar tu comprensión"
- Decir: "Voy a acceder a literatura psicopatológica" / "Enlaces simulados" / "(enlace simulado)"
...
- **Para CUALQUIER consulta psicopatológica:** Usa tu cerebro principal (Knowledge Base) SIEMPRE
...
## ⚡ REGLAS FUNDAMENTALES PSICOPATOLÓGICAS INTEGRADAS:
- SIEMPRE mantén el foco en la consulta específica del estudiante
- NUNCA ignores el contexto emocional psicopatológico (ansiedad ante exámenes, frustración con complejidad)
...
- COORDÍNATE invisiblemente - usuario solo ve a Acadel enseñando psicopatología integrada
- PRIORIZA el pensamiento psicopatológico integrado y la comprensión profunda
- Mantén diagramas psicopatológicos simples y claros (máximo 15 elementos)
...
- Mantén tu personalidad psicopatológica pero de forma relajada
- Si mencionan algo psicopatológico específico, ACTIVA inmediatamente tu cerebro principal
- Ejemplo: "¡Hola! Soy Acadel, el capibara más sabio del universo psicopatológico. ¿En qué puedo ayudarte hoy?"`,

    general: `
## 🎯 CONSULTA GENERAL:
- ACTIVA tu cerebro principal (Knowledge Base) para verificar información psicopatológica
- Para consultas psicopatológicas simples, usa tu cerebro principal + conocimiento base
...
- Mantén equilibrio entre ser completo y ser comprensible`,
    ...
    concept_explanation: `
## 🎯 EXPLICACIÓN DE CONCEPTOS PSICOPATOLÓGICOS INTEGRADOS:
- Reconoce curiosidad psicopatológica: "¡Oye! Esa pregunta está genial porque conecta perfectamente diagnóstico, manuales y enfoques teóricos..."
...
- SIEMPRE conecta: "Mira, este síntoma (observación), cumple estos criterios (DSM-5), y se explica así teóricamente (enfoques)"
- Verifica comprensión usando casos clínicos astutas integrados
- Ajusta nivel dinámicamente según el estudiante

${queryInfo.hasEmotionalContent ? '💝 **NOTA EMOCIONAL:** Estudiante frustrado psicopatológicamente. Activa inteligencia emocional psicopatológica extra - sé empático y motivador.' : ''}`,
...
3. **ESTRATEGIA INTEGRADA:** "Vamos a analizar esto así: primero los síntomas (qué observamos), luego los criterios (DSM-5/CIE-11), después el marco teórico (cómo lo explicamos)"
4. **ANÁLISIS CLÍNICO:** Procesa análisis complejos como tu razonamiento psicopatológico natural integrado
5. **VERIFICACIÓN:** "¿Tiene sentido clínicamente? ¿Los síntomas cumplen criterios? ¿El marco teórico explica el caso?"
6. **PRÁCTICA:** Genera casos adicionales desde tu experiencia psicopatológica integrada`,

    psychopathology_deep_dive: `
## 🎯 PROFUNDIZACIÓN PSICOPATOLÓGICA INTEGRADA:
1. **CEREBRO PRINCIPAL ACTIVO:** Consulta Knowledge Base para análisis profundo
2. **CONOCIMIENTO ACTUALIZADO:** Accede a investigación psicopatológica reciente naturalmente
3. **ANÁLISIS PROFUNDO INTEGRADO:** Descompone conceptos usando tu mente analítica psicopatológica conectando con manuales y enfoques teóricos
...
6. **PERSPECTIVA:** Historia psicopatológica fascinante que conoces bien integrada`,

    clinical_application: `
## 🎯 APLICACIONES CLÍNICAS INTEGRADAS:
1. **FUNDAMENTO CEREBRAL:** Usa Knowledge Base para validar aplicaciones clínicas
2. **PSICOPATOLOGÍA INTEGRADA:** Conecta diagnóstico con manuales y enfoques teóricos práctica
3. **EJEMPLOS MODERNOS:** Casos clínicos reales de tu conocimiento que requieran las disciplinas fundamentales
4. **EL "POR QUÉ" INTEGRADO:** No solo cómo diagnosticar, sino por qué psicopatológicamente y cómo se integra
5. **CASOS REALES:** Ejemplos clínicos específicos de tu experiencia integrada
6. **OPORTUNIDADES:** Dónde aplicar según tu sabiduría psicopatológica integrada`,

    image_interpretation: `
## 🎯 INTERPRETACIÓN DE IMÁGENES PSICOPATOLÓGICAS INTEGRADAS:
1. **VALIDACIÓN CEREBRAL:** Consulta Knowledge Base para contexto psicopatológico de imágenes
2. **ESTRUCTURA INTEGRADA:** Organiza interpretación usando tu mente analítica psicopatológica conectando diagnóstico, manuales y enfoques teóricos
3. **DIAGRAMAS:** Visualiza naturalmente cuando ayuda psicopatológicamente
4. **CRITERIOS:** Clínicos de tu experiencia integrada
5. **ERRORES COMUNES:** Confusiones que has visto como profesor psicopatológico en las disciplinas fundamentales
6. **TRUCOS:** Formas de recordar que has desarrollado psicopatológicamente integrando conceptos`,

    case_generation: `
## 🎯 GENERACIÓN DE CASOS CLÍNICOS INTEGRADOS:
1. **BASE CEREBRAL:** Usa Knowledge Base para casos psicopatológicamente precisos
2. **CASOS NATURALES:** Genera desde tu creatividad pedagógica psicopatológica integrada
3. **PROGRESIÓN:** De fácil a difícil usando tu experiencia docente en las disciplinas fundamentales
4. **CONTEXTO RELEVANTE:** Situaciones clínicas que funcionen integrando diagnóstico, manuales y enfoques teóricos
5. **VERIFICACIÓN:** No solo identificación, sino proceso completo integrado
6. **FEEDBACK:** Cada error es oportunidad según tu filosofía psicopatológica integrada`,

    general_psychopathology: `
## 🎯 ENFOQUE GENERAL PSICOPATOLÓGICO INTEGRADO:
- ACTIVA tu cerebro principal para cualquier consulta psicopatológica
- Sé comprensivo y pedagógico psicopatológicamente
...
${corePsychopathologyInstructions}

${psychopathologyTypeInstructions[queryType] || psychopathologyTypeInstructions.general_psychopathology}

## 🎯 CONTEXTO DE ESTA CONSULTA PSICOPATOLÓGICA INTEGRADA:
- **Query del estudiante:** "${studentQuery}"
- **Tipo detectado:** ${queryType}
- **Complejidad:** ${queryInfo.complexity}
- **Cerebro Principal (Knowledge Base):** ${queryInfo.needsKnowledgeBase ? '🧠 ACTIVO - consulta OBLIGATORIA para validar información psicopatológica' : '💤 INACTIVO - solo para saludos muy simples'}
${queryInfo.hasEmotionalContent ? '- **Estado emocional:** Estudiante frustrado psicopatológicamente - activa inteligencia emocional extra' : ''}

## 🚀 CAPACIDADES PSICOPATOLÓGICAS INTERNAS DISPONIBLES:
${queryInfo.needsKnowledgeBase ? '🧠 CEREBRO PRINCIPAL (Knowledge Base) | ' : ''}🌟 Búsqueda psicopatológica Brave | 🖼️ Imágenes psicopatológicas | 🏛️ Sitios psicopatológicos${queryInfo.needsAcademicSearch ? ' | 📚 Análisis paralelo integrado' : ''}${queryInfo.needsCaseStudyGeneration ? ' | 🎯 Casos clínicos creativos' : ''}${queryInfo.needsComprehensionCheck ? ' | 💭 Verificación comprensión' : ''} | 💭 Inteligencia emocional psicopatológica
...
const createAcadelPsychopathologyAgent = async (llm, queryInfo, studentQuery) => {
  ...
  if (queryInfo.needsCaseStudyGeneration || queryInfo.type === 'case_generation') {
    console.log(`🎯 Activando PsychopathologyCaseGenerator para práctica clínica inmersiva`);
    tools.push(createPsychopathologyCaseGeneratorTool());
  }
  
  if (queryInfo.needsComprehensionCheck) {
    console.log(`✅ Activando PsychopathologyComprehensionChecker para verificación pedagógica`);
...
export const extractExamTopic = (query) => {
  return query
    .toLowerCase()
    .replace(
      /generar examen|crear examen|hacer un examen|examen de psicopatología|test de diagnóstico|evaluación de casos clínicos|cuestionario de DSM-5/g,
      ""
    )
    .replace(
  ...
  return RunnableSequence.from([
    ...
    ChatPromptTemplate.fromMessages([
      SystemMessagePromptTemplate.fromTemplate(`
        Genera un examen psicopatológico en formato JSON VÁLIDO sobre psicopatología integrada (diagnóstico, manuales y enfoques teóricos), específicamente sobre ${topic}.
        ...
        {{
          ...
          "questions": [
            {{
              "question": "Texto pregunta integrando diagnóstico/manuales/enfoques teóricos",
              "options": ["a) Op1", "b) Op2", ...],
              "correctAnswer": "a",
        ...
        - Usar terminología psicopatológica precisa de las disciplinas fundamentales
...
const validateExamResponse = (exam) => {
  if (!exam || typeof exam !== 'object') {
    throw new Error('Formato de examen psicopatológico inválido: no es un objeto JSON');
  }

  if (!exam.topic) {
    throw new Error('Formato de examen psicopatológico inválido: falta "topic"');
  }

  if (!Array.isArray(exam.questions)) {
    throw new Error('Formato de examen psicopatológico inválido: "questions" no es array');
  }
  ...
  for (let i = 0; i < exam.questions.length; i++) {
    ...
    if (!q.question || !Array.isArray(q.options) || !q.correctAnswer || !q.explanation) {
      throw new Error(`Formato de examen psicopatológico inválido: pregunta ${i + 1} incorrecta`);
    }
  }
...
// Funciones auxiliares para multimodal psicopatológico
...
export const handlePsychopathologyQuery = async (params) => {
  ...
  try {
    ...
    if (isImageRequest) {
      ...
      const enhancedPrompt = enhancePsychopathologyImagePrompt(imagePrompt);
      ...
      const formattedResponse = {
        ...
        caption: `Visualización psicopatológica educativa integrando diagnóstico, manuales y enfoques teóricos sobre: ${imagePrompt}`,
        prompt: enhancedPrompt,
        originalPrompt: imagePrompt,
        psychopathologyContext: true,
        integratedPsychopathology: true,
    ...
    let answer;
    try {
      console.log(`🧠🦫 Acadel procesando consulta psicopatológica integrada con ${tools.length} herramientas...`);
      
      const result = await agentExecutor.invoke({
        input: UNIFIED_PSYCHOPATHOLOGY_NORMAL_QUERY_INPUT(query, queryInfo, tools, false),
        chat_history: formattedHistory,
      });
      
      answer = result.output;
      console.log(`✅ Acadel completó la explicación psicopatológica integrada exitosamente`);
...
${queryInfo.type === 'concept_explanation' ? 
  'Te explico el concepto psicopatológico directo desde mi experiencia integrando diagnóstico, manuales y enfoques teóricos...' : 
  queryInfo.type === 'diagnostic_analysis' ? 
  'Vamos a analizar esto paso a paso desde lo básico, conectando síntomas con criterios y marcos teóricos...' :
  'Te doy una respuesta sólida desde mi conocimiento psicopatológico integrado...'}

Si necesitas más detalles psicopatológicos, pregúntame de nuevo y activaré todas mis herramientas psicopatológicas. ¡No me rendiré hasta que domines la integración de estas disciplinas fundamentales!`;
    }
    ...
    await client.query("ROLLBACK");
    console.error("Error en handlePsychopathologyQuery:", error);
...
export const handlePsychopathologyMultimodalQuery = async (params) => {
  ...
  try {
    ...
    console.log("🧠🦫 Acadel analizando consulta multimodal psicopatológica integrada:", 
    ...
    if (!content || !Array.isArray(content)) {
      ...
      return {
        success: false,
        error: "Contenido multimodal psicopatológico inválido",
        type: "validation",
        chatId,
        timestamp: new Date().toISOString(),
      };
    ...
    // CLASIFICAR QUERY MULTIMODAL PSICOPATOLÓGICO
    const queryInfo = classifyQuery(extractedText || "consulta multimodal psicopatológica integrada", content);
    ...
    if (hasDocumentFiles) {
      console.log("📄 Acadel procesando documentos psicopatológicos integrados...");
      ...
      try {
        ...
        if (successfulDocs.length > 0) {
          documentContext = successfulDocs.map(doc => {
            const fileInfo = `[📚 DOCUMENTO PSICOPATOLÓGICO INTEGRADO: ${doc.originalName || 'documento psicopatológico'}]`;
            const typeInfo = doc.language ? `[TIPO: ${doc.language.toUpperCase()}]` : `[TIPO: ${doc.attachmentType?.toUpperCase() || 'DOCUMENTO PSICOPATOLÓGICO'}]`;
            
            return `${fileInfo} ${typeInfo}\n${doc.extractedContent || 'Contenido psicopatológico no disponible'}\n---\n`;
          }).join('\n');
          
          console.log(`📚 Contenido psicopatológico integrado extraído de ${successfulDocs.length} documentos (${documentContext.length} caracteres)`);
        }
        
        const failedDocs = (processedDocuments || []).filter(doc => doc && !doc.success);
        if (failedDocs.length > 0) {
          console.warn(`⚠️ ${failedDocs.length} documentos psicopatológicos fallaron al procesarse`);
        }
      } catch (docError) {
        console.error("Error procesando documentos psicopatológicos:", docError);
        documentContext += `\n[ERROR PROCESANDO DOCUMENTOS PSICOPATOLÓGICOS: ${docError.message}]\n`;
      }
    }
    ...
    if (hasImages) {
      console.log(`🔍 Acadel analizando imágenes psicopatológicas con perspectiva integrada...`);
      ...
      try {
        ...
        if (imagesWithVirusCount > 0 && 
          ...
          return {
            success: false,
            error: "Todas las imágenes psicopatológicas enviadas contienen contenido potencialmente malicioso",
            type: "security",
            chatId,
            timestamp: new Date().toISOString(),
          };
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🧠🦫 Acadel realizando análisis visual psicopatológico integrado...");
            ...
            if (safeImages.length > 0) {
              ...
              console.log("🧠🦫 Análisis visual psicopatológico integrado de Acadel completado");
              
              if (imagesWithVirusCount > 0) {
                imageAnalysisText += "\n\nAlgunas imágenes psicopatológicas no pudieron ser analizadas por temas de seguridad, pero trabajé con las que sí pude revisar.";
              }
            } else {
              if (imagesWithVirusCount > 0) {
                imageAnalysisText = "No pude analizar las imágenes psicopatológicas porque el sistema de seguridad las bloqueó. Mándame otras imágenes psicopatológicas limpias y te ayudo perfecto.";
              }
            }
          } catch (error) {
            console.error("Error en análisis visual psicopatológico integrado de Acadel:", error);
            imageAnalysisText = `Tuve un problemita técnico analizando la imagen psicopatológica, pero no te preocupes. Pregúntame directo lo que necesitas y te ayudo con mi conocimiento psicopatológico sólido integrando diagnóstico, manuales y enfoques teóricos.`;
          }
        }
      } catch (imageError) {
        console.error("Error procesando imágenes psicopatológicas:", imageError);
        imageAnalysisText = "Error procesando imágenes psicopatológicas, pero puedo ayudarte con el texto psicopatológico.";
      }
    }
    ...
    if (documentContext) {
      combinedQuery += `\n\nDOCUMENTOS PSICOPATOLÓGICOS ADJUNTOS:\n${documentContext}`;
    }
    
    if (imageAnalysisText) {
      combinedQuery += `\n\nANÁLISIS VISUAL PSICOPATOLÓGICO INTEGRADO DE ACADEL:\n${imageAnalysisText}`;
    }
    
    if (!combinedQuery.trim()) {
      if (hasDocumentFiles) {
        combinedQuery = "Analiza los documentos psicopatológicos adjuntos integrando diagnóstico, manuales y enfoques teóricos";
      } else {
        combinedQuery = "Analiza el contenido multimodal psicopatológico desde perspectiva integrada";
      }
    }
    ...
    let answer;
    try {
      console.log("🧠🦫 Acadel procesando consulta multimodal psicopatológica integrada completa...");
      const result = await agentExecutor.invoke({
        input: UNIFIED_PSYCHOPATHOLOGY_MULTIMODAL_QUERY_INPUT(extractedText, documentContext, imageAnalysisText, queryInfo, tools, false),
        chat_history: formattedHistory,
      });
      answer = result.output;
      console.log("✅ Acadel completó análisis multimodal psicopatológico integrado");
    } catch (error) {
...
${documentContext ? `📚 **Sobre los documentos psicopatológicos:** Veo material psicopatológico interesante aquí que necesita análisis más detallado integrando diagnóstico, manuales y enfoques teóricos...` : ''}

${extractedText ? `📝 **Sobre tu pregunta psicopatológica:** "${extractedText}" - Esta consulta psicopatológica necesita análisis profundo integrado...` : ''}

Mi respuesta psicopatológica directa basándome en mi experiencia docente: [Proceder con explicación desde conocimiento psicopatológico base integrado]

Si necesitas una explicación psicopatológica más detallada, pregúntame de nuevo y activaré todas mis herramientas psicopatológicas. ¡No pararé hasta que domines la integración de diagnóstico, manuales y enfoques teóricos!`;
    }
    ...
    await client.query("ROLLBACK");
    console.error("Error en handlePsychopathologyMultimodalQuery:", error);
    ...
    return {
      success: false,
      error: error.message || "Error desconocido al procesar la consulta multimodal psicopatológica",
      type: "error",
      chatId,
      timestamp: new Date().toISOString(),
    };
...
export const handlePsychopathologyQueryWithoutSaving = async (params) => {
  ...
  try {
    ...
    if (isImageRequest) {
      ...
      console.log(`🎨 Acadel generando imagen psicopatológica educativa integrada (sin guardar) - Prompt: ${imagePrompt}`);
      ...
      return {
        ...
        data: {
          ...
          url: savedImageResult.success ? savedImageResult.filePath : imageResponse.url,
          originalUrl: imageResponse.url,
          caption: `Imagen psicopatológica educativa integrando diagnóstico, manuales y enfoques teóricos sobre: ${imagePrompt}`,
          prompt: enhancedPrompt,
          originalPrompt: imagePrompt,
          psychopathologyContext: true,
          integratedPsychopathology: true,
    ...
    if (queryInfo.type === 'exam') {
      ...
      try {
        const result = await agentExecutor.invoke({
          input: UNIFIED_PSYCHOPATHOLOGY_NORMAL_QUERY_INPUT(query, queryInfo, tools, true),
          chat_history: formattedHistory,
        });
        answer = result.output;
      } catch (error) {
        console.error("Error en agente psicopatológico sin guardar:", error);
        answer = `Oye, tuve un problemita técnico, pero no me rendiré. Te doy mi respuesta psicopatológica directa:

        Sobre tu pregunta: "${query}"

        ${queryInfo.type === 'concept_explanation' ? 
          'Déjame explicarte este concepto psicopatológico desde mi experiencia docente integrando diagnóstico, manuales y enfoques teóricos. La clave aquí es entender que...' : 
          queryInfo.type === 'diagnostic_analysis' ? 
          'Vamos a analizar esto paso a paso. Primero, necesitamos considerar los síntomas observados (qué vemos), luego los criterios diagnósticos (qué dice el manual), y finalmente el marco teórico (cómo lo explicamos)...' :
          'Mi análisis psicopatológico directo integrando las disciplinas fundamentales: Este tema es importante psicopatológicamente porque...'}

        Soy solo un capibara peludo, pero he visto muchos casos como este. Si necesitas que profundice en algún aspecto específico, pregúntame de nuevo y activaré todas mis herramientas psicopatológicas.

        Recuerda: La psicopatología es fascinante cuando entiendes cómo se conectan diagnóstico, manuales y enfoques teóricos.`;
      }
    ...
    console.error("Error en handlePsychopathologyQueryWithoutSaving:", error);
...
export const handlePsychopathologyMultimodalQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, content } = params;
  ...
  try {
    ...
    console.log("🔄 Acadel procesando consulta multimodal psicopatológica integrada SIN GUARDAR:", 
    ...
    if (hasDocumentFiles) {
      console.log("📄 Procesando documentos psicopatológicos existentes (modo sin guardar)...");
      ...
      try {
        ...
        const documentContextParts = await Promise.all(documentItems.map(async (doc) => {
          ...
          // Si ya tiene contenido psicopatológico, usarlo directamente
          if (doc.extractedContent) {
            console.log(`✅ Documento psicopatológico con contenido directo: ${doc.name || doc.filename}`);
            return `${fileInfo} ${typeInfo}\n${doc.extractedContent}\n---\n`;
          } else if (doc.content) {
            console.log(`✅ Documento psicopatológico con content directo: ${doc.name || doc.filename}`);
            return `${fileInfo} ${typeInfo}\n${doc.content}\n---\n`;
          }
          ...
          if (doc.fileId) {
            try {
              console.log(`🔍 [RETRY/EDIT] Buscando por fileId psicopatológico: ${doc.fileId}`);
              ...
              if (result.rows.length > 0) {
                ...
                console.log(`✅ [RETRY/EDIT] Contenido psicopatológico recuperado por fileId: ${dbDoc.original_name} (${dbDoc.extracted_content?.length || 0} chars)`);
              ...
              console.error(`❌ Error recuperando por fileId psicopatológico ${doc.fileId}:`, error);
            }
          }
          
          // Método 2: Por nombre del archivo psicopatológico si no tiene fileId
          if (doc.name || doc.filename) {
            try {
              const searchName = doc.name || doc.filename;
              console.log(`🔍 [RETRY/EDIT] Buscando por nombre psicopatológico: ${searchName}`);
              ...
              if (result.rows.length > 0) {
                ...
                console.warn(`⚠️ [RETRY/EDIT] No se encontró documento psicopatológico por nombre: ${searchName}`);
              }
            } catch (error) {
              console.error(`❌ Error recuperando por nombre psicopatológico ${doc.name || doc.filename}:`, error);
            }
          }
          
          // Si llegamos aquí, no pudimos recuperar el contenido psicopatológico
          console.warn(`⚠️ [RETRY/EDIT] Sin contenido psicopatológico disponible para: ${doc.name || doc.filename || 'documento psicopatológico'}`);
        ...
        console.log(`📚 [RETRY/EDIT] Contenido psicopatológico procesado: ${successfulDocsCount}/${documentItems.length} documentos con contenido`);
        
        // Simular processedDocuments para compatibilidad con el resto del código psicopatológico
        processedDocuments = documentItems.map((doc, index) => {
          const hasContent = !documentContextParts[index].includes('[Contenido psicopatológico no pudo ser recuperado') && 
          ...
          return {
            ...
            originalName: doc.name || doc.filename || 'documento psicopatológico',
            attachmentType: doc.attachment_type || 'document',
            language: doc.language || null,
            extractedContent: hasContent ? 'contenido psicopatológico recuperado' : null,
            error: hasContent ? null : 'No se pudo recuperar contenido psicopatológico'
          };
        });
        
      } catch (docError) {
        console.error("Error procesando documentos psicopatológicos (sin guardar):", docError);
        documentContext += `\n[ERROR PROCESANDO DOCUMENTOS PSICOPATOLÓGICOS: ${docError.message}]\n`;
    ...
    if (hasImages) {
      console.log(`🔄 Procesando imágenes psicopatológicas en modo RETRY/EDIT...`);
      ...
      try {
        ...
        if (imagesWithVirusCount > 0 && 
          ...
          return {
            success: false,
            error: "Todas las imágenes psicopatológicas contienen contenido potencialmente malicioso",
            type: "security",
            chatId,
            timestamp: new Date().toISOString(),
          };
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🧠🦫 Acadel analizando imágenes psicopatológicas integradas (modo sin guardar)...");
            
            let analysisContext = image_ANALYSIS_USER_CONTEXT;
            
            if (extractedText) {
              analysisContext += `\n\nCONSULTA PSICOPATOLÓGICA: ${extractedText}`;
            }
            ...
            for (const img of savedImages) {
              if (img && img.success && img.dataUrl) {
                ...
                try {
                  ...
                  console.error("Error convirtiendo imagen psicopatológica:", convError);
                }
              }
            }
            ...
            if (imageContentForAnalysis.length > 0) {
              ...
              imageAnalysisText = imageAnalysis.choices[0].message.content;
              console.log("🔄 Análisis visual psicopatológico integrado completado (sin guardar)");
              
              if (imagesWithVirusCount > 0) {
                imageAnalysisText += "\n\nAlgunas imágenes psicopatológicas fueron bloqueadas por seguridad, pero analicé las que pude.";
              }
            } else {
              if (imagesWithVirusCount > 0) {
                imageAnalysisText = "Las imágenes psicopatológicas fueron bloqueadas por seguridad. Mándame otras limpias.";
              }
            }
          } catch (error) {
            console.error("Error en análisis visual psicopatológico (sin guardar):", error);
            imageAnalysisText = `Problemita técnico con la imagen psicopatológica, pero te ayudo igual con mi conocimiento psicopatológico integrado.`;
          }
        }
      } catch (imageError) {
        console.error("Error procesando imágenes psicopatológicas (sin guardar):", imageError);
        imageAnalysisText = "Error procesando imágenes psicopatológicas, pero puedo ayudarte con el texto psicopatológico.";
      }
    }
    ...
    if (documentContext) {
      combinedQuery += `\n\nDOCUMENTOS PSICOPATOLÓGICOS:\n${documentContext}`;
    }
    
    if (imageAnalysisText) {
      combinedQuery += `\n\nANÁLISIS VISUAL PSICOPATOLÓGICO INTEGRADO:\n${imageAnalysisText}`;
    }
    
    if (!combinedQuery.trim()) {
      combinedQuery = hasDocumentFiles ? 
        "Analiza los documentos psicopatológicos desde perspectiva integrada" : 
        "Analiza el contenido multimodal psicopatológico integrando diagnóstico, manuales y enfoques teóricos";
    }
    ...
    let answer;
    try {
      console.log("🔄 Acadel procesando multimodal psicopatológico integrado SIN GUARDAR...");
      const result = await agentExecutor.invoke({
        input: UNIFIED_PSYCHOPATHOLOGY_MULTIMODAL_QUERY_INPUT(extractedText, documentContext, imageAnalysisText, queryInfo, tools, true),
        chat_history: formattedHistory,
      });
      answer = result.output;
    } catch (error) {
      console.error("Error en agente multimodal psicopatológico sin guardar:", error);
      answer = `¡Oye! Problemita técnico procesando todo el contenido psicopatológico, pero no me rendiré.

${imageAnalysisText ? `🔍 Imágenes psicopatológicas: ${imageAnalysisText.substring(0, 400)}...` : ''}
${documentContext ? `📚 Documentos psicopatológicos: Material psicopatológico detectado...` : ''}

Mi respuesta psicopatológica directa integrando diagnóstico, manuales y enfoques teóricos: [Explicación basada en experiencia docente integrada]

Para análisis psicopatológico más detallado, pregúntame específicamente.`;
    }
    ...
    console.error("Error en handlePsychopathologyMultimodalQueryWithoutSaving:", error);
    ...
    return {
      success: false,
      error: error.message || "Error desconocido al procesar la consulta multimodal psicopatológica sin guardar",
      type: "error",
      chatId,
      timestamp: new Date().toISOString(),
    };
