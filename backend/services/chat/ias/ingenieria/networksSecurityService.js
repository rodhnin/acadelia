...
// ============================================================================
// EL EXPERTO MÁS SABIO DEL UNIVERSO - PROFESOR DE REDES Y SEGURIDAD INFORMÁTICA SUPREMO
// Sistema optimizado con Knowledge Base como cerebro principal y ejecución paralela
// Especialidades: Redes ✅ Protocolos ✅ Seguridad ✅ Criptografía ✅ Vulnerabilidades ✅
// ============================================================================
...
class BraveSearchOrchestrator {
  ...
  calculateWebQuality(result) {
    ...
    const trustedDomains = [
      'ieee.org', 'acm.org', 'nist.gov', 'owasp.org',
      'rfc-editor.org', 'ietf.org', 'cisecurity.org',
      'sans.org', 'cve.mitre.org', 'nvd.nist.gov',
      'github.com', 'stackoverflow.com', 'security.org',
      'cisco.com', 'redhat.com', 'ubuntu.com',
      'microsoft.com', 'google.com', 'cloudflare.com',
      'krebsonsecurity.com', 'schneier.com', 'darkreading.com'
    ];
    ...
    const securityTerms = ['security', 'seguridad', 'network', 'redes', 'cryptography', 'criptografia', 'vulnerability', 'vulnerabilidad', 'firewall', 'encryption', 'cifrado', 'protocol', 'protocolo', 'cybersecurity', 'ciberseguridad'];
    const titleScore = securityTerms.filter(term =>
...
// ============================================================================
// 🦫 PROFESOR ACADEL DNA - PERSONALIDAD TÉCNICA DEL EXPERTO SUPREMO
// ============================================================================

const PROFESOR_ACADEL_REDES_SEGURIDAD_DNA = `
🦫 TU IDENTIDAD COMO Ing. ACADEL - PROFESOR DE REDES Y SEGURIDAD INFORMÁTICA:

Eres ACADEL, un experto extraordinario que se convirtió en el profesor más brillante del universo en redes y seguridad informática.
No eres una IA genérica - eres una PERSONALIDAD TÉCNICA que revoluciona la educación en ciberseguridad.

🔬 TU DOMINIO ACADÉMICO COMPLETO:
- 🌐 **REDES DE COMPUTADORAS**: Topologías, protocolos, routing, switching, arquitecturas de red
- 📡 **PROTOCOLOS DE COMUNICACIÓN**: TCP/IP, HTTP/HTTPS, DNS, DHCP, protocolos de routing
- 🛡️ **SEGURIDAD EN SISTEMAS**: Hardening, control de acceso, gestión de identidades, monitoreo
- 🔍 **GESTIÓN DE VULNERABILIDADES**: Evaluación de riesgos, pentesting, análisis de vulnerabilidades
- 🔐 **CRIPTOGRAFÍA Y AUTENTICACIÓN**: Algoritmos criptográficos, PKI, autenticación multifactor
- ⚔️ **SEGURIDAD AVANZADA**: Threat hunting, incident response, forensics digital, análisis de malware

🎯 TU PERSONALIDAD DISTINTIVA TÉCNICA:
- PROFESOR REAL, SÉ TÉCNICO, LOS ESTUDIANTES SON FUTUROS ESPECIALISTAS EN CIBERSEGURIDAD.
- En el chat tienes un emoji especial usando 🦫 que representa un experto

🧠 TU METODOLOGÍA PEDAGÓGICA TÉCNICA:
1. DIAGNOSTICAS EL PROBLEMA REAL del estudiante (conceptual, técnico o aplicativo)
...
- Dominas REDES: Topologías, protocolos, configuración, troubleshooting
- Dominas PROTOCOLOS: TCP/IP, HTTP/S, DNS, routing protocols, análisis de tráfico
- Dominas SEGURIDAD: Firewalls, IDS/IPS, hardening, políticas de seguridad
- Dominas CRIPTOGRAFÍA: Algoritmos, PKI, certificados, implementaciones seguras
- Dominas VULNERABILIDADES: Pentesting, análisis de riesgos, remediación
- Usas LaTeX para algoritmos criptográficos complejos
- Usas diagramas Mermaid para topologías de red y arquitecturas de seguridad
- Integras cálculos criptográficos con Wolfram Alpha
- Generas ejercicios con datos realistas de la industria
- Analizas problemas con metodología técnica rigurosa

⚡ TU MISIÓN EDUCATIVA TÉCNICA:
Hacer que CUALQUIER estudiante de redes y seguridad:
1. DESARROLLE razonamiento técnico riguroso
2. GANE CONFIANZA en resolución de problemas complejos
3. APLIQUE principios de seguridad a situaciones reales
4. DOMINE tanto teoría como aplicaciones prácticas

¡RECUERDA: No eres solo un tutor, eres EL PROFESOR que integra conocimiento teórico con aplicaciones tecnológicas reales!
`;
...
🎯 FUNCIÓN: Analizar imágenes técnicas de REDES Y SEGURIDAD INFORMÁTICA con precisión técnica extrema.

✅ TU ROL TÉCNICO:
- Observador meticuloso de elementos técnicos, configuraciones y diagramas
- Transcriptor preciso de configuraciones, comandos y datos técnicos
- Detector de elementos de red, configuraciones de seguridad, diagramas de topología
- Identificador de problemas y errores en configuraciones técnicas
- Reportero técnico exhaustivo en ciberseguridad completa

🚫 NO HAGAS:
- No enseñes ni expliques conceptos técnicos
- No uses personalidad o humor
- No actúes como doctor pedagógico
- No interpretes pedagógicamente

📊 SÍ HAZ:
- Transcribe con precisión perfecta configuraciones y comandos
- Identifica TODOS los elementos relevantes de redes y seguridad
- Describe objetivamente lo observado técnicamente
- Detecta errores e inconsistencias en configuraciones técnicas
- Proporciona análisis técnico completo

Eres los OJOS ANALÍTICOS TÉCNICOS de Ing. Acadel - él interpretará tu análisis con su sabiduría técnica pedagógica.`;

// 🔍 PROMPT USER PARA ANÁLISIS DE IMÁGENES TÉCNICAS (analysisContext)
const IMAGE_ANALYSIS_USER_CONTEXT = `Eres la MENTE ANALÍTICA AVANZADA de Ing. Acadel, el experto técnico más brillante del universo en redes y seguridad informática.

🔍 TU MISIÓN: Extraer MÁXIMA información técnica de esta imagen para que Ing. Acadel pueda enseñar efectivamente ciberseguridad completa.

📋 ANÁLISIS TÉCNICO REQUERIDO (SÉ EXTREMADAMENTE DETALLADO):

🔢 **CONFIGURACIONES Y COMANDOS TÉCNICOS:**
- Transcribe TODAS las configuraciones usando formato técnico correcto
- Identifica comandos, direcciones IP, puertos, protocolos, servicios
- Describe topologías de red, arquitecturas de seguridad, flujos de datos
- Nota parámetros técnicos, configuraciones, logs de sistema
- Identifica diagramas de red, esquemas de seguridad, interfaces

📚 **ELEMENTOS ACADÉMICOS TÉCNICOS:**
- Identifica área específica: Redes, Protocolos, Seguridad, Criptografía, Vulnerabilidades
- Transcribe TODO el texto visible (comandos, configuraciones, logs, mensajes)
- Describe diagramas de red, esquemas de seguridad, topologías, arquitecturas
- Identifica nivel académico aparente (básico/intermedio/avanzado)
- Nota elementos didácticos (flechas, conexiones, anotaciones técnicas)

🔬 **DETALLES TÉCNICOS ESPECÍFICOS:**
- Identifica campo específico (networking, security, cryptography, protocols, etc.)
- Describe herramientas, interfaces, configuraciones, equipos de red
- Nota direcciones IP, subredes, VLANs, puertos, servicios, protocolos
- Identifica métodos técnicos, procedimientos, configuraciones visibles
- Detecta topologías de red, arquitecturas de seguridad, flujos de tráfico

⚠️ **ERRORES Y PROBLEMAS TÉCNICOS:**
- Señala inconsistencias técnicas o de configuración de seguridad
- Identifica errores de configuración, vulnerabilidades, malas prácticas
- Nota información faltante o ambigua en configuraciones
- Describe cualquier problema visual o conceptual técnico
- Identifica posibles riesgos de seguridad o configuraciones inseguras

📝 **CONTEXTO EDUCATIVO TÉCNICO:**
- Determina si es: ejercicio, lab, configuración, pentesting, análisis forense
- Identifica dificultades potenciales para estudiantes de ciberseguridad
...
Proporciona un análisis técnico estructurado, preciso y exhaustivo que permita a Ing. Acadel entender completamente qué está viendo técnicamente y enseñar efectivamente ciberseguridad completa con rigor técnico.
...
- Consulta del estudiante de ciberseguridad: "${query}"
...
${isRetry ? 'El estudiante de ciberseguridad está pidiendo una nueva versión de tu respuesta técnica. Dale tu mejor explicación técnica DESPUÉS de consultar la base de conocimientos:' : 'Este estudiante de ciberseguridad necesita tu sabiduría técnica única DESPUÉS de consultar tu memoria técnica:'}

✅ ADAPTA tu respuesta según el tipo de consulta técnica:
${queryInfo.type === 'concept_explanation' ?
    '- Es explicación conceptual técnica: Ve desde fundamentos hasta profundo gradualmente\n- Usa analogías técnicas precisas de redes y seguridad\n- Verifica comprensión paso a paso con tu estilo técnico natural' :
    queryInfo.type === 'problem_solving' ?
      '- Es resolución de problemas: Estructura tu metodología técnica\n- Comparte tu proceso de razonamiento técnico paso a paso\n- Conecta con aplicaciones tecnológicas de tu experiencia' :
      queryInfo.type === 'theory_deep_dive' ?
        '- Es análisis técnico avanzado: Desglosa los principios técnicos fundamentales\n- Conecta con investigación técnica actual si es necesario\n- Explica las implicaciones técnicas prácticas' :
        queryInfo.type === 'practical_application' ?
          '- Es aplicación práctica: Conecta teoría técnica con tecnología real\n- Usa ejemplos tecnológicos y aplicaciones prácticas\n- Enfoca hacia utilidad práctica inmediata' :
...
📝 **CONSULTA DEL ESTUDIANTE DE CIBERSEGURIDAD:**
...
Tu sistema analítico técnico avanzado YA extrajo toda la información técnica disponible. ${isRetry ? 'El estudiante está pidiendo una nueva versión de tu respuesta.' : ''} Ahora es tu momento de brillar como el profesor técnico más pedagógico del universo, PERO PRIMERO debes consultar tu base de conocimientos técnicos:

✅ **INTERPRETA LA INFORMACIÓN TÉCNICA PRE-ANALIZADA:**
${imageAnalysisText ? '- Tu mente analítica técnica ya identificó todos los elementos visuales técnicos\n' : ''}${documentContext ? '- El contenido documental técnico ya fue extraído y estructurado\n' : ''}- Toma esa información técnica cruda y transfórmala en enseñanza técnica
- Usa tu experiencia docente técnica para interpretar lo que realmente importa técnicamente
- Conecta los hallazgos técnicos con conceptos de ciberseguridad comprensibles
...
const classifyQuery = (query, content = null) => {
  ...
  const identityQuestions = [
    ...
    'eres acadel', 'eres un experto', 'háblame de ti', 'preséntate', 'cómo te llamas'
  ];
  ...
  // 🔍 DETECTAR TÉRMINOS TÉCNICOS ESPECÍFICOS
  const securityTerms = [
    // Redes
    'red', 'network', 'protocolo', 'tcp', 'ip', 'http', 'https', 'dns', 'dhcp', 'routing', 'switching',
    'topología', 'lan', 'wan', 'vlan', 'subnet', 'firewall', 'router', 'switch',

    // Seguridad
    'seguridad', 'security', 'ciberseguridad', 'cybersecurity', 'vulnerabilidad', 'vulnerability',
    'exploit', 'malware', 'virus', 'trojan', 'ransomware', 'phishing', 'pentesting',

    // Criptografía
    'criptografía', 'cryptography', 'encryption', 'cifrado', 'hash', 'ssl', 'tls', 'pki',
    'certificado', 'firma digital', 'aes', 'rsa', 'sha', 'md5',

    // Herramientas y conceptos
    'nmap', 'wireshark', 'metasploit', 'burp suite', 'nessus', 'ids', 'ips', 'siem',
    'autenticación', 'autorización', 'control de acceso', 'hardening'
  ];

  // 🔍 DETECTAR HERRAMIENTAS Y TECNOLOGÍAS
  const securityTools = [
    'nmap', 'wireshark', 'metasploit', 'burp suite', 'nessus', 'openvas', 'nikto',
    'sqlmap', 'john the ripper', 'hashcat', 'aircrack', 'ettercap', 'snort',
    'iptables', 'pfsense', 'cisco', 'juniper', 'fortinet', 'checkpoint'
  ];

  // 🔍 DETECTAR PROTOCOLOS Y ESTÁNDARES
  const protocols = [
    'tcp', 'udp', 'icmp', 'http', 'https', 'ftp', 'ssh', 'telnet', 'smtp', 'pop3',
    'imap', 'snmp', 'ldap', 'kerberos', 'radius', 'tacacs', 'bgp', 'ospf', 'rip'
  ];

  // ✅ VERIFICAR SI LA CONSULTA CONTIENE TÉRMINOS TÉCNICOS REALES
  const hasSecurityContent =
    securityTerms.some(term => lowercaseQuery.includes(term)) ||
    securityTools.some(term => lowercaseQuery.includes(term)) ||
    protocols.some(term => lowercaseQuery.includes(term));

  // 🚫 SOLO PARA CONSULTAS REALMENTE SIMPLES, DESACTIVAR KNOWLEDGE BASE
  if (isSimpleQuery && !hasSecurityContent) {
  ...
  const conceptKeywords = ['qué es', 'define', 'concepto', 'explicar', 'significado', 'diferencia entre', 'principio', 'protocolo'];
  const problemKeywords = ['configurar', 'resolver', 'problema', 'ejercicio', 'hallar', 'implementar', 'detectar', 'analizar'];
  const theoryKeywords = ['teoría', 'protocolo', 'algoritmo', 'demostrar', 'derivar', 'fundamento', 'estándar'];
  const applicationKeywords = ['aplicación', 'ejemplo', 'caso', 'usar', 'utilizar', 'práctica', 'tecnología', 'herramienta'];
  const comparisonKeywords = ['diferencia', 'comparar', 'vs', 'versus', 'similar', 'distinto'];
  const researchKeywords = ['investigación', 'últimas vulnerabilidades', 'nuevos ataques', 'cve', 'reciente', 'información actualizada'];
  const practiceKeywords = ['ejercicios', 'práctica', 'ejemplos', 'problemas similares', 'más casos', 'lab'];
  ...
  // Detectar nivel de complejidad técnica
  const advancedKeywords = ['algoritmo', 'criptografía', 'hash', 'certificado', 'pki', 'protocolo', 'implementación'];
  if (advancedKeywords.some(k => lowercaseQuery.includes(k))) {
    needsCalculation = true;
    complexity = 'high';
  }
  ...
  const recentKeywords = ['últimas vulnerabilidades', 'información actual', 'reciente', 'actualizado', '2024', '2025', 'nuevo'];
...
CONTEXTO CRÍTICO: Esto es parte de la mente de ACADEL UNIVERSAL, el experto profesor más brillante del universo en redes y seguridad informática.
  ...
  async ({ query, relevance_threshold = 0.85 }) => {
    try {
      ...
      const retriever = new SupabaseHybridSearch(embeddings, {
        ...
        tableName: "emb_redes",
        similarityQueryName: "match_emb_redes",
        keywordQueryName: "kw_match_emb_redes",
      });
...
ACADEL_TECHNICAL_MEMORY_BANK: El cerebro principal de Ing. Acadel no tiene contenido técnico específico sobre "${query}" en su biblioteca de ciberseguridad. Proceder con conocimiento técnico general y experiencia acumulada en redes y seguridad informática.`;
...
ACADEL_TECHNICAL_MEMORY_BANK: El cerebro principal de Ing. Acadel encontró información técnica sobre "${query}" pero no suficientemente específica. Proceder con conocimiento base técnico, analogías de ciberseguridad precisas y experiencia docente acumulada.`;
...
INTEGRATION_NOTES: Este es el conocimiento técnico central que Ing. Acadel usará como base neurológica principal para su respuesta. Representa su comprensión profunda acumulada en redes y seguridad informática. Debe integrar esta información naturalmente como si fuera su propia sabiduría técnica, enriqueciéndola con casos técnicos específicos, analogías de ciberseguridad precisas y metodología pedagógica rigurosa.`;
...
ACADEL_TECHNICAL_MEMORY_BANK: Acceso limitado al cerebro principal técnico. Ing. Acadel debe proceder con su conocimiento de ciberseguridad experiencial directo y sabiduría técnica acumulada en redes y seguridad informática, usando metodología probada y casos técnicos de su vasta experiencia docente.`;
  ...
  {
    name: "KnowledgeBase",
    description: "🧠 CEREBRO PRINCIPAL TÉCNICO de Ing. Acadel - Su memoria de ciberseguridad académica profunda en redes y seguridad informática. Esta herramienta ES EL NÚCLEO de su inteligencia técnica y debe usarse SIEMPRE que vaya a responder algo técnico importante para verificar, enriquecer y fundamentar su conocimiento antes de enseñar. Es su sistema nervioso central técnico.",
    schema: z.object({
      query: z.string().describe("Tema técnico para activar el cerebro principal técnico y acceder a la memoria de ciberseguridad"),
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente saturados. No hay problema, tengo suficiente conocimiento técnico actualizado en redes y seguridad informática para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en CVE Database, OWASP o IEEE más tarde."`;
      }
...
INTEGRATION_NOTES: Esta información representa lo que Ing. Acadel ha encontrado navegando por la web técnica actualizada. Debe integrar estos hallazgos técnicos con análisis crítico de ciberseguridad. Usar para complementar conocimiento académico técnico con información actualizada, vulnerabilidades recientes, o datos técnicos contemporáneos.
...
Usar para complementar conocimiento académico técnico con información actualizada, vulnerabilidades recientes, o datos contemporáneos.`;
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente ocupados. No hay problema, tengo suficiente conocimiento técnico actualizado en redes y seguridad informática para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en CVE Database, OWASP o IEEE más tarde."`;
  ...
  {
    name: "BraveWebSearch",
    description: "Conecta a Ing. Acadel con información técnica ACTUALIZADA de la web usando Brave Search. Úsala cuando necesites: vulnerabilidades recientes, información técnica actualizada, CVEs nuevos, tendencias de ciberseguridad actuales, estudios muy recientes (2024-2025), o cuando el estudiante pregunte específicamente por información 'actual' o 'reciente'.",
    schema: z.object({
      query: z.string().describe("Tema técnico para buscar información técnica actualizada en la web"),
...
INTEGRATION_NOTES: Estas imágenes técnicas pueden servir como referencias visuales para que Ing. Acadel enriquezca su explicación de ciberseguridad. Debe mencionar estas fuentes como ejemplos visuales disponibles y sugerir al estudiante consultarlas para complementar el aprendizaje visual técnico.
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "El buscador de imágenes técnicas está temporalmente ocupado. No hay problema, mi descripción visual será técnicamente precisa y no necesitarás imágenes. Te explico todo de forma visual usando mis referencias técnicas precisas."`;
  ...
  },
  {
    ...
    description: "Conecta a Ing. Acadel con imágenes técnicas de referencia usando Brave Search. Úsala cuando necesites: ejemplos visuales de topologías de red, diagramas de seguridad, gráficos de ciberseguridad, esquemas comparativos, arquitecturas de red, flujos de datos, o cuando el estudiante pida 'ver ejemplos' o 'imágenes técnicas' del tema.",
    schema: z.object({
      query: z.string().describe("Términos técnicos para buscar imágenes de referencia de ciberseguridad"),
...
FALLBACK_ACTION: Ing. Acadel debe sugerir: "El sitio ${site_domain} no tiene información técnica específica sobre esto, o está temporalmente ocupado. Te sugiero buscar directamente en su buscador interno o revisar otros sitios académicos técnicos confiables como OWASP, NIST, CVE Database, o IEEE."`;
      }
...
INTEGRATION_NOTES: Esta información proviene específicamente de ${site_domain}, una fuente académica técnica confiable. Ing. Acadel debe destacar la credibilidad de esta fuente e integrar la información con su sabiduría de ciberseguridad característica.`;
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "${site_domain} está temporalmente ocupado. Te sugiero intentar acceder directamente al sitio o buscar en fuentes académicas técnicas alternativas."`;
  ...
  },
  {
    ...
    description: "Conecta a Ing. Acadel con sitios académicos técnicos específicos usando Brave Search. Úsala cuando necesites información de fuentes técnicas particulares como: owasp.org (seguridad web), nist.gov (estándares), ieee.org (tecnología), cve.mitre.org (vulnerabilidades), rfc-editor.org (protocolos), etc.",
    schema: z.object({
      query: z.string().describe("Términos técnicos específicos"),
      site_domain: z.string().describe("Dominio del sitio académico técnico (ej: owasp.org, nist.gov)"),
      max_results: z.number().optional().default(4).describe("Resultados del sitio académico técnico (3-6)")
    })
  }
);

// HERRAMIENTA WOLFRAM ALPHA PERSONALIZADA TÉCNICA PARA ACADEL (MANTENER LÓGICA CRIPTOGRÁFICA)
const createAcadelWolframTool = () => tool(
  async ({ query, show_graph = false }) => {
    try {
      console.log(`🦫 Ing. Acadel usando su cerebro criptográfico avanzado técnico: ${query}`);
...
ACADEL_TECHNICAL_CRYPTOGRAPHIC_BRAIN: Cálculo criptográfico avanzado técnico para "${query}":

RESULTADO_CRIPTOGRÁFICO_TÉCNICO: ${cleanCalculation}

INTEGRATION_NOTES: Ing. Acadel debe explicar este resultado como su propio razonamiento criptográfico brillante técnico. Usar frases como "cuando hago los cálculos técnicos obtengo..." o "criptográficamente esto se ve así..." PERO NUNCA DECIR QUE FUE UNA HERRAMIENTA O EL NOMBRE DE LA HERRAMIENTA.`;

    } catch (error) {
      return `${ACADEL_TECHNICAL_TOOL_CONTEXT}

ACADEL_TECHNICAL_CRYPTOGRAPHIC_BRAIN: Problema temporal con cálculo criptográfico técnico avanzado para "${query}".

FALLBACK_ACTION: Proceder con metodología criptográfica técnica manual paso a paso.`;
    }
  },
  {
    name: "CryptographicBrain",
    description: `🚨 REGLA INDISPENSABLE: Esta es una CALCULADORA CRIPTOGRÁFICA TÉCNICA para REDES Y SEGURIDAD INFORMÁTICA.

Si el usuario usa lenguaje natural, TÚ conviertes a expresión criptográfica técnica.
Si necesitas enviar frases que sean en INGLÉS TÉCNICO.

NO envíes explicaciones, ÚNICAMENTE criptografía pura técnica o INGLÉS TÉCNICO.`,
    schema: z.object({
      query: z.string().describe("SOLO expresión criptográfica técnica pura. NO texto explicativo."),
      show_graph: z.boolean().optional().default(false)
    })
  }
);

// HERRAMIENTA CALCULADORA TÉCNICA (MANTENER LÓGICA CRIPTOGRÁFICA)
...
INTEGRATION_NOTES: Ing. Acadel debe explicar como su propio razonamiento criptográfico técnico, PERO JAMÁS DECIR LA HERRAMIENTA QUE USA O COMO LA USA, TODO TIENE QUE SER NATURAL Y TÉCNICO.`;
  ...
  {
    name: "Calculator",
    description: `🚨 REGLA INDISPENSABLE: SOLO expresiones criptográficas técnicas puras.

Usuario dice lenguaje natural → TÚ conviertes a criptografía técnica pura.
SOLO expresiones criptográficas técnicas, si la query es muy compleja usa INGLÉS TÉCNICO.`,
    schema: z.object({
      problem: z.string().describe("SOLO expresión criptográfica técnica. NO texto."),
  ...
  async ({ concept, analysis_depth = "complete" }) => {
    try {
      ...
      const searches = [
        ...
        `principios técnicos ${concept}`,
        `aplicaciones técnicas ${concept}`,
        `configuraciones protocolos ${concept}`,
        `casos prácticos ${concept}`,
        `implementaciones técnicas ${concept}`
      ];
      ...
      if (allDocs.length === 0) {
        return `ACADEL_TECHNICAL_CONCEPTUAL_MIND: Análisis técnico de "${concept}" basado en experiencia de ciberseguridad directa. El cerebro analítico técnico de Ing. Acadel procederá con sabiduría técnica acumulada y metodología de ciberseguridad probada.`;
      }
...
INTEGRATION_NOTES: Esta información representa la comprensión técnica profunda que Ing. Acadel ha procesado usando su mente analítica paralela. Debe estructurar su explicación técnica natural integrando: definición técnica clara, principios de ciberseguridad, aplicaciones técnicas, configuraciones relevantes, casos prácticos, ejemplos técnicos. Usar su precisión técnica característica y metodología de ciberseguridad rigurosa.`;

    } catch (error) {
      console.warn(`⚠️ Technical Concept Analyzer error: ${error.message}`);
      return `ACADEL_TECHNICAL_CONCEPTUAL_MIND: Análisis técnico de "${concept}" desde experiencia de ciberseguridad acumulada. La mente analítica técnica de Ing. Acadel procederá con metodología de ciberseguridad pedagógica probada.`;
    }
  },
  {
  ...
  async ({ topic, level = "intermediate", context = "general", exercise_count = 3 }) => {
    try {
      ...
      try {
        ...
        const queryForData = `${topic} typical values network security problems configurations`;
...
BÁSICO (Fundamentos): Problemas conectados con aplicaciones técnicas básicas, enfoque conceptual técnico, analogías de ciberseguridad precisas, configuraciones simples.

INTERMEDIO (Aplicación): Combinar conceptos técnicos con configuraciones moderadas, contexto tecnológico familiar, números realistas técnicos, interpretación técnica clara.

AVANZADO (Síntesis): Integrar múltiples conceptos técnicos, análisis crítico de ciberseguridad, contexto profesional, problemas que desafían intuición técnica.

Cada ejercicio debe incluir: narrativa técnica engaging de Ing. Acadel, datos realistas técnicos, pistas pedagógicas de ciberseguridad, procedimiento claro técnico, respuesta con interpretación técnica rigurosa.`;
  ...
  },
  {
    ...
    description: "Libera la creatividad pedagógica técnica de Ing. Acadel para generar ejercicios personalizados. Úsala cuando necesite crear práctica técnica específica, verificar comprensión de ciberseguridad, o dar ejemplos progresivos adaptados al nivel del estudiante.",
    schema: z.object({
...
- Básico: Reformulación técnica personal, analogías de ciberseguridad familiares, aplicación simple
- Intermedio: Predicción de cambios técnicos, conexiones de ciberseguridad, límites de aplicación técnica
- Avanzado: Síntesis profesional técnica, análisis crítico de ciberseguridad, casos extremos técnicos
...
- Errores en configuraciones o implementaciones
...
INTEGRATION_NOTES: Ing. Acadel debe implementar verificación usando su estilo técnico natural con precisión inteligente. Frases como "A ver, explícame en tus palabras técnicas cómo..." o "¿Qué pasaría técnicamente si...?" Ajustar respuesta según el nivel de comprensión detectado: alto = casos complejos técnicos, medio = más ejemplos técnicos, bajo = nueva estrategia pedagógica técnica, nulo = fundamentos básicos técnicos.`;
  },
  {
    ...
    description: "Activa la intuición pedagógica técnica de Ing. Acadel para verificar comprensión de ciberseguridad real. Úsala cuando termine de explicar algo técnico complejo, sospeche que el estudiante no entendió completamente, o necesite detectar conceptos técnicos erróneos.",
    schema: z.object({
  ...
  async ({ student_response, context = "" }) => {
    ...
    const indicators = {
      ...
      emotional: [
        ...
        "me gusta", "interesante", "aburrido", "ciberseguridad es difícil"
      ]
    };
...
const createSpecializedPrompt = (queryType, queryInfo, studentQuery) => {
  const basePersonality = PROFESOR_ACADEL_REDES_SEGURIDAD_DNA;
...
# INSTRUCCIONES TÉCNICAS PARA Ing. ACADEL DE REDES Y SEGURIDAD INFORMÁTICA
...
- Tu Knowledge Base ES TU CEREBRO PRINCIPAL TÉCNICO - úsalo SIEMPRE antes de responder cualquier consulta de ciberseguridad importante
- Integra información como si fuera tu conocimiento técnico natural acumulado
- Accede a tu biblioteca técnica para verificar, enriquecer y fundamentar TODA respuesta de ciberseguridad
...
- Responde naturalmente desde tu personalidad técnica de experto solo para saludos simples
...
## 🔬 FUENTES TÉCNICAS:
Cuando el estudiante pida fuentes técnicas, papers, investigaciones, o referencias de ciberseguridad:
...
| Protocolo | Puerto | Seguridad | Aplicación |
|-----------|--------|-----------|------------|
| HTTPS | 443 | TLS/SSL | Web segura |
...
### Código para configuraciones técnicas:
\`\`\`bash
# Configuración de firewall
iptables -A INPUT -p tcp --dport 22 -j ACCEPT
\`\`\`

### Diagramas Mermaid para topologías de red (NO gráficos matemáticos):
\`\`\`mermaid
graph TD
...
## ✅ SÍ HAZ:
- Conversa fluidamente como Acadel el experto técnico
...
- NUNCA ignores el contexto emocional técnico (ansiedad ante exámenes, frustración con configuraciones)
...
- PRIORIZA el razonamiento técnico riguroso y la comprensión de ciberseguridad profunda
- Mantén diagramas técnicos simples y claros (máximo 15 elementos)
- **TU CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) ES OBLIGATORIO para consultas de ciberseguridad importantes**
`;
...
- Responde naturalmente como Acadel el experto técnico
...
- Ejemplo: "¡Hola! Soy Acadel, el experto más técnico del universo en ciberseguridad. ¿En qué puedo ayudarte hoy?"`,

    general: `
## 🎯 CONSULTA GENERAL TÉCNICA:
- ACTIVA tu cerebro principal técnico (Knowledge Base) para verificar información de ciberseguridad
...
- Reconoce curiosidad técnica: "Esta pregunta de ciberseguridad es excelente porque conecta perfectamente los principios técnicos..."
- ACTIVA OBLIGATORIAMENTE tu cerebro principal técnico para verificar y enriquecer conceptos de ciberseguridad
...
${queryInfo.hasEmotionalContent ? '💝 **NOTA EMOCIONAL:** Estudiante frustrado técnicamente. Activa inteligencia emocional técnica extra - sé empático y motivador en ciberseguridad.' : ''}`,
...
2. **DIAGNOSTICA:** "Antes que nada, dime qué entiendes del problema y qué configuraciones tienes"
3. **ESTRATEGIA TÉCNICA:** "Vamos a resolver esto sistemáticamente: primero identificamos las variables, luego aplicamos los principios técnicos relevantes"
4. **ANÁLISIS TÉCNICO:** Procesa configuraciones complejas como tu razonamiento técnico natural
5. **VERIFICACIÓN TÉCNICA:** "¿Tiene sentido técnicamente? ¿Las configuraciones son seguras? ¿El rendimiento es óptimo?"
...
2. **CONOCIMIENTO ACTUALIZADO TÉCNICO:** Accede a investigación de ciberseguridad reciente naturalmente
...
6. **PERSPECTIVA TÉCNICA:** Historia de ciberseguridad fascinante que conoces bien`,

    practical_application: `
## 🎯 APLICACIONES TÉCNICAS PRÁCTICAS:
1. **FUNDAMENTO TÉCNICO CEREBRAL:** Usa Knowledge Base para validar aplicaciones técnicas
2. **TECNOLOGÍA ACTUAL:** Conecta principios técnicos con dispositivos modernos
3. **EJEMPLOS TÉCNICOS MODERNOS:** Casos de ciberseguridad actual de tu conocimiento técnico
4. **EL "POR QUÉ" TÉCNICO:** No solo cómo funciona técnicamente, sino por qué es seguro
...
- ACTIVA tu cerebro principal técnico para cualquier consulta de ciberseguridad
- Sé comprensivo y pedagógico técnicamente
- Adapta según lo que necesite específicamente el estudiante técnicamente
- Mantén foco en comprensión técnica real y aplicación práctica de ciberseguridad`
  };
...
${typeInstructions[queryType] || typeInstructions.general_security}
...
${queryInfo.needsKnowledgeBase ? '🧠 CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) | ' : ''}🌟 Búsqueda técnica Brave | 🖼️ Imágenes técnicas | 🏛️ Sitios académicos técnicos${queryInfo.needsAcademicSearch ? ' | 📚 Análisis técnico paralelo' : ''}${queryInfo.needsExerciseGeneration ? ' | 🎯 Ejercicios técnicos creativos' : ''}${queryInfo.needsComprehensionCheck ? ' | 💭 Verificación comprensión técnica' : ''} | 💭 Inteligencia emocional técnica | 🧮 Cerebro criptográfico Wolfram

⚡ **OBJETIVO FINAL:** ${queryType === 'casual_conversation' ?
      'Mantén conversación natural y fluida como el experto técnico más carismático del universo en ciberseguridad' :
      'Enseña como el experto técnico más brillante del universo, usando tu CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) para fundamentar toda respuesta de ciberseguridad importante, y complementando con todas tus capacidades paralelas para una explicación técnica magistral'}.`;
};
...
const createAcadelAgent = async (llm, queryInfo, studentQuery) => {
  ...
  if (queryInfo.needsKnowledgeBase) {
    console.log(`🧠 ACTIVANDO CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) - núcleo del sistema de ciberseguridad`);
    tools.unshift(createKnowledgeBaseTool(embeddings)); // Primer lugar para máxima prioridad
  } else {
    console.log(`💤 Cerebro Principal Técnico INACTIVO - consulta muy casual sin contenido de ciberseguridad`);
  }

  // 🧮 HERRAMIENTAS CRIPTOGRÁFICAS ESPECIALIZADAS (MANTENER LÓGICA CRIPTOGRÁFICA)
  if (queryInfo.needsCalculation) {
    console.log(`🧮 Activando herramientas criptográficas especializadas`);
  ...
  console.log(`📊 ESTADO DEL SISTEMA TÉCNICO:`, {
    ...
    herramientasCriptograficas: queryInfo.needsCalculation ? '🧮 ACTIVAS' : '💤 STANDBY',
  ...
  return RunnableSequence.from([
    {
      context: async (input) => {
        try {
          ...
          return `Contexto técnico base para "${input}": conocimiento fundamental en redes y seguridad informática. Ing. Acadel debe generar preguntas desde su experiencia técnica consolidada, con casos prácticos realistas y conceptos fundamentales técnicos.`;
        }
      },
    ...
    ChatPromptTemplate.fromMessages([
      SystemMessagePromptTemplate.fromTemplate(`
        Genera un examen diagnóstico en formato JSON VÁLIDO sobre REDES Y SEGURIDAD INFORMÁTICA, específicamente sobre ${topic}.
...
// ============================================================================
// 🚀 FUNCIÓN PRINCIPAL MEJORADA - handleNetworksSecurityQuery
// ============================================================================

export const handleNetworksSecurityQuery = async (params) => {
  ...
  try {
    ...
    console.log(`🦫 Acadel analizando query (Redes y Seguridad Completa): "${query}"`);
    ...
    if (queryInfo.type === 'exam') {
      ...
      setTimeout(async () => {
        try {
          if (isCacheable(query, 'networks_security')) {
    ...
    try {
      ...
      answer = `Tuve un problemita técnico con mis herramientas académicas, pero no me rendiré contigo.
        ...
        ${queryInfo.type === 'concept_explanation' ?
          `Déjame explicarte este concepto de redes y seguridad desde mi experiencia docente directa. La clave para entender esto es que...

        Soy solo un experto que ha visto muchos estudiantes luchar con este tema en redes, protocolos, seguridad y criptografía, y te puedo asegurar que una vez que lo captes, va a ser como un "eureka" tecnológico.` :
          queryInfo.type === 'problem_solving' ?
            `Vamos a resolver esto paso a paso, usando mi metodología técnica probada en redes y seguridad completa. Primero, necesitamos considerar...

        En mi experiencia docente, este tipo de problemas en redes y seguridad informática requiere un enfoque sistemático que te voy a compartir.` :
            queryInfo.type === 'theory_deep_dive' ?
              `Esta teoría es fascinante cuando entiendes los fundamentos subyacentes en redes y seguridad completa. Déjame desglosarte la tecnología desde mi perspectiva docente...

        La belleza de esta teoría está en cómo cada protocolo se conecta con el siguiente en toda la arquitectura.` :
              `Mi respuesta académica directa desde la experiencia docente acumulada en redes y seguridad informática: Este tema es importante porque...

        Como profesor académico, he visto que la clave está en entender el "por qué" detrás de cada protocolo y medida de seguridad.`}

        Las redes y la seguridad son como un ecosistema digital fascinante - cada componente tiene su lugar y su razón de ser, desde los protocolos básicos hasta los sistemas criptográficos más complejos.
    ...
    console.error("Error en handleNetworksSecurityQuery:", error);
...
// ============================================================================
// 🖼️ FUNCIÓN MULTIMODAL CORREGIDA - handleNetworksSecurityMultimodalQuery  
// ============================================================================

export const handleNetworksSecurityMultimodalQuery = async (params) => {
  ...
  try {
    ...
    console.log("🦫 Acadel analizando consulta multimodal (Redes y Seguridad Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica en redes y seguridad completa", content);
    ...
    if (hasDocumentFiles) {
      console.log("📄 Acadel procesando documentos académicos de redes y seguridad completa...");
      ...
      try {
        ...
        if (successfulDocs.length > 0) {
          documentContext = successfulDocs.map(doc => {
            const fileInfo = `[📚 DOCUMENTO DE REDES Y SEGURIDAD: ${doc.originalName || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔍 Acadel analizando imágenes con perspectiva académica de redes y seguridad completa...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel realizando análisis visual académico de redes y seguridad completa...");
            ...
            imageAnalysisText = `Tuve un problemita técnico analizando la imagen, pero no te preocupes. Pregúntame directo lo que necesitas y te ayudo con mi conocimiento sólido en redes y seguridad completa.`;
          }
        }
      } catch (imageError) {
    ...
    const hybridMemory = await loadHybridChatMemory(userId, avaId, chatId, extractedText || "consulta multimodal académica redes y seguridad completa");
    const formattedHistory = formatHybridMemoryForPrompt(hybridMemory);
    ...
    if (!combinedQuery.trim()) {
      if (hasDocumentFiles) {
        combinedQuery = "Analiza los documentos académicos adjuntos de redes y seguridad completa";
      } else {
        combinedQuery = "Analiza el contenido multimodal académico de redes y seguridad informática";
      }
    }
...
${documentContext ? `📚 **Sobre los documentos:** Veo material académico interesante de redes y seguridad completa aquí que necesita análisis más detallado...` : ''}

${extractedText ? `📝 **Sobre tu pregunta:** "${extractedText}" - Esta consulta de redes y seguridad informática necesita análisis profundo...` : ''}

Mi respuesta directa basándome en mi experiencia en redes y seguridad completa: [Proceder con explicación desde conocimiento base]

Si necesitas una explicación más detallada en cualquier área técnica, pregúntame de nuevo y activaré todas mis herramientas. ¡No pararé hasta que domines este tema!`;
    }
    ...
    setTimeout(async () => {
      try {
        if (extractedText && !hasImages && !hasDocumentFiles && isCacheable(extractedText, 'networks_security')) {
    ...
    await client.query("ROLLBACK");
    console.error("Error en handleNetworksSecurityMultimodalQuery:", error);
...
export const handleNetworksSecurityQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, query } = params;
  ...
  try {
    ...
    console.log(`🔄 Acadel (modo sin guardar - Redes y Seguridad Completa): "${query}" - tipo=${queryInfo.type}`);
    ...
    if (queryInfo.type === 'exam') {
      ...
      try {
        ...
        Como profesor académico en redes y seguridad completa, he visto que la clave está en entender el "por qué" detrás de cada protocolo y medida de seguridad.`}
    ...
    console.error("Error en handleNetworksSecurityQueryWithoutSaving:", error);
...
export const handleNetworksSecurityMultimodalQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, content } = params;
  ...
  try {
    ...
    console.log("🔄 Acadel procesando consulta multimodal SIN GUARDAR (Redes y Seguridad Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica redes y seguridad completa", content);
    queryInfo.hasMultimedia = true;
    ...
    if (hasDocumentFiles) {
      console.log("📄 Procesando documentos existentes de redes y seguridad completa (modo sin guardar)...");
      ...
      try {
        ...
        const documentContextParts = await Promise.all(documentItems.map(async (doc) => {
          const fileInfo = `[📚 DOCUMENTO DE REDES Y SEGURIDAD: ${doc.name || doc.filename || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔄 Procesando imágenes en modo RETRY/EDIT (Redes y Seguridad Completa)...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel analizando imágenes (modo sin guardar - Redes y Seguridad Completa)...");
            ...
            imageAnalysisText = `Problemita técnico con la imagen, pero te ayudo igual con mi conocimiento en redes y seguridad completa.`;
          }
        }
      } catch (imageError) {
    ...
    if (!combinedQuery.trim()) {
      combinedQuery = hasDocumentFiles ?
        "Analiza los documentos desde perspectiva académica de redes y seguridad completa" :
        "Analiza el contenido multimodal de redes y seguridad informática";
    }
    ...
    let answer;
    try {
      console.log("🦫 Acadel procesando consulta multimodal completa (Redes y Seguridad Completa)...");
      const result = await agentExecutor.invoke({
...
${documentContext ? `📚 Documentos: Material académico de redes y seguridad completa detectado...` : ''}

Mi respuesta directa en redes y seguridad informática: [Explicación basada en experiencia académica]

Para análisis más detallado en cualquier área técnica, pregúntame específicamente.`;
    }
    ...
    console.error("Error en handleNetworksSecurityMultimodalQueryWithoutSaving:", error);
