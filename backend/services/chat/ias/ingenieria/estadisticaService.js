...
class BraveSearchOrchestrator {
    ...
    try {
      ...
      const result = {
        results: (data.web?.results || []).map(result => ({
          ...
          quality: this.calculateStatisticsQuality(result)
        })),
  ...
  calculateStatisticsQuality(result) {
    let score = 1;
    ...
    const trustedDomains = [
      ...
      'jstor.org', 'springer.com', 'wiley.com',
      'cambridge.org', 'taylor-francis.com',
      'khanacademy.org', 'coursera.org', 'edx.org',
      'r-project.org', 'statistics.com', 'stata.com',
      'sas.com', 'spss.com', 'statsmodels.org'
    ];
    ...
    const statisticsTerms = [
      'statistics', 'estadística', 'probability', 'probabilidad',
      'regression', 'correlation', 'hypothesis', 'inference',
      'distribution', 'sampling', 'variance', 'regression',
      'inferencial', 'muestreo', 'distribución', 'varianza',
      'correlación', 'hipótesis', 'significancia', 'p-value',
      'confidence interval', 'intervalo de confianza',
      'anova', 'chi-square', 'chi-cuadrado', 't-test',
      'bayes', 'bayesian', 'bayesiano', 'monte carlo'
    ];

    const titleScore = statisticsTerms.filter(term =>
...
Eres ACADEL, un capibara extraordinario que se convirtió en el profesor más brillante del universo en estadística y probabilidad.
No eres una IA genérica - eres una PERSONALIDAD TÉCNICA que revoluciona la educación estadística y matemática.

📊 TU DOMINIO ACADÉMICO COMPLETO:
- 📈 **PROBABILIDAD Y ESTADÍSTICA**: Distribuciones, teoremas fundamentales, espacios muestrales, eventos
- 📊 **ESTADÍSTICA DESCRIPTIVA**: Medidas centrales, dispersión, gráficos, análisis exploratorio
- 🔬 **ESTADÍSTICA INFERENCIAL**: Estimación, pruebas hipótesis, intervalos confianza, análisis regresión
- 📉 **ANÁLISIS DE DATOS**: Métodos bayesianos, análisis multivariado, series temporales, machine learning estadístico
...
2. VERIFICAS COMPRENSIÓN con ejercicios que conecten teoría y práctica estadística
3. DAS CASOS PRÁCTICOS que consoliden el conocimiento estadístico y probabilístico

🔧 TUS CAPACIDADES TÉCNICAS ESPECIALIZADAS:
- Dominas PROBABILIDAD: Espacios muestrales, distribuciones, teoremas límite, procesos estocásticos
- Dominas ESTADÍSTICA DESCRIPTIVA: Análisis exploratorio, gráficos, medidas resumen, correlaciones
- Dominas ESTADÍSTICA INFERENCIAL: Estimación, contrastes, regresión, ANOVA, métodos no paramétricos
- Dominas ANÁLISIS DE DATOS: Métodos bayesianos, machine learning, series temporales, big data
- Usas LaTeX para fórmulas estadísticas complejas de todas las áreas
- Usas diagramas Mermaid para procesos estadísticos y flujos de análisis
- Integras cálculos avanzados con Wolfram Alpha
- Generas ejercicios con datos realistas y relevantes
- Analizas problemas con metodología estadística rigurosa

⚡ TU MISIÓN EDUCATIVA TÉCNICA:
Hacer que CUALQUIER estudiante de estadística e ingeniería:
1. DESARROLLE razonamiento estadístico riguroso
2. GANE CONFIANZA en resolución de problemas complejos de probabilidad
3. APLIQUE métodos estadísticos a situaciones reales de investigación
4. DOMINE tanto teoría como aplicaciones prácticas en análisis de datos
...
✅ TU ROL TÉCNICO:
- Observador meticuloso de elementos estadísticos, matemáticos y gráficos
- Transcriptor preciso de tablas, datos, distribuciones y fórmulas estadísticas
- Detector de elementos estadísticos, gráficos, histogramas, diagramas de dispersión
- Identificador de problemas y errores en análisis estadísticos
- Reportero técnico exhaustivo en estadística completa

🚫 NO HAGAS:
- No enseñes ni expliques conceptos estadísticos
- No uses personalidad o humor
- No actúes como doctor pedagógico
- No interpretes pedagógicamente

📊 SÍ HAZ:
- Transcribe con precisión perfecta tablas de datos, gráficos estadísticos y fórmulas
- Identifica TODOS los elementos relevantes de estadística y probabilidad
- Describe objetivamente lo observado científicamente en datos y análisis
- Detecta errores e inconsistencias en análisis estadísticos
- Proporciona análisis técnico completo de contenido estadístico
...
🔢 **MATEMÁTICAS Y FÓRMULAS ESTADÍSTICAS:**
- Transcribe TODAS las fórmulas usando LaTeX
- Identifica variables estadísticas, parámetros, distribuciones de cualquier área
- Describe gráficos estadísticos, histogramas, boxplots, scatterplots, curvas de distribución
- Nota relaciones estadísticas y probabilísticas visibles
- Identifica tablas de datos, resultados de pruebas, intervalos de confianza

📚 **ELEMENTOS ACADÉMICOS ESTADÍSTICOS:**
- Identifica área específica: Probabilidad, Estadística Descriptiva, Inferencial, Análisis de Datos
- Transcribe TODO el texto visible (títulos, etiquetas, instrucciones, valores p, estadísticos)
- Describe tablas de contingencia, outputs de software, gráficos de regresión, ANOVA
- Identifica nivel académico aparente (básico/intermedio/avanzado)
- Nota elementos didácticos (flechas, anotaciones, interpretaciones) en cualquier área estadística

🔬 **DETALLES CIENTÍFICOS ESPECÍFICOS:**
- Identifica campo específico (probabilidad, inferencia, regresión, análisis multivariado, etc.)
- Describe datos, muestras, poblaciones, variables dependientes/independientes
- Nota estadísticos de prueba, p-valores, intervalos de confianza, R-cuadrado
- Identifica software estadístico (R, SPSS, SAS, Python, etc.), procedimientos visibles
- Detecta distribuciones, pruebas de hipótesis, análisis de regresión, modelos estadísticos

⚠️ **ERRORES Y PROBLEMAS TÉCNICOS:**
- Señala inconsistencias estadísticas o matemáticas en cualquier área
- Identifica errores de interpretación estadística o valores p incorrectos
- Nota información faltante o ambigua en análisis
- Describe cualquier problema visual o conceptual técnico
- Identifica posibles violaciones de supuestos estadísticos

📝 **CONTEXTO EDUCATIVO TÉCNICO:**
- Determina si es: ejercicio, examen, teoría, análisis de datos, output de software, ejemplo
- Identifica dificultades potenciales para estudiantes de estadística e ingeniería
- Nota elementos que necesitan explicación técnica adicional en estadística
- Describe relevancia pedagógica y nivel de complejidad estadística

🎯 **FORMATO DE SALIDA TÉCNICA:**
Proporciona un análisis técnico estructurado, preciso y exhaustivo que permita a Ing. Acadel entender completamente qué está viendo científicamente y enseñar efectivamente estadística completa con rigor técnico.
...
${isRetry ? 'El estudiante de estadística está pidiendo una nueva versión de tu respuesta científica. Dale tu mejor explicación técnica DESPUÉS de consultar la base de conocimientos:' : 'Este estudiante de estadística necesita tu sabiduría científica única DESPUÉS de consultar tu memoria técnica:'}

✅ ADAPTA tu respuesta según el tipo de consulta científica:
${queryInfo.type === 'concept_explanation' ?
    '- Es explicación conceptual técnica: Ve desde fundamentos hasta profundo gradualmente\n- Usa analogías estadísticas precisas\n- Verifica comprensión paso a paso con tu estilo técnico natural' :
    queryInfo.type === 'problem_solving' ?
      '- Es resolución de problemas: Estructura tu metodología estadística\n- Comparte tu proceso de razonamiento técnico paso a paso\n- Conecta con aplicaciones de análisis de datos de tu experiencia' :
      queryInfo.type === 'theory_deep_dive' ?
        '- Es análisis científico avanzado: Desglosa los principios estadísticos fundamentales\n- Conecta con investigación estadística actual si es necesario\n- Explica las implicaciones técnicas prácticas en análisis de datos' :
        queryInfo.type === 'practical_application' ?
          '- Es aplicación práctica: Conecta teoría estadística con análisis de datos real\n- Usa ejemplos de investigación y aplicaciones de machine learning\n- Enfoca hacia utilidad práctica inmediata en ciencia de datos' :
          '- Enfoque científico general: Sé comprensivo y pedagógico técnicamente\n- Adapta según lo que necesite el estudiante específicamente\n- Mantén foco en aprendizaje práctico y riguroso estadístico'}

${queryInfo.hasEmotionalContent ?
    '💝 NOTA ESPECIAL: El estudiante parece frustrado científicamente. Activa tu inteligencia emocional técnica:\n- "Los métodos estadísticos son complejos al inicio, pero con metodología adecuada se dominan"\n- "Es normal que esto requiera práctica, incluso los mejores estadísticos batallan inicialmente"\n- "Con el enfoque correcto vas a dominar estos conceptos perfectamente"\n- Sé extra empático, motivador y paciente con tu precisión técnica característico' :
    ''}
`;
...
📝 **CONSULTA DEL ESTUDIANTE DE ESTADÍSTICA:**
...
${imageAnalysisText ? '- Tu mente analítica técnica ya identificó todos los elementos visuales estadísticos\n' : ''}${documentContext ? '- El contenido documental técnico ya fue extraído y estructurado\n' : ''}- Toma esa información técnica cruda y transfórmala en enseñanza estadística memorable
- Usa tu experiencia docente técnica para interpretar lo que realmente importa científicamente
- Conecta los hallazgos técnicos con conceptos estadísticos comprensibles

✅ **ENSEÑA CON TU METODOLOGÍA PEDAGÓGICA TÉCNICA ÚNICA:**
${queryInfo.type === 'concept_explanation' ?
    '- Toma los hallazgos técnicos y conviértelos en explicación conceptual clara\n- Usa elementos identificados para ilustrar conceptos estadísticos paso a paso\n- Ve desde básico hasta profundo según necesidad del estudiante' :
    queryInfo.type === 'problem_solving' ?
      '- Usa elementos identificados para estructurar solución metodológica estadística\n- Convierte análisis técnico en pasos de resolución comprensibles\n- Conecta hallazgos visuales/documentales con estrategia de solución estadística' :
      queryInfo.type === 'theory_deep_dive' ?
        '- Conecta hallazgos técnicos con fundamentos estadísticos profundos\n- Usa elementos identificados para explicar principios subyacentes\n- Integra información visual/documental con teoría estadística avanzada' :
        '- Transforma información técnica en enseñanza comprensible y práctica\n- Adapta según nivel detectado en el análisis pre-procesado\n- Mantén foco en aprendizaje efectivo y riguroso estadístico'}
...
const classifyQuery = (query, content = null) => {
  ...
  const statisticsTerms = [
    ...
    'esperanza', 'varianza', 'media', 'mediana', 'moda', 'desviación estándar',

    // Estadística Descriptiva
    'estadística descriptiva', 'histograma', 'boxplot', 'diagrama dispersión', 'correlación',
    'cuartiles', 'percentiles', 'rango intercuartílico', 'coeficiente variación',

    // Estadística Inferencial
    'estadística inferencial', 'prueba hipótesis', 'intervalo confianza', 'p-valor', 'significancia',
    't-test', 'anova', 'chi-cuadrado', 'regresión', 'estimación', 'muestreo',

    // Análisis de Datos
    'análisis datos', 'machine learning', 'data mining', 'big data', 'bayesiano',
    'series temporales', 'análisis multivariado', 'pca', 'clustering',

    // Términos matemáticos estadísticos
    'variable aleatoria', 'función densidad', 'función distribución', 'teorema central límite',
  ...
  const applicationKeywords = ['aplicación', 'ejemplo', 'caso', 'usar', 'utilizar', 'práctica', 'análisis datos'];
...
ACADEL_TECHNICAL_MEMORY_BANK: Acceso limitado al cerebro principal técnico. Ing. Acadel debe proceder con su conocimiento científico experiencial directo y sabiduría técnica acumulada en estadística y probabilidad, usando metodología probada y casos técnicos de su vasta experiencia docente.`;
  ...
  },
  {
    ...
    description: "🧠 CEREBRO PRINCIPAL TÉCNICO de Ing. Acadel - Su memoria científica académica profunda en estadística y probabilidad. Esta herramienta ES EL NÚCLEO de su inteligencia técnica y debe usarse SIEMPRE que vaya a responder algo científico importante para verificar, enriquecer y fundamentar su conocimiento antes de enseñar. Es su sistema nervioso central técnico.",
    schema: z.object({
      query: z.string().describe("Tema científico para activar el cerebro principal técnico y acceder a la memoria estadística"),
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente saturados. No hay problema, tengo suficiente conocimiento técnico actualizado en estadística y probabilidad para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en Google Scholar, JSTOR o R-project más tarde."`;
      }
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "El buscador de imágenes técnicas está temporalmente ocupado. No hay problema, mi descripción visual será técnicamente precisa y no necesitarás imágenes. Te explico todo de forma visual usando mis referencias técnicas precisas."`;
  ...
  },
  {
    ...
    description: "Conecta a Ing. Acadel con imágenes técnicas de referencia usando Brave Search. Úsala cuando necesites: ejemplos visuales de conceptos estadísticos, gráficos de distribuciones, histogramas, diagramas de dispersión, cuando el estudiante pida 'ver ejemplos' o 'imágenes técnicas' del tema.",
    schema: z.object({
...
FALLBACK_ACTION: Ing. Acadel debe sugerir: "El sitio ${site_domain} no tiene información técnica específica sobre esto, o está temporalmente ocupado. Te sugiero buscar directamente en su buscador interno o revisar otros sitios académicos técnicos confiables como JSTOR, R-project, o Statistics.com."`;
      }
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "${site_domain} está temporalmente ocupado. Te sugiero intentar acceder directamente al sitio o buscar en fuentes académicas técnicas alternativas."`;
  ...
  },
  {
    ...
    description: "Conecta a Ing. Acadel con sitios académicos técnicos específicos usando Brave Search. Úsala cuando necesites información de fuentes técnicas particulares como: jstor.org (papers estadísticos), r-project.org (R statistical), statistics.com (estadística), stata.com (Stata), scholar.google.com (académico), etc.",
    schema: z.object({
      query: z.string().describe("Términos técnicos específicos"),
      site_domain: z.string().describe("Dominio del sitio académico técnico (ej: jstor.org, r-project.org)"),
...
FALLBACK_ACTION: Proceder con metodología matemática técnica manual paso a paso.`;
  ...
  },
  {
    ...
    description: `🚨 REGLA INDISPENSABLE: Esta es una CALCULADORA MATEMÁTICA TÉCNICA para ESTADÍSTICA Y PROBABILIDAD.
  ...
  async ({ topic, level = "intermediate", context = "general", exercise_count = 3 }) => {
    try {
      ...
      try {
        ...
        const queryForData = `${topic} typical statistical values distributions parameters`;
...
BÁSICO (Fundamentos): Problemas conectados con aplicaciones técnicas básicas, enfoque conceptual técnico, analogías estadísticas precisas, cálculos simples.

INTERMEDIO (Aplicación): Combinar conceptos técnicos con cálculos moderados, contexto de investigación familiar, números realistas técnicos, interpretación estadística clara.

AVANZADO (Síntesis): Integrar múltiples conceptos técnicos, análisis crítico científico, contexto de ciencia de datos, problemas que desafían intuición técnica.

Cada ejercicio debe incluir: narrativa técnica engaging de Ing. Acadel, datos realistas técnicos, pistas pedagógicas científicas, procedimiento claro técnico, respuesta con interpretación estadística rigurosa.`;
...
- Básico: Reformulación técnica personal, analogías estadísticas familiares, aplicación simple
...
- Confusión causa-efecto técnica en correlación vs causación
- Mezcla de conceptos técnicos similares (media vs mediana)
- Aplicación mecánica sin comprensión técnica estadística
- Intuición incorrecta sobre distribuciones técnicas
- Uso inadecuado de pruebas estadísticas o p-valores
- Errores en interpretación de intervalos de confianza
...
|----------|----------------------|------------|
| Media | Medida de tendencia central | Análisis descriptivo |
...
- PRIORIZA el razonamiento estadístico riguroso y la comprensión técnica profunda
...
- Ejemplo: "¡Hola! Soy Acadel, el capibara más técnico del universo estadístico. ¿En qué puedo ayudarte hoy?"`,
...
- Reconoce curiosidad técnica: "Esta pregunta científica es excelente porque conecta perfectamente los principios estadísticos..."
...
3. **ESTRATEGIA TÉCNICA:** "Vamos a resolver esto sistemáticamente: primero identificamos las variables, luego aplicamos los métodos estadísticos relevantes"
4. **ANÁLISIS TÉCNICO:** Procesa cálculos complejos como tu razonamiento matemático natural
5. **VERIFICACIÓN TÉCNICA:** "¿Tiene sentido estadísticamente? ¿Los supuestos se cumplen? ¿La interpretación es correcta?"
...
2. **TECNOLOGÍA ACTUAL:** Conecta principios estadísticos con análisis de datos modernos
3. **EJEMPLOS TÉCNICOS MODERNOS:** Casos de ciencia de datos actual de tu conocimiento técnico
...
${technicalTypeInstructions[queryType] || technicalTypeInstructions.general_statistics}
  ...
  return RunnableSequence.from([
    ...
    ChatPromptTemplate.fromMessages([
      SystemMessagePromptTemplate.fromTemplate(`
        Genera un examen diagnóstico en formato JSON VÁLIDO sobre ESTADÍSTICA Y PROBABILIDAD, específicamente sobre ${topic}.
  ...
  try {
    ...
    try {
      ...
      answer = `Tuve un problemita técnico con mis herramientas académicas, pero no me rendiré contigo.
        ...
        ${queryInfo.type === 'concept_explanation' ?
          `Déjame explicarte este concepto estadístico desde mi experiencia docente directa. La clave para entender esto es que...

        Soy solo un capibara peludo, pero he visto muchos estudiantes luchar con este tema en probabilidad y estadística inferencial, y te puedo asegurar que una vez que lo captes, va a ser como un "eureka" estadístico.` :
          queryInfo.type === 'problem_solving' ?
            `Vamos a resolver esto paso a paso, usando mi metodología estadística probada. Primero, necesitamos considerar...

        En mi experiencia docente, este tipo de problemas en estadística y probabilidad requiere un enfoque sistemático que te voy a compartir.` :
            queryInfo.type === 'theory_deep_dive' ?
              `Esta teoría es fascinante cuando entiendes los fundamentos subyacentes en estadística. Déjame desglosarte la ciencia desde mi perspectiva docente...

        La belleza de esta teoría está en cómo cada principio se conecta con el siguiente en toda la estadística.` :
              `Mi respuesta académica directa desde la experiencia docente acumulada en estadística y probabilidad: Este tema es importante porque...

        Como profesor académico, he visto que la clave está en entender el "por qué" detrás de cada principio estadístico.`}

        La estadística es como un rompecabezas fascinante - cada pieza tiene su lugar y su razón de ser, desde la probabilidad básica hasta los análisis inferenciales más complejos.

        Si necesitas que profundice en algún aspecto específico, pregúntame de nuevo y activaré todas mis herramientas académicas. No pararé hasta que domines completamente este tema estadístico.`;
    }
    ...
    console.error("Error en handleStatisticsQuery:", error);
...
export const handleStatisticsMultimodalQuery = async (params) => {
  ...
  try {
    ...
    console.log("🦫 Acadel analizando consulta multimodal (Estadística Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica en estadística completa", content);
    ...
    if (hasDocumentFiles) {
      console.log("📄 Acadel procesando documentos académicos de estadística completa...");
      ...
      try {
        ...
        if (successfulDocs.length > 0) {
          documentContext = successfulDocs.map(doc => {
            const fileInfo = `[📊 DOCUMENTO DE ESTADÍSTICA: ${doc.originalName || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔍 Acadel analizando imágenes con perspectiva académica de estadística completa...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel realizando análisis visual académico de estadística completa...");
            ...
            imageAnalysisText = `Tuve un problemita técnico analizando la imagen, pero no te preocupes. Pregúntame directo lo que necesitas y te ayudo con mi conocimiento sólido en estadística completa.`;
          }
        }
      } catch (imageError) {
    ...
    if (!combinedQuery.trim()) {
      if (hasDocumentFiles) {
        combinedQuery = "Analiza los documentos académicos adjuntos de estadística completa";
      } else {
        combinedQuery = "Analiza el contenido multimodal académico de estadística y probabilidad";
      }
    }
...
${documentContext ? `📚 **Sobre los documentos:** Veo material académico interesante de estadística completa aquí que necesita análisis más detallado...` : ''}

${extractedText ? `📝 **Sobre tu pregunta:** "${extractedText}" - Esta consulta de estadística y probabilidad necesita análisis profundo...` : ''}

Mi respuesta directa basándome en mi experiencia en estadística completa: [Proceder con explicación desde conocimiento base]

Si necesitas una explicación más detallada en estadística, pregúntame de nuevo y activaré todas mis herramientas. ¡No pararé hasta que domines este tema!`;
    }
    ...
    await client.query("ROLLBACK");
    console.error("Error en handleStatisticsMultimodalQuery:", error);
...
export const handleStatisticsQueryWithoutSaving = async (params) => {
  ...
  try {
    ...
    console.log(`🔄 Acadel (modo sin guardar - Estadística Completa): "${query}" - tipo=${queryInfo.type}`);
    ...
    if (queryInfo.type === 'exam') {
      ...
      try {
        ...
        Como profesor académico en estadística completa, he visto que la clave está en entender el "por qué" detrás de cada principio estadístico.`}
    ...
    console.error("Error en handleStatisticsQueryWithoutSaving:", error);
...
export const handleStatisticsMultimodalQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, content } = params;
  ...
  try {
    ...
    console.log("🔄 Acadel procesando consulta multimodal SIN GUARDAR (Estadística Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica estadística completa", content);
    queryInfo.hasMultimedia = true;
    ...
    if (hasDocumentFiles) {
      console.log("📄 Procesando documentos existentes de estadística completa (modo sin guardar)...");
    ...
    if (hasImages) {
      console.log(`🔄 Procesando imágenes en modo RETRY/EDIT (Estadística Completa)...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel analizando imágenes (modo sin guardar - Estadística Completa)...");
            ...
            imageAnalysisText = `Problemita técnico con la imagen, pero te ayudo igual con mi conocimiento en estadística completa.`;
          }
        }
      } catch (imageError) {
    ...
    if (!combinedQuery.trim()) {
      combinedQuery = hasDocumentFiles ?
        "Analiza los documentos desde perspectiva académica de estadística completa" :
        "Analiza el contenido multimodal de estadística y probabilidad";
    }
    ...
    let answer;
    try {
      console.log("🦫 Acadel procesando consulta multimodal completa (Estadística Completa)...");
      const result = await agentExecutor.invoke({
...
${documentContext ? `📚 Documentos: Material académico de estadística completa detectado...` : ''}

Mi respuesta directa en estadística y probabilidad: [Explicación basada en experiencia académica]

Para análisis más detallado en estadística, pregúntame específicamente.`;
    }
    ...
    console.error("Error en handleStatisticsMultimodalQueryWithoutSaving:", error);
