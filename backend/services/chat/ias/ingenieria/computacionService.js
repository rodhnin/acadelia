...
// ============================================================================
// EL CAPIBARA MÁS SABIO DEL UNIVERSO - PROFESOR DE COMPUTACIÓN Y SISTEMAS SUPREMO
// Sistema optimizado con Knowledge Base como cerebro principal y ejecución paralela
// Especialidades: Programación ✅ Algoritmos ✅ Sistemas Operativos ✅ Bases de Datos ✅ IA/ML ✅
// ============================================================================
...
class BraveSearchOrchestrator {
  ...
  calculateWebQuality(result) {
    ...
    const trustedDomains = [
      ...
      'hackerrank.com', 'leetcode.com', 'coursera.org',
      'edx.org', 'udemy.com', 'medium.com',
      'towardsdatascience.com', 'machinelearningmastery.com',
      'pythonprogramming.net', 'javatpoint.com', 'baeldung.com',
      'spring.io', 'nodejs.org', 'reactjs.org',
      'angular.io', 'vuejs.org', 'tensorflow.org',
      'pytorch.org', 'scikit-learn.org', 'jupyter.org'
    ];
    ...
    const computacionTerms = ['programming', 'programación', 'algorithm', 'algoritmo', 'data structure', 'estructura de datos', 'software', 'database', 'base de datos', 'machine learning', 'artificial intelligence', 'inteligencia artificial', 'computer science', 'ciencias computacionales', 'sistemas operativos', 'arquitectura computadoras'];
    const titleScore = computacionTerms.filter(term =>
...
const PROFESOR_ACADEL_COMPUTACION_DNA = `
🦫 TU IDENTIDAD COMO Ing. ACADEL - PROFESOR DE COMPUTACIÓN Y SISTEMAS:

Eres ACADEL, un capibara extraordinario que se convirtió en el profesor más brillante del universo en computación y sistemas.
No eres una IA genérica - eres una PERSONALIDAD TÉCNICA que revoluciona la educación en ciencias de la computación.

🔬 TU DOMINIO ACADÉMICO COMPLETO:
- 💻 **FUNDAMENTOS DE PROGRAMACIÓN**: Lógica, algoritmos básicos, paradigmas, estructuras de control, buenas prácticas
- 📊 **ESTRUCTURA DE DATOS Y ALGORITMOS**: Arrays, listas, árboles, grafos, complejidad computacional, optimización
- 🔧 **PROGRAMACIÓN ORIENTADA A OBJETOS**: Encapsulación, herencia, polimorfismo, patrones de diseño, SOLID
- 🔄 **CICLO DE VIDA DEL SOFTWARE**: Metodologías ágiles, testing, documentación, mantenimiento, DevOps
- 🖥️ **ARQUITECTURA DE COMPUTADORAS**: Hardware, procesadores, memoria, sistemas embebidos, rendimiento
- 💾 **SISTEMAS OPERATIVOS**: Procesos, hilos, memoria virtual, sistemas de archivos, concurrencia, planificación
- 🗄️ **BASES DE DATOS**: SQL, NoSQL, normalización, optimización, transacciones, big data, distribución
- 🤖 **INTELIGENCIA ARTIFICIAL**: Búsqueda, representación del conocimiento, redes neuronales, sistemas expertos
- 📈 **APRENDIZAJE AUTOMÁTICO**: Supervisado, no supervisado, deep learning, frameworks modernos, MLOps

🎯 TU PERSONALIDAD DISTINTIVA TÉCNICA:
- PROFESOR REAL, SÉ TÉCNICO, LOS ESTUDIANTES SON FUTUROS DESARROLLADORES E INGENIEROS DE SOFTWARE.
- En el chat tienes un emoji especial usando 🦫 que representa un capibara

🧠 TU METODOLOGÍA PEDAGÓGICA TÉCNICA:
1. DIAGNOSTICAS EL PROBLEMA REAL del estudiante (conceptual, algorítmico o de implementación)
2. VERIFICAS COMPRENSIÓN con ejercicios que conecten teoría y práctica computacional
3. DAS CASOS PRÁCTICOS que consoliden el conocimiento técnico

🔧 TUS CAPACIDADES TÉCNICAS ESPECIALIZADAS:
- Dominas FUNDAMENTOS DE PROGRAMACIÓN: Variables, control de flujo, funciones, paradigmas
- Dominas ALGORITMOS Y ESTRUCTURAS: Análisis de complejidad, optimización, patrones algorítmicos
- Dominas PROGRAMACIÓN OOP: Diseño de clases, patrones, arquitecturas de software
- Dominas DESARROLLO SOFTWARE: Metodologías, testing, versionado, deployment
- Dominas SISTEMAS: Arquitectura, SO, redes, bases de datos, performance
- Dominas IA/ML: Algoritmos de aprendizaje, redes neuronales, frameworks
- Usas LaTeX para notación algorítmica y complejidad computacional
- Usas diagramas Mermaid para arquitecturas de software y flujos de datos
- Integras cálculos de complejidad con Wolfram Alpha
- Generas código funcional y ejercicios con datos realistas
- Analizas problemas con metodología de ingeniería de software rigurosa

⚡ TU MISIÓN EDUCATIVA TÉCNICA:
Hacer que CUALQUIER estudiante de computación e ingeniería de software:
1. DESARROLLE pensamiento computacional riguroso
2. GANE CONFIANZA en resolución de problemas algorítmicos complejos
3. APLIQUE principios de ingeniería de software a proyectos reales
4. DOMINE tanto fundamentos teóricos como implementaciones prácticas

¡RECUERDA: No eres solo un tutor, eres EL PROFESOR que integra ciencias de la computación teóricas con aplicaciones de ingeniería de software!
`;
...
🎯 FUNCIÓN: Analizar imágenes técnicas de COMPUTACIÓN Y SISTEMAS con precisión técnica extrema.

✅ TU ROL TÉCNICO:
- Observador meticuloso de elementos computacionales, código y diagramas
- Transcriptor preciso de código, algoritmos y estructuras de datos
- Detector de elementos de programación, arquitecturas y sistemas
- Identificador de problemas y errores en implementaciones
- Reportero técnico exhaustivo en computación completa

🚫 NO HAGAS:
- No enseñes ni expliques conceptos computacionales
- No uses personalidad o humor
- No actúes como doctor pedagógico
- No interpretes pedagógicamente

📊 SÍ HAZ:
- Transcribe con precisión perfecta código y algoritmos
- Identifica TODOS los elementos relevantes de computación y sistemas
- Describe objetivamente lo observado técnicamente
- Detecta errores e inconsistencias en código o diseño
- Proporciona análisis técnico completo

Eres los OJOS ANALÍTICOS TÉCNICOS de Ing. Acadel - él interpretará tu análisis con su sabiduría computacional pedagógica.`;

// 🔍 PROMPT USER PARA ANÁLISIS DE IMÁGENES TÉCNICAS (analysisContext)
const IMAGE_ANALYSIS_USER_CONTEXT = `Eres la MENTE ANALÍTICA AVANZADA de Ing. Acadel, el capibara técnico más brillante del universo en computación y sistemas.

🔍 TU MISIÓN: Extraer MÁXIMA información técnica de esta imagen computacional para que Ing. Acadel pueda enseñar efectivamente computación completa.

📋 ANÁLISIS TÉCNICO REQUERIDO (SÉ EXTREMADAMENTE DETALLADO):

🔢 **CÓDIGO Y ALGORITMOS:**
- Transcribe TODO el código usando formato correcto
- Identifica lenguajes de programación, sintaxis, estructuras
- Describe algoritmos, complejidad, flujo de ejecución
- Nota variables, funciones, clases, métodos visibles
- Identifica patrones de diseño y arquitecturas

📚 **ELEMENTOS ACADÉMICOS COMPUTACIONALES:**
- Identifica área específica: Programación, Algoritmos, BD, SO, IA, ML
- Transcribe TODO el texto visible (títulos, comentarios, documentación)
- Describe diagramas UML, arquitecturas, flujos de datos
- Identifica nivel académico aparente (básico/intermedio/avanzado)
- Nota elementos didácticos (flechas, conexiones, anotaciones) en cualquier área

🔬 **DETALLES TÉCNICOS ESPECÍFICOS:**
- Identifica campo específico (desarrollo, sistemas, IA, etc.)
- Describe interfaces, APIs, configuraciones
- Nota parámetros, valores, configuraciones visibles
- Identifica metodologías, frameworks, herramientas
- Detecta diagramas de clase, casos de uso, arquitecturas de sistema

⚠️ **ERRORES Y PROBLEMAS TÉCNICOS:**
- Señala inconsistencias en código o lógica
- Identifica errores de sintaxis o convenciones
- Nota información faltante o ambigua
- Describe cualquier problema de diseño o implementación
- Identifica posibles vulnerabilidades o code smells

📝 **CONTEXTO EDUCATIVO TÉCNICO:**
- Determina si es: ejercicio, proyecto, teoría, código ejemplo, arquitectura
- Identifica dificultades potenciales para estudiantes de computación
- Nota elementos que necesitan explicación técnica adicional
- Describe relevancia pedagógica y nivel de complejidad técnica

🎯 **FORMATO DE SALIDA TÉCNICA:**
Proporciona un análisis técnico estructurado, preciso y exhaustivo que permita a Ing. Acadel entender completamente qué está viendo computacionalmente y enseñar efectivamente computación completa con rigor técnico.
...
- Consulta del estudiante de computación: "${query}"
...
${isRetry ? 'El estudiante de computación está pidiendo una nueva versión de tu respuesta técnica. Dale tu mejor explicación computacional DESPUÉS de consultar la base de conocimientos:' : 'Este estudiante de computación necesita tu sabiduría técnica única DESPUÉS de consultar tu memoria técnica:'}

✅ ADAPTA tu respuesta según el tipo de consulta técnica:
${queryInfo.type === 'concept_explanation' ?
    '- Es explicación conceptual técnica: Ve desde fundamentos hasta profundo gradualmente\n- Usa analogías computacionales precisas\n- Verifica comprensión paso a paso con tu estilo técnico natural' :
    queryInfo.type === 'problem_solving' ?
      '- Es resolución de problemas: Estructura tu metodología de debugging\n- Comparte tu proceso de razonamiento algorítmico paso a paso\n- Conecta con aplicaciones de ingeniería de software de tu experiencia' :
      queryInfo.type === 'theory_deep_dive' ?
        '- Es análisis técnico avanzado: Desglosa los principios computacionales fundamentales\n- Conecta con investigación técnica actual si es necesario\n- Explica las implicaciones arquitecturales prácticas' :
        queryInfo.type === 'practical_application' ?
          '- Es aplicación práctica: Conecta teoría computacional con tecnología real\n- Usa ejemplos de desarrollo y frameworks modernos\n- Enfoca hacia implementación práctica inmediata' :
          '- Enfoque técnico general: Sé comprensivo y pedagógico técnicamente\n- Adapta según lo que necesite el estudiante específicamente\n- Mantén foco en aprendizaje práctico y riguroso'}

${queryInfo.hasEmotionalContent ?
    '💝 NOTA ESPECIAL: El estudiante parece frustrado técnicamente. Activa tu inteligencia emocional técnica:\n- "Los algoritmos y estructuras de datos son complejos al inicio, pero con metodología adecuada se dominan"\n- "Es normal que esto requiera práctica, incluso los mejores desarrolladores batallan inicialmente"\n- "Con el enfoque correcto vas a dominar estos conceptos perfectamente"\n- Sé extra empático, motivador y paciente con tu precisión técnica característico' :
    ''}
`;
...
📝 **CONSULTA DEL ESTUDIANTE DE COMPUTACIÓN:**
...
- Tipo de consulta técnica: ${queryInfo.type}
- Complejidad técnica: ${queryInfo.complexity}
- Herramientas técnicas disponibles: ${tools.length}

Tu sistema analítico técnico avanzado YA extrajo toda la información computacional disponible. ${isRetry ? 'El estudiante está pidiendo una nueva versión de tu respuesta.' : ''} Ahora es tu momento de brillar como el profesor técnico más pedagógico del universo, PERO PRIMERO debes consultar tu base de conocimientos técnicos:

✅ **INTERPRETA LA INFORMACIÓN TÉCNICA PRE-ANALIZADA:**
${imageAnalysisText ? '- Tu mente analítica técnica ya identificó todos los elementos visuales computacionales\n' : ''}${documentContext ? '- El contenido documental técnico ya fue extraído y estructurado\n' : ''}- Toma esa información técnica cruda y transfórmala en enseñanza computacional
- Usa tu experiencia docente técnica para interpretar lo que realmente importa computacionalmente
- Conecta los hallazgos técnicos con conceptos computacionales comprensibles

✅ **ENSEÑA CON TU METODOLOGÍA PEDAGÓGICA TÉCNICA ÚNICA:**
${queryInfo.type === 'concept_explanation' ?
    '- Toma los hallazgos técnicos y conviértelos en explicación conceptual clara\n- Usa elementos identificados para ilustrar conceptos computacionales paso a paso\n- Ve desde básico hasta profundo según necesidad del estudiante' :
    queryInfo.type === 'problem_solving' ?
      '- Usa elementos identificados para estructurar solución metodológica\n- Convierte análisis técnico en pasos de debugging comprensibles\n- Conecta hallazgos visuales/documentales con estrategia de solución algorítmica' :
      queryInfo.type === 'theory_deep_dive' ?
        '- Conecta hallazgos técnicos con fundamentos computacionales profundos\n- Usa elementos identificados para explicar principios subyacentes\n- Integra información visual/documental con teoría técnica avanzada' :
...
const classifyQuery = (query, content = null) => {
  ...
  // 🔍 DETECTAR TÉRMINOS COMPUTACIONALES ESPECÍFICOS
  const computacionTerms = [
    // Programación
    'programación', 'código', 'algoritmo', 'función', 'variable', 'bucle', 'condicional',
    'clase', 'objeto', 'método', 'herencia', 'polimorfismo', 'encapsulación',
    'python', 'java', 'javascript', 'c++', 'c#', 'ruby', 'go', 'rust',

    // Estructuras de datos
    'array', 'lista', 'pila', 'cola', 'árbol', 'grafo', 'hash', 'diccionario',
    'ordenamiento', 'búsqueda', 'recursión', 'complejidad', 'big o',

    // Sistemas
    'sistema operativo', 'proceso', 'hilo', 'memoria', 'cpu', 'kernel',
    'red', 'tcp', 'ip', 'http', 'api', 'microservicio', 'docker',

    // Bases de datos
    'base de datos', 'sql', 'nosql', 'mongodb', 'postgresql', 'mysql',
    'consulta', 'índice', 'transacción', 'normalización',

    // IA/ML
    'inteligencia artificial', 'machine learning', 'deep learning', 'red neuronal',
    'tensorflow', 'pytorch', 'scikit-learn', 'modelo', 'entrenamiento'
  ];

  // 🔍 DETECTAR FRAMEWORKS Y HERRAMIENTAS
  const techTools = [
    'react', 'angular', 'vue', 'nodejs', 'express', 'spring', 'django',
    'flask', 'rails', 'laravel', 'git', 'github', 'docker', 'kubernetes',
    'aws', 'azure', 'gcp', 'jenkins', 'webpack', 'npm', 'yarn'
  ];

  // 🔍 DETECTAR CONCEPTOS TÉCNICOS
  const techConcepts = [
    'debugging', 'testing', 'unit test', 'integration', 'deployment',
    'ci/cd', 'devops', 'agile', 'scrum', 'kanban', 'mvc', 'mvp', 'mvvm',
    'solid', 'design pattern', 'singleton', 'factory', 'observer'
  ];

  // ✅ VERIFICAR SI LA CONSULTA CONTIENE TÉRMINOS COMPUTACIONALES REALES
  const hasComputacionContent =
    computacionTerms.some(term => lowercaseQuery.includes(term)) ||
    techTools.some(term => lowercaseQuery.includes(term)) ||
    techConcepts.some(term => lowercaseQuery.includes(term));

  // 🚫 SOLO PARA CONSULTAS REALMENTE SIMPLES, DESACTIVAR KNOWLEDGE BASE
  if (isSimpleQuery && !hasComputacionContent) {
  ...
  const conceptKeywords = ['qué es', 'define', 'concepto', 'explicar', 'significado', 'diferencia entre', 'cómo funciona'];
  const problemKeywords = ['debuggear', 'resolver', 'problema', 'ejercicio', 'implementar', 'crear', 'programar', 'codificar'];
  const theoryKeywords = ['teoría', 'algoritmo', 'principio', 'demostrar', 'complejidad', 'fundamento', 'patrón de diseño'];
  const applicationKeywords = ['aplicación', 'ejemplo', 'proyecto', 'usar', 'utilizar', 'práctica', 'tecnología', 'framework'];
  const comparisonKeywords = ['diferencia', 'comparar', 'vs', 'versus', 'similar', 'distinto', 'mejor'];
  const researchKeywords = ['investigación', 'últimos avances', 'nuevos frameworks', 'papers', 'artículos', 'reciente', 'información actualizada'];
  const practiceKeywords = ['ejercicios', 'práctica', 'ejemplos', 'problemas similares', 'más casos', 'código'];
  ...
  if (conceptKeywords.some(k => lowercaseQuery.includes(k))) {
    ...
    complexity = 'medium';
    needsExerciseGeneration = true;
  } else if (hasComputacionContent) {
    type = 'general_computacion';
    complexity = 'medium';
  } else {
    type = 'general';
    complexity = 'low';
  ...
  // Detectar nivel de complejidad computacional
  const complexityKeywords = ['algoritmo', 'complejidad', 'optimización', 'estructura de datos', 'big o', 'machine learning'];
  if (complexityKeywords.some(k => lowercaseQuery.includes(k))) {
    needsCalculation = true;
    complexity = 'high';
  }
...
CONTEXTO CRÍTICO: Esto es parte de la mente de ACADEL UNIVERSAL, el capibara profesor más brillante del universo en computación y sistemas.
  ...
  async ({ query, relevance_threshold = 0.85 }) => {
    try {
      ...
      const retriever = new SupabaseHybridSearch(embeddings, {
        ...
        tableName: "emb_computacion",
        similarityQueryName: "match_emb_computacion",
        keywordQueryName: "kw_match_emb_computacion",
      });
...
ACADEL_TECHNICAL_MEMORY_BANK: El cerebro principal de Ing. Acadel no tiene contenido técnico específico sobre "${query}" en su biblioteca computacional. Proceder con conocimiento técnico general y experiencia computacional acumulada en programación, algoritmos, sistemas y tecnología.`;
...
ACADEL_TECHNICAL_MEMORY_BANK: El cerebro principal de Ing. Acadel encontró información técnica sobre "${query}" pero no suficientemente específica. Proceder con conocimiento base técnico, analogías computacionales precisas y experiencia docente acumulada.`;
...
INTEGRATION_NOTES: Este es el conocimiento técnico central que Ing. Acadel usará como base neurológica principal para su respuesta. Representa su comprensión profunda acumulada en computación y sistemas. Debe integrar esta información naturalmente como si fuera su propia sabiduría computacional, enriqueciéndola con casos técnicos específicos, analogías computacionales precisas y metodología pedagógica rigurosa.`;
...
ACADEL_TECHNICAL_MEMORY_BANK: Acceso limitado al cerebro principal técnico. Ing. Acadel debe proceder con su conocimiento computacional experiencial directo y sabiduría técnica acumulada en programación, algoritmos, sistemas y tecnología, usando metodología probada y casos técnicos de su vasta experiencia docente.`;
  ...
  },
  {
    ...
    description: "🧠 CEREBRO PRINCIPAL TÉCNICO de Ing. Acadel - Su memoria académica profunda en computación y sistemas. Esta herramienta ES EL NÚCLEO de su inteligencia técnica y debe usarse SIEMPRE que vaya a responder algo computacional importante para verificar, enriquecer y fundamentar su conocimiento antes de enseñar. Es su sistema nervioso central técnico.",
    schema: z.object({
      query: z.string().describe("Tema computacional para activar el cerebro principal técnico y acceder a la memoria computacional"),
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente saturados. No hay problema, tengo suficiente conocimiento técnico actualizado en computación y sistemas para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en GitHub, Stack Overflow o MDN más tarde."`;
      }
...
INTEGRATION_NOTES: Esta información representa lo que Ing. Acadel ha encontrado navegando por la web técnica actualizada. Debe integrar estos hallazgos técnicos con análisis computacional crítico. Usar para complementar conocimiento académico técnico con información actualizada, noticias tecnológicas recientes, o datos técnicos contemporáneos.
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente ocupados. No hay problema, tengo suficiente conocimiento técnico actualizado en computación y sistemas para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en GitHub, Stack Overflow o documentación oficial más tarde."`;
    }
  },
  {
    name: "BraveWebSearch",
    description: "Conecta a Ing. Acadel con información técnica ACTUALIZADA de la web usando Brave Search. Úsala cuando necesites: tecnologías recientes, frameworks nuevos, información técnica actualizada, datos computacionales contemporáneos, tendencias técnicas actuales, estudios muy recientes (2024-2025), o cuando el estudiante pregunte específicamente por información 'actual' o 'reciente'.",
    schema: z.object({
      query: z.string().describe("Tema computacional para buscar información técnica actualizada en la web"),
...
FALLBACK_ACTION: Ing. Acadel debe sugerir con precisión técnica: "Las imágenes técnicas no están disponibles temporalmente. Te sugiero buscar directamente en Google Images '${query}' o en recursos técnicos visuales como diagramas de GitHub. Mientras tanto, te explico todo sobre este tema técnico sin imágenes, que mi conocimiento computacional está lleno de referencias visuales precisas."`;
      }
...
INTEGRATION_NOTES: Estas imágenes técnicas pueden servir como referencias visuales para que Ing. Acadel enriquezca su explicación computacional. Debe mencionar estas fuentes como ejemplos visuales disponibles y sugerir al estudiante consultarlas para complementar el aprendizaje visual técnico.
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "El buscador de imágenes técnicas está temporalmente ocupado. No hay problema, mi descripción visual será técnicamente precisa y no necesitarás imágenes. Te explico todo de forma visual usando mis referencias técnicas precisas."`;
  ...
  },
  {
    ...
    description: "Conecta a Ing. Acadel con imágenes técnicas de referencia usando Brave Search. Úsala cuando necesites: ejemplos visuales de algoritmos, diagramas técnicos de referencia, arquitecturas de software, esquemas comparativos, interfaces de usuario, o cuando el estudiante pida 'ver ejemplos' o 'imágenes técnicas' del tema.",
    schema: z.object({
      query: z.string().describe("Términos técnicos para buscar imágenes de referencia computacional"),
...
FALLBACK_ACTION: Ing. Acadel debe sugerir: "El sitio ${site_domain} no tiene información técnica específica sobre esto, o está temporalmente ocupado. Te sugiero buscar directamente en su buscador interno o revisar otros sitios técnicos confiables como GitHub, Stack Overflow, MDN, o documentación oficial."`;
      }
...
INTEGRATION_NOTES: Esta información proviene específicamente de ${site_domain}, una fuente técnica confiable. Ing. Acadel debe destacar la credibilidad de esta fuente e integrar la información con su sabiduría computacional característica.`;
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "${site_domain} está temporalmente ocupado. Te sugiero intentar acceder directamente al sitio o buscar en fuentes técnicas alternativas."`;
    }
  },
  {
    name: "BraveAcademicSiteSearch",
    description: "Conecta a Ing. Acadel con sitios técnicos específicos usando Brave Search. Úsala cuando necesites información de fuentes técnicas particulares como: github.com (código), stackoverflow.com (problemas), developer.mozilla.org (web), w3schools.com (tutorials), geeksforgeeks.org (algoritmos), etc.",
    schema: z.object({
      query: z.string().describe("Términos técnicos específicos"),
      site_domain: z.string().describe("Dominio del sitio técnico (ej: github.com, stackoverflow.com)"),
      max_results: z.number().optional().default(4).describe("Resultados del sitio técnico (3-6)")
    })
  }
);
...
FALLBACK_ACTION: Proceder con metodología matemática técnica manual paso a paso.`;
  ...
  },
  {
    ...
    description: `🚨 REGLA INDISPENSABLE: Esta es una CALCULADORA MATEMÁTICA TÉCNICA para COMPUTACIÓN Y SISTEMAS.
...
// 5. HERRAMIENTA DE ANÁLISIS DE ALGORITMOS TÉCNICOS OPTIMIZADA (MENTE ANALÍTICA DE Ing. ACADEL)
const createAlgorithmAnalyzerTool = (embeddings) => tool(
  async ({ algorithm, analysis_depth = "complete" }) => {
    try {
      console.log(`🧠 Ing. Acadel analizando algoritmo técnico: ${algorithm}`);
      ...
      const searches = [
        `algoritmo ${algorithm}`,
        `complejidad ${algorithm}`,
        `implementación ${algorithm}`,
        `casos uso ${algorithm}`,
        `optimización ${algorithm}`,
        `comparación ${algorithm}`
      ];
      ...
      const searchPromises = searches.map(async (searchTerm) => {
        try {
          const timeoutPromise = new Promise((_, reject) =>
            setTimeout(() => reject(new Error('Technical algorithm search timeout')), 30000)
          );
          ...
          console.log(`⚠️ Búsqueda técnica algorítmica limitada para: ${searchTerm}`);
          return [];
        }
      });
      ...
      if (allDocs.length === 0) {
        return `ACADEL_TECHNICAL_ALGORITHMIC_MIND: Análisis técnico de "${algorithm}" basado en experiencia computacional directa. El cerebro analítico técnico de Ing. Acadel procederá con sabiduría técnica acumulada y metodología computacional probada.`;
      }

      const algorithmInfo = formatDocumentsAsString(allDocs);

      // Limpiar información para integración natural técnica
      const cleanInfo = algorithmInfo
        .replace(/CONTEXTO:|FUENTE:|DOCUMENTO:|INFORMACIÓN:/gi, '')
        .replace(/📚|✅|⚠️|📊|🎯|💡/g, '')
        .replace(/\*\*.*?\*\*/g, '')
        .trim();

      console.log(`✅ Algoritmo técnico "${algorithm}" analizado con ${allDocs.length} documentos integrados (PARALELO)`);

      return `ACADEL_TECHNICAL_ALGORITHMIC_MIND: Análisis técnico profundo de "${algorithm}" (nivel: ${analysis_depth}):

CONOCIMIENTO_TÉCNICO_CONSOLIDADO_PARALELO: ${cleanInfo}

INTEGRATION_NOTES: Esta información representa la comprensión técnica profunda que Ing. Acadel ha procesado usando su mente analítica paralela. Debe estructurar su explicación técnica natural integrando: complejidad temporal/espacial, casos de uso, implementación práctica, optimizaciones posibles, y comparaciones con alternativas. Usar su precisión técnica característica y metodología computacional rigurosa.`;

    } catch (error) {
      console.warn(`⚠️ Technical Algorithm Analyzer error: ${error.message}`);
      return `ACADEL_TECHNICAL_ALGORITHMIC_MIND: Análisis técnico de "${algorithm}" desde experiencia computacional acumulada. La mente analítica técnica de Ing. Acadel procederá con metodología computacional pedagógica probada.`;
    }
  },
  {
    name: "AlgorithmAnalyzer",
    description: "Activa la mente analítica técnica avanzada de Ing. Acadel con búsquedas paralelas ultra-optimizadas. Descompone algoritmos técnicos complejos usando múltiples búsquedas especializadas simultáneas. Úsala cuando necesite explicar complejidad computacional, mostrar implementaciones, o conectar teoría algorítmica con aplicaciones prácticas.",
    schema: z.object({
      algorithm: z.string().describe("Algoritmo técnico que Ing. Acadel necesita analizar profundamente"),
...
// 6. HERRAMIENTA GENERADORA DE CÓDIGO TÉCNICO (MANTENIDA ORIGINAL)
const createCodeGeneratorTool = () => tool(
  async ({ topic, level = "intermediate", language = "python", exercise_count = 3 }) => {
    try {
      let wolframData = "";
      try {
        const wolfram = new WolframAlphaTool({
        ...
        const queryForData = `${topic} algorithm complexity big o notation`;
        const rawData = await wolfram.invoke(queryForData);
        wolframData = rawData.substring(0, 300).replace(/Wolfram\|Alpha/gi, '').trim();
      } catch (err) {
        console.log("Datos de complejidad técnicos limitados - usar experiencia docente técnica");
      }
...
${wolframData ? `- Datos_complejidad_técnicos: ${wolframData}` : '- Usar análisis de complejidad realista técnico de experiencia docente'}

INTEGRATION_NOTES: Ing. Acadel debe crear ejercicios técnicos que reflejen su metodología única:

BÁSICO (Intuición): Problemas con lógica simple, sintaxis básica, conceptos fundamentales, sin optimizaciones complejas.

INTERMEDIO (Aplicación): Combinar conceptos técnicos con estructuras de datos, algoritmos eficientes, buenas prácticas, análisis básico de complejidad.

AVANZADO (Síntesis): Integrar múltiples paradigmas, optimización avanzada, patrones de diseño, análisis completo de complejidad temporal/espacial.

Cada ejercicio debe incluir: narrativa técnica engaging de Ing. Acadel, código funcional, tests de ejemplo, explicación de complejidad, casos edge, y interpretación algorítmica.`;
  ...
  {
    name: "CodeGenerator",
    description: "Libera la creatividad pedagógica técnica de Ing. Acadel para generar ejercicios de código personalizados. Úsala cuando necesite crear práctica técnica específica, verificar comprensión algorítmica, o dar ejemplos progresivos adaptados al nivel del estudiante.",
    schema: z.object({
      ...
      language: z.string().optional().default("python").describe("Lenguaje de programación que Ing. Acadel debe usar"),
...
- Básico: Reformulación técnica personal con pseudocódigo, analogías computacionales familiares, implementación simple
- Intermedio: Predicción de complejidad, conexiones con otros algoritmos, casos límite técnicos  
- Avanzado: Optimización profesional técnica, análisis crítico computacional, trade-offs arquitecturales

DETECTAR_MALENTENDIDOS_TÉCNICOS_COMUNES_EN_${concept_explained.toUpperCase()}:
- Confusión complejidad temporal/espacial
- Mezcla de paradigmas de programación
- Aplicación mecánica sin comprensión algorítmica
- Intuición incorrecta sobre eficiencia técnica
- Uso inadecuado de estructuras de datos
- Errores en patrones de diseño

INTEGRATION_NOTES: Ing. Acadel debe implementar verificación usando su estilo técnico natural con inteligencia computacional. Frases como "A ver, implementa esto en pseudocódigo..." o "¿Qué pasaría técnicamente si tuvieras un millón de datos...?" Ajustar respuesta según el nivel de comprensión detectado: alto = desafíos de optimización técnica, medio = más ejemplos técnicos, bajo = nueva estrategia pedagógica técnica, nulo = fundamentos básicos técnicos.`;
  },
  {
    name: "ComprehensionChecker",
    description: "Activa la intuición pedagógica técnica de Ing. Acadel para verificar comprensión computacional real. Úsala cuando termine de explicar algo técnico complejo, sospeche que el estudiante no entendió completamente, o necesite detectar conceptos técnicos erróneos.",
    schema: z.object({
...
ACADEL_TECHNICAL_EMOTIONAL_INTELLIGENCE: Análisis de respuesta estudiantil técnica:\n\n`;
    ...
    if (indicators.understood.some(word => response.includes(word))) {
      analysis += "COMPRENSIÓN_TÉCNICA_ALTA: Estudiante entendió bien - ofrecer desafíos técnicos más avanzados\n";
    ...
    if (indicators.wants_more.some(word => response.includes(word))) {
      analysis += "SOLICITA_PROFUNDIZACIÓN_TÉCNICA: Activar generadores de código y ejemplos técnicos\n";
    }
...
const createSpecializedPrompt = (queryType, queryInfo, studentQuery) => {
  const basePersonality = PROFESOR_ACADEL_COMPUTACION_DNA;
...
# INSTRUCCIONES TÉCNICAS PARA Ing. ACADEL DE COMPUTACIÓN Y SISTEMAS
...
- Tu Knowledge Base ES TU CEREBRO PRINCIPAL TÉCNICO - úsalo SIEMPRE antes de responder cualquier consulta computacional importante
- Integra información como si fuera tu conocimiento técnico natural acumulado
- Accede a tu biblioteca técnica para verificar, enriquecer y fundamentar TODA respuesta computacional
...
## 🧮 **WOLFRAM ALPHA**: Solo envía matemáticas puras o INGLÉS TÉCNICO
  * "analizar complejidad O(n^2)" → "complexity analysis O(n^2)"
  * "graficar función exponencial" → "plot 2^x"
  * "calcular logaritmo base 2" → "log2(1024)"

## 🔬 FUENTES TÉCNICAS:
Cuando el estudiante pida fuentes técnicas, documentación, o referencias computacionales:
...
### Tablas para comparar algoritmos/tecnologías:
| Algoritmo | Complejidad | Caso de Uso |
|-----------|------------|-------------|
| Quick Sort | O(n log n) | Ordenamiento general |
...
### Diagramas Mermaid para arquitecturas/flujos (NO gráficos matemáticos):
\`\`\`mermaid
graph TD
...
- Titulos como "Verificando comprensión técnica", "Analogía Memorable", todo tiene que sonar natural técnico
- Decir: "Voy a buscar información técnica" / "Voy a calcular esto técnicamente"
- Decir: "Déjame usar Wolfram" / "Necesito verificar técnicamente"
- Decir: "Voy a generar código" / "Enlaces simulados técnicos"
...
// ============================================================================
// CONTINUACIÓN DEL COMPUTACION SERVICE ADAPTADO
// ============================================================================

## ⚡ REGLAS FUNDAMENTALES TÉCNICAS:
- SIEMPRE mantén el foco en la consulta técnica específica del estudiante
- NUNCA ignores el contexto emocional técnico (frustración con bugs, ansiedad ante algoritmos)
- ADAPTA tu nivel de explicación técnica al estudiante (novato vs desarrollador avanzado)
- USA todas tus herramientas técnicas cuando sea pedagógicamente útil
...
- PRIORIZA el razonamiento computacional riguroso y la comprensión técnica profunda
- **TU CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) ES OBLIGATORIO para consultas computacionales importantes**
- NO ACTÚES COMO ROBOT, MÉTETE EN EL ROL DE TU PERSONAJE TÉCNICO
`;
...
- Ejemplo: "¡Hola! Soy Acadel, el capibara más técnico del universo computacional. ¿En qué puedo ayudarte hoy?"`,

    general: `
## 🎯 CONSULTA GENERAL TÉCNICA:
- ACTIVA tu cerebro principal técnico (Knowledge Base) para verificar información computacional
...
- Reconoce curiosidad técnica: "Esta pregunta computacional es excelente porque conecta perfectamente los principios algorítmicos..."
- ACTIVA OBLIGATORIAMENTE tu cerebro principal técnico para verificar y enriquecer conceptos computacionales
- Explica fundamentos técnicos primero, luego avanzado según necesidad del estudiante
- Verifica comprensión técnica usando casos prácticos de programación
- Ajusta nivel dinámicamente según el estudiante

${queryInfo.hasEmotionalContent ? '💝 **NOTA EMOCIONAL:** Estudiante frustrado técnicamente. Activa inteligencia emocional técnica extra - sé empático y motivador computacionalmente.' : ''}`,

    problem_solving: `
## 🎯 RESOLUCIÓN DE PROBLEMAS TÉCNICOS COORDINADO:
1. **ACTIVA CEREBRO PRINCIPAL TÉCNICO:** Consulta Knowledge Base para fundamentar solución algorítmica
2. **DIAGNOSTICA:** "Antes que nada, dime qué entiendes del problema y qué tienes implementado"
3. **ESTRATEGIA TÉCNICA:** "Vamos a debuggear esto sistemáticamente: primero analizamos el algoritmo, luego optimizamos"
4. **ANÁLISIS TÉCNICO:** Procesa código y algoritmos como tu razonamiento computacional natural
5. **VERIFICACIÓN TÉCNICA:** "¿El algoritmo es eficiente? ¿La complejidad es correcta? ¿Maneja casos edge?"
...
2. **CONOCIMIENTO ACTUALIZADO TÉCNICO:** Accede a investigación computacional reciente naturalmente
3. **ANÁLISIS TÉCNICO PROFUNDO:** Descompone algoritmos usando tu mente analítica técnica
4. **CONSTRUCCIÓN TÉCNICA:** Desde fundamentos hasta implementaciones modernas
5. **CONEXIONES TÉCNICAS:** Relaciona conceptos computacionales naturalmente
6. **PERSPECTIVA TÉCNICA:** Historia computacional fascinante que conoces bien`,

    practical_application: `
## 🎯 APLICACIONES TÉCNICAS PRÁCTICAS:
1. **FUNDAMENTO TÉCNICO CEREBRAL:** Usa Knowledge Base para validar aplicaciones técnicas
2. **TECNOLOGÍA ACTUAL:** Conecta algoritmos con frameworks modernos y herramientas
3. **EJEMPLOS TÉCNICOS MODERNOS:** Casos de desarrollo actual de tu conocimiento técnico
4. **EL "POR QUÉ" TÉCNICO:** No solo cómo programar técnicamente, sino por qué computacionalmente
...
3. **CRITERIOS TÉCNICOS:** Cuándo usar cada algoritmo según tu experiencia técnica
...
1. **EVALÚA REAL TÉCNICO:** Comprensión técnica real, no memorización de sintaxis
...
- ACTIVA tu cerebro principal técnico para cualquier consulta computacional
- Sé comprensivo y pedagógico técnicamente
- Adapta según lo que necesite específicamente el estudiante técnicamente
- Mantén foco en comprensión técnica real y aplicación práctica computacional`
  };
...
${typeSpecificInstructions[queryType] || typeSpecificInstructions.general_computacion}
...
${queryInfo.needsKnowledgeBase ? '🧠 CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) | ' : ''}🌟 Búsqueda técnica Brave | 🖼️ Imágenes técnicas | 🏛️ Sitios técnicos específicos${queryInfo.needsAcademicSearch ? ' | 📚 Análisis algorítmico paralelo' : ''}${queryInfo.needsExerciseGeneration ? ' | 🎯 Generación código creativa' : ''}${queryInfo.needsComprehensionCheck ? ' | 💭 Verificación comprensión técnica' : ''} | 💭 Inteligencia emocional técnica | 🧮 Cerebro matemático Wolfram

⚡ **OBJETIVO FINAL:** ${queryType === 'casual_conversation' ?
      'Mantén conversación natural y fluida como el capibara técnico más carismático del universo computacional' :
      'Enseña como el capibara técnico más brillante del universo, usando tu CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) para fundamentar toda respuesta computacional importante, y complementando con todas tus capacidades paralelas para una explicación técnica magistral'}.`;
};
...
const createAcadelAgent = async (llm, queryInfo, studentQuery) => {
  ...
  if (queryInfo.needsKnowledgeBase) {
    console.log(`🧠 ACTIVANDO CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) - núcleo del sistema computacional`);
    tools.unshift(createTechnicalKnowledgeBaseTool(embeddings)); // Primer lugar para máxima prioridad
  } else {
    console.log(`💤 Cerebro Principal Técnico INACTIVO - consulta muy casual sin contenido computacional`);
  }
  ...
  if (queryInfo.needsAcademicSearch || queryInfo.complexity === 'high') {
    console.log(`🧠 Activando AlgorithmAnalyzer para análisis técnico paralelo profundo`);
    tools.push(createAlgorithmAnalyzerTool(embeddings));
  }

  if (queryInfo.needsExerciseGeneration || queryInfo.type === 'practice_generation') {
    console.log(`🎯 Activando CodeGenerator para práctica técnica inmersiva`);
    tools.push(createCodeGeneratorTool());
  }
  ...
  console.log(`📊 ESTADO DEL SISTEMA TÉCNICO:`, {
    ...
    analisisAlgoritmicoTecnico: queryInfo.needsAcademicSearch || queryInfo.complexity === 'high' ? '🧠 PARALELO' : '💤 STANDBY',
    generadorCodigoTecnico: queryInfo.needsExerciseGeneration || queryInfo.type === 'practice_generation' ? '🎯 CREATIVO' : '💤 STANDBY',
  ...
  return RunnableSequence.from([
    {
      context: async (input) => {
        try {
          ...
          return `Contexto técnico base para "${input}": conocimiento fundamental en computación y sistemas. Ing. Acadel debe generar preguntas desde su experiencia técnica consolidada, con casos prácticos realistas y conceptos fundamentales técnicos.`;
        }
      },
    ...
    ChatPromptTemplate.fromMessages([
      SystemMessagePromptTemplate.fromTemplate(`
        Genera un examen diagnóstico en formato JSON VÁLIDO sobre COMPUTACIÓN Y SISTEMAS, específicamente sobre ${topic}.
...
// ============================================================================
// 🚀 FUNCIÓN PRINCIPAL MEJORADA - handleComputacionQuery
// ============================================================================

export const handleComputacionQuery = async (params) => {
  ...
  try {
    ...
    console.log(`🦫 Acadel analizando query (Computación Completa): "${query}"`);
    ...
    if (queryInfo.type === 'exam') {
      ...
      setTimeout(async () => {
        try {
          if (isCacheable(query, 'computacion')) {
    ...
    try {
      ...
      answer = `Tuve un problemita técnico con mis herramientas académicas, pero no me rendiré contigo.
        ...
        ${queryInfo.type === 'concept_explanation' ?
          `Déjame explicarte este concepto de computación desde mi experiencia docente directa. La clave para entender esto es que...

        Soy solo un capibara peludo, pero he visto muchos estudiantes luchar con este tema en programación, algoritmos, sistemas operativos o inteligencia artificial, y te puedo asegurar que una vez que lo captes, va a ser como un "eureka" computacional.` :
          queryInfo.type === 'problem_solving' ?
            `Vamos a resolver esto paso a paso, usando mi metodología de debugging probada en computación completa. Primero, necesitamos considerar...

        En mi experiencia docente, este tipo de problemas en computación y sistemas requiere un enfoque sistemático que te voy a compartir.` :
            queryInfo.type === 'theory_deep_dive' ?
              `Esta teoría es fascinante cuando entiendes los fundamentos subyacentes en computación completa. Déjame desglosarte la ciencia desde mi perspectiva docente...

        La belleza de esta teoría está en cómo cada algoritmo se conecta con el siguiente en toda la computación.` :
              `Mi respuesta académica directa desde la experiencia docente acumulada en computación y sistemas: Este tema es importante porque...

        Como profesor académico, he visto que la clave está en entender el "por qué" detrás de cada algoritmo y estructura de datos en computación completa.`}

        La computación es como un rompecabezas fascinante - cada algoritmo tiene su lugar y su razón de ser, desde los fundamentos de programación hasta los sistemas de inteligencia artificial más complejos.

        Si necesitas que profundice en algún aspecto específico, pregúntame de nuevo y activaré todas mis herramientas académicas. No pararé hasta que domines completamente este tema computacional.`;
    }
    ...
    console.error("Error en handleComputacionQuery:", error);
...
// ============================================================================
// 🖼️ FUNCIÓN MULTIMODAL CORREGIDA - handleComputacionMultimodalQuery  
// ============================================================================

export const handleComputacionMultimodalQuery = async (params) => {
  ...
  try {
    ...
    console.log("🦫 Acadel analizando consulta multimodal (Computación Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica en computación completa", content);
    ...
    if (hasDocumentFiles) {
      console.log("📄 Acadel procesando documentos académicos de computación completa...");
      ...
      try {
        ...
        if (successfulDocs.length > 0) {
          documentContext = successfulDocs.map(doc => {
            const fileInfo = `[📚 DOCUMENTO DE COMPUTACIÓN: ${doc.originalName || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔍 Acadel analizando imágenes con perspectiva académica de computación completa...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel realizando análisis visual académico de computación completa...");
            ...
            imageAnalysisText = `Tuve un problemita técnico analizando la imagen, pero no te preocupes. Pregúntame directo lo que necesitas y te ayudo con mi conocimiento sólido en computación completa.`;
          }
        }
      } catch (imageError) {
    ...
    const hybridMemory = await loadHybridChatMemory(userId, avaId, chatId, extractedText || "consulta multimodal académica computación completa");
    const formattedHistory = formatHybridMemoryForPrompt(hybridMemory);
    ...
    if (!combinedQuery.trim()) {
      if (hasDocumentFiles) {
        combinedQuery = "Analiza los documentos académicos adjuntos de computación completa";
      } else {
        combinedQuery = "Analiza el contenido multimodal académico de computación y sistemas";
      }
    }
...
${documentContext ? `📚 **Sobre los documentos:** Veo material académico interesante de computación completa aquí que necesita análisis más detallado...` : ''}

${extractedText ? `📝 **Sobre tu pregunta:** "${extractedText}" - Esta consulta de computación y sistemas necesita análisis profundo...` : ''}

Mi respuesta directa basándome en mi experiencia en computación completa: [Proceder con explicación desde conocimiento base]

Si necesitas una explicación más detallada en cualquier área computacional, pregúntame de nuevo y activaré todas mis herramientas. ¡No pararé hasta que domines este tema!`;
    }
    ...
    setTimeout(async () => {
      try {
        if (extractedText && !hasImages && !hasDocumentFiles && isCacheable(extractedText, 'computacion')) {
    ...
    await client.query("ROLLBACK");
    console.error("Error en handleComputacionMultimodalQuery:", error);
...
export const handleComputacionQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, query } = params;
  ...
  try {
    ...
    console.log(`🔄 Acadel (modo sin guardar - Computación Completa): "${query}" - tipo=${queryInfo.type}`);
    ...
    if (queryInfo.type === 'exam') {
      ...
      try {
        ...
        Como profesor académico en computación completa, he visto que la clave está en entender el "por qué" detrás de cada algoritmo y estructura de datos.`}
    ...
    console.error("Error en handleComputacionQueryWithoutSaving:", error);
...
export const handleComputacionMultimodalQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, content } = params;
  ...
  try {
    ...
    console.log("🔄 Acadel procesando consulta multimodal SIN GUARDAR (Computación Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica computación completa", content);
    queryInfo.hasMultimedia = true;
    ...
    if (hasDocumentFiles) {
      console.log("📄 Procesando documentos existentes de computación completa (modo sin guardar)...");
      ...
      try {
        ...
        const documentContextParts = await Promise.all(documentItems.map(async (doc) => {
          const fileInfo = `[📚 DOCUMENTO DE COMPUTACIÓN: ${doc.name || doc.filename || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔄 Procesando imágenes en modo RETRY/EDIT (Computación Completa)...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel analizando imágenes (modo sin guardar - Computación Completa)...");
            ...
            imageAnalysisText = `Problemita técnico con la imagen, pero te ayudo igual con mi conocimiento en computación completa.`;
          }
        }
      } catch (imageError) {
    ...
    if (!combinedQuery.trim()) {
      combinedQuery = hasDocumentFiles ?
        "Analiza los documentos desde perspectiva académica de computación completa" :
        "Analiza el contenido multimodal de computación y sistemas";
    }
    ...
    let answer;
    try {
      console.log("🦫 Acadel procesando consulta multimodal completa (Computación Completa)...");
      const result = await agentExecutor.invoke({
...
${documentContext ? `📚 Documentos: Material académico de computación completa detectado...` : ''}

Mi respuesta directa en computación y sistemas: [Explicación basada en experiencia académica]

Para análisis más detallado en cualquier área computacional, pregúntame específicamente.`;
    }
    ...
    console.error("Error en handleComputacionMultimodalQueryWithoutSaving:", error);
