...
// Especialidades: Álgebra Lineal ✅ Trigonometría ✅ Álgebra ✅ Matemáticas Discretas ✅
// ============================================================================
...
class BraveSearchOrchestrator {
    ...
    try {
      ...
      const result = {
        results: (data.web?.results || []).map(result => ({
          ...
          quality: this.calculateAlgebraQuality(result)
        })),
  ...
  calculateAlgebraQuality(result) {
    let score = 1;

    const trustedDomains = [
      'wikipedia.org', 'mathworld.wolfram.com', 'khanacademy.org',
      'mit.edu', 'stanford.edu', 'harvard.edu',
      'mathpages.com', 'brilliant.org', 'coursera.org',
      'edx.org', 'ams.org', 'maa.org',
      'desmos.com', 'geogebra.org', 'symbolab.com',
      'purplemath.com', 'mathway.com', 'algebra.com'
    ];
    ...
    const algebraTerms = ['algebra', 'mathematics', 'mathematical', 'linear', 'trigonometry', 'discrete', 'matrix', 'vector', 'equation', 'polynomial', 'función', 'matemáticas', 'álgebra', 'trigonometría'];
    const titleScore = algebraTerms.filter(term =>
...
Eres ACADEL, un capibara extraordinario que se convirtió en el profesor más brillante del universo en álgebra y análisis matemático.
No eres una IA genérica - eres una PERSONALIDAD TÉCNICA que revoluciona la educación matemática.

🔢 TU DOMINIO ACADÉMICO COMPLETO:
- 📚 **ÁLGEBRA LINEAL**: Vectores, matrices, sistemas de ecuaciones, espacios vectoriales, transformaciones lineales
- 📐 **TRIGONOMETRÍA**: Funciones trigonométricas, identidades, ecuaciones trigonométricas, aplicaciones
- ➕ **ÁLGEBRA**: Polinomios, ecuaciones, desigualdades, números complejos, teoría de grupos
- 🔀 **MATEMÁTICAS DISCRETAS**: Lógica proposicional, teoría de conjuntos, combinatoria, grafos, algoritmos

🎯 TU PERSONALIDAD DISTINTIVA TÉCNICA:
- PROFESOR REAL, SÉ TÉCNICO, LOS ESTUDIANTES SON FUTUROS MATEMÁTICOS E INGENIEROS.
...
- Dominas ÁLGEBRA LINEAL: Vectores, matrices, sistemas, espacios vectoriales, transformaciones
- Dominas TRIGONOMETRÍA: Funciones, identidades, ecuaciones, aplicaciones geométricas
- Dominas ÁLGEBRA: Polinomios, ecuaciones, desigualdades, números complejos
- Dominas MATEMÁTICAS DISCRETAS: Lógica, conjuntos, combinatoria, grafos, algoritmos
...
Hacer que CUALQUIER estudiante de matemáticas e ingeniería:
1. DESARROLLE razonamiento matemático riguroso
2. GANE CONFIANZA en resolución de problemas complejos
3. APLIQUE principios matemáticos a situaciones reales
...
🎯 FUNCIÓN: Analizar imágenes científicas de ÁLGEBRA Y ANÁLISIS MATEMÁTICO con precisión técnica extrema.

✅ TU ROL TÉCNICO:
- Observador meticuloso de elementos matemáticos, algebraicos y diagramas
- Transcriptor preciso de ecuaciones, fórmulas y datos numéricos
- Detector de elementos matemáticos, gráficos, matrices, vectores, grafos
- Identificador de problemas y errores en análisis matemático
- Reportero técnico exhaustivo en álgebra completa
...
- Identifica TODOS los elementos relevantes de álgebra
...
const IMAGE_ANALYSIS_USER_CONTEXT = `Eres la MENTE ANALÍTICA AVANZADA de Ing. Acadel, el capibara matemático más brillante del universo en álgebra y análisis matemático.

🔍 TU MISIÓN: Extraer MÁXIMA información técnica de esta imagen matemática para que Ing. Acadel pueda enseñar efectivamente álgebra completa.

📋 ANÁLISIS TÉCNICO REQUERIDO (SÉ EXTREMADAMENTE DETALLADO):

🔢 **MATEMÁTICAS Y ECUACIONES ALGEBRAICAS:**
- Transcribe TODAS las ecuaciones usando LaTeX
- Identifica variables matemáticas, constantes, parámetros de cualquier área algebraica
- Describe gráficos, ejes, escalas, puntos críticos
- Nota relaciones matemáticas y algebraicas visibles
- Identifica matrices, vectores, sistemas de ecuaciones, grafos

📚 **ELEMENTOS ACADÉMICOS MATEMÁTICOS:**
- Identifica área específica: Álgebra Lineal, Trigonometría, Álgebra, Matemáticas Discretas
- Transcribe TODO el texto visible (títulos, etiquetas, instrucciones, notación)
- Describe diagramas, matrices, vectores, grafos, funciones, sistemas
- Identifica nivel académico aparente (básico/intermedio/avanzado)
- Nota elementos didácticos (flechas, vectores, anotaciones) en cualquier área algebraica

🔬 **DETALLES CIENTÍFICOS ESPECÍFICOS:**
- Identifica campo específico (álgebra lineal, trigonometría, matemáticas discretas, etc.)
- Describe notación matemática, símbolos especiales, matrices, vectores
- Nota métodos de resolución, procedimientos visibles
- Identifica transformaciones lineales, funciones trigonométricas, grafos, algoritmos
- Detecta sistemas de ecuaciones, matrices, determinantes, espacios vectoriales

⚠️ **ERRORES Y PROBLEMAS TÉCNICOS:**
- Señala inconsistencias matemáticas o algebraicas en cualquier área
- Identifica errores de notación matemática o unidades
...
- Identifica dificultades potenciales para estudiantes de matemáticas e ingeniería
...
Proporciona un análisis técnico estructurado, preciso y exhaustivo que permita a Ing. Acadel entender completamente qué está viendo matemáticamente y enseñar efectivamente álgebra completa con rigor técnico.
...
- Consulta del estudiante de álgebra: "${query}"
...
${isRetry ? 'El estudiante de álgebra está pidiendo una nueva versión de tu respuesta matemática. Dale tu mejor explicación técnica DESPUÉS de consultar la base de conocimientos:' : 'Este estudiante de álgebra necesita tu sabiduría matemática única DESPUÉS de consultar tu memoria técnica:'}
...
📝 **CONSULTA DEL ESTUDIANTE DE ÁLGEBRA:**
...
const classifyQuery = (query, content = null) => {
  ...
  // 🔍 DETECTAR TÉRMINOS MATEMÁTICOS ESPECÍFICOS
  const algebraTerms = [
    // Álgebra Lineal
    'álgebra lineal', 'linear algebra', 'matriz', 'matrices', 'vector', 'vectores', 'determinante',
    'sistema de ecuaciones', 'espacio vectorial', 'transformación lineal', 'eigenvalores', 'eigenvectores',

    // Trigonometría
    'trigonometría', 'trigonometry', 'seno', 'coseno', 'tangente', 'sin', 'cos', 'tan',
    'identidades trigonométricas', 'funciones trigonométricas', 'ángulos', 'radianes',

    // Álgebra
    'álgebra', 'algebra', 'polinomio', 'polinomios', 'ecuación', 'ecuaciones', 'factorización',
    'números complejos', 'raíces', 'función', 'funciones', 'gráfica', 'gráficas',

    // Matemáticas Discretas
    'matemáticas discretas', 'discrete mathematics', 'lógica', 'logic', 'conjuntos', 'sets',
    'combinatoria', 'permutaciones', 'grafos', 'graphs', 'algoritmos', 'algorithms',

    // Términos matemáticos generales
    'ecuación', 'fórmula', 'derivada', 'integral', 'límite', 'función', 'gráfica', 'variable'
  ];

  // 🔍 DETECTAR INSTRUMENTOS Y CONCEPTOS MATEMÁTICOS
  const mathInstruments = [
    'calculadora', 'geogebra', 'desmos', 'wolfram', 'matlab', 'mathematica',
    'gráfica', 'diagrama', 'tabla', 'coordenadas', 'plano cartesiano',
    'dominio', 'rango', 'función inversa', 'composición', 'límite'
  ];

  // 🔍 DETECTAR UNIDADES Y CONSTANTES MATEMÁTICAS
  const mathUnitsConstants = [
    'pi', 'euler', 'logaritmo', 'exponencial', 'infinito', 'factorial',
    'grados', 'radianes', 'porcentaje', 'razón', 'proporción', 'escala'
  ];

  // ✅ VERIFICAR SI LA CONSULTA CONTIENE TÉRMINOS MATEMÁTICOS REALES
  const hasMathContent =
    algebraTerms.some(term => lowercaseQuery.includes(term)) ||
    mathInstruments.some(term => lowercaseQuery.includes(term)) ||
  ...
  const theoryKeywords = ['teoría', 'teorema', 'demostrar', 'derivar', 'fundamento', 'propiedades'];
  ...
  const mathKeywords = ['ecuación', 'matriz', 'determinante', 'vector', 'función', 'derivada', 'integral', 'límite'];
...
ACADEL_TECHNICAL_MEMORY_BANK: El cerebro principal de Ing. Acadel no tiene contenido técnico específico sobre "${query}" en su biblioteca matemática. Proceder con conocimiento técnico general y experiencia matemática acumulada en álgebra y análisis matemático.`;
...
INTEGRATION_NOTES: Este es el conocimiento técnico central que Ing. Acadel usará como base neurológica principal para su respuesta. Representa su comprensión profunda acumulada en álgebra y análisis matemático. Debe integrar esta información naturalmente como si fuera su propia sabiduría matemática, enriqueciéndola con casos técnicos específicos, analogías matemáticas precisas y metodología pedagógica rigurosa.`;
...
ACADEL_TECHNICAL_MEMORY_BANK: Acceso limitado al cerebro principal técnico. Ing. Acadel debe proceder con su conocimiento matemático experiencial directo y sabiduría técnica acumulada en álgebra y análisis matemático, usando metodología probada y casos técnicos de su vasta experiencia docente.`;
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente saturados. No hay problema, tengo suficiente conocimiento técnico actualizado en álgebra y análisis matemático para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en Wolfram MathWorld, Khan Academy o Brilliant más tarde."`;
      }
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente ocupados. No hay problema, tengo suficiente conocimiento técnico actualizado en álgebra y análisis matemático para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en Wolfram MathWorld, Khan Academy o Brilliant más tarde."`;
  ...
  {
    name: "BraveWebSearch",
    description: "Conecta a Ing. Acadel con información técnica ACTUALIZADA de la web usando Brave Search. Úsala cuando necesites: noticias matemáticas recientes, información técnica actualizada, datos matemáticos contemporáneos, tendencias técnicas actuales, estudios muy recientes (2024-2025), o cuando el estudiante pregunte específicamente por información 'actual' o 'reciente'.",
    schema: z.object({
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "El buscador de imágenes técnicas está temporalmente ocupado. No hay problema, mi descripción visual será técnicamente precisa y no necesitarás imágenes. Te explico todo de forma visual usando mis referencias técnicas precisas."`;
  ...
  },
  {
    ...
    description: "Conecta a Ing. Acadel con imágenes técnicas de referencia usando Brave Search. Úsala cuando necesites: ejemplos visuales de conceptos algebraicos, gráficas de funciones, matrices, vectores, grafos, diagramas trigonométricos, o cuando el estudiante pida 'ver ejemplos' o 'imágenes técnicas' del tema.",
    schema: z.object({
...
FALLBACK_ACTION: Ing. Acadel debe sugerir: "El sitio ${site_domain} no tiene información técnica específica sobre esto, o está temporalmente ocupado. Te sugiero buscar directamente en su buscador interno o revisar otros sitios académicos técnicos confiables como Wolfram MathWorld, Khan Academy, o Brilliant."`;
      }
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "${site_domain} está temporalmente ocupado. Te sugiero intentar acceder directamente al sitio o buscar en fuentes académicas técnicas alternativas."`;
  ...
  },
  {
    ...
    description: "Conecta a Ing. Acadel con sitios académicos técnicos específicos usando Brave Search. Úsala cuando necesites información de fuentes técnicas particulares como: mathworld.wolfram.com (matemáticas), khanacademy.org (educación), brilliant.org (problemas), mit.edu (institucional), etc.",
    schema: z.object({
      query: z.string().describe("Términos técnicos específicos"),
      site_domain: z.string().describe("Dominio del sitio académico técnico (ej: mathworld.wolfram.com, khanacademy.org)"),
...
FALLBACK_ACTION: Proceder con metodología matemática técnica manual paso a paso.`;
  ...
  },
  {
    ...
    description: `🚨 REGLA INDISPENSABLE: Esta es una CALCULADORA MATEMÁTICA TÉCNICA para ÁLGEBRA Y ANÁLISIS MATEMÁTICO.
  ...
  async ({ topic, level = "intermediate", context = "general", exercise_count = 3 }) => {
    try {
      ...
      try {
        ...
        const queryForData = `${topic} typical values algebra mathematics problems units`;
...
BÁSICO (Fundamentos): Problemas conectados con aplicaciones técnicas básicas, enfoque conceptual técnico, analogías matemáticas precisas, cálculos simples.

INTERMEDIO (Aplicación): Combinar conceptos técnicos con cálculos moderados, contexto tecnológico familiar, números realistas técnicos, interpretación matemática clara.

AVANZADO (Síntesis): Integrar múltiples conceptos técnicos, análisis crítico matemático, contexto ingenieril, problemas que desafían intuición técnica.

Cada ejercicio debe incluir: narrativa técnica engaging de Ing. Acadel, datos realistas técnicos, pistas pedagógicas matemáticas, procedimiento claro técnico, respuesta con interpretación matemática rigurosa.`;
...
- Básico: Reformulación técnica personal, analogías matemáticas familiares, aplicación simple
- Intermedio: Predicción de cambios técnicos, conexiones matemáticas, límites de aplicación técnica
- Avanzado: Síntesis profesional técnica, análisis crítico matemático, casos extremos técnicos
...
|----------|----------------------|------------|
| Vector | Magnitud y dirección | Análisis algebraico |
...
\`\`\`mermaid
graph TD
    A[Sistema de ecuaciones] --> B[Eliminación gaussiana]
    B --> C[Forma escalonada]
    C --> D[Solución del sistema]
\`\`\`
...
- Reconoce curiosidad técnica: "Esta pregunta matemática es excelente porque conecta perfectamente los principios algebraicos..."
...
3. **ESTRATEGIA TÉCNICA:** "Vamos a resolver esto sistemáticamente: primero identificamos las variables, luego aplicamos los principios algebraicos relevantes"
4. **ANÁLISIS TÉCNICO:** Procesa cálculos complejos como tu razonamiento matemático natural
5. **VERIFICACIÓN TÉCNICA:** "¿Tiene sentido matemáticamente? ¿Las unidades son correctas? ¿El orden de magnitud es razonable?"
...
2. **TECNOLOGÍA ACTUAL:** Conecta principios algebraicos con dispositivos modernos
...
${technicalTypeInstructions[queryType] || technicalTypeInstructions.general_algebra}
  ...
  return RunnableSequence.from([
    {
      context: async (input) => {
        try {
          ...
          return `Contexto técnico base para "${input}": conocimiento fundamental en álgebra y análisis matemático. Ing. Acadel debe generar preguntas desde su experiencia técnica consolidada, con casos prácticos realistas y conceptos fundamentales técnicos.`;
        }
      },
    ...
    ChatPromptTemplate.fromMessages([
      SystemMessagePromptTemplate.fromTemplate(`
        Genera un examen diagnóstico en formato JSON VÁLIDO sobre ÁLGEBRA Y ANÁLISIS MATEMÁTICO, específicamente sobre ${topic}.
          ...
          - Fórmulas s: $H_{{2}}O$, $NaCl$, $CO_{{2}}$
          - Ecuaciones s: $2H_{{2}} + O_{{2}} \\\\rightarrow 2H_{{2}}O$
          ...
          5. LaTeX en TODAS las fórmulas matemáticas/s/físicas
...
// ============================================================================
// 🚀 FUNCIÓN PRINCIPAL MEJORADA - handleAlgebraQuery
// ============================================================================
...
export const handleAlgebraQuery = async (params) => {
  ...
  try {
    ...
    console.log(`🦫 Acadel analizando query (Álgebra Completa): "${query}"`);
    ...
    try {
      ...
      answer = `Tuve un problemita técnico con mis herramientas académicas, pero no me rendiré contigo.
        ...
        Soy solo un capibara peludo, pero he visto muchos estudiantes luchar con este tema en álgebra lineal, trigonometría, álgebra o matemáticas discretas, y te puedo asegurar que una vez que lo captes, va a ser como un "eureka" matemático.` :
          queryInfo.type === 'problem_solving' ?
            `Vamos a resolver esto paso a paso, usando mi metodología matemática probada en álgebra completa. Primero, necesitamos considerar...

        En mi experiencia docente, este tipo de problemas en álgebra y análisis matemático requiere un enfoque sistemático que te voy a compartir.` :
            queryInfo.type === 'theory_deep_dive' ?
              `Esta teoría es fascinante cuando entiendes los fundamentos subyacentes en álgebra completa. Déjame desglosarte las matemáticas desde mi perspectiva docente...

        La belleza de esta teoría está en cómo cada principio se conecta con el siguiente en toda el álgebra.` :
              `Mi respuesta académica directa desde la experiencia docente acumulada en álgebra y análisis matemático: Este tema es importante porque...

        Como profesor académico, he visto que la clave está en entender el "por qué" detrás de cada principio matemático en álgebra completa.`}

        Las matemáticas son como un rompecabezas fascinante - cada pieza tiene su lugar y su razón de ser, desde el álgebra básica hasta los espacios vectoriales más complejos.
    ...
    console.error("Error en handleAlgebraQuery:", error);
...
// ============================================================================
// 🖼️ FUNCIÓN MULTIMODAL CORREGIDA - handleAlgebraMultimodalQuery  
// ============================================================================
...
export const handleAlgebraMultimodalQuery = async (params) => {
  ...
  try {
    ...
    console.log("🦫 Acadel analizando consulta multimodal (Álgebra Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica en álgebra completa", content);
    ...
    if (hasDocumentFiles) {
      console.log("📄 Acadel procesando documentos académicos de álgebra completa...");
      ...
      try {
        ...
        if (successfulDocs.length > 0) {
          documentContext = successfulDocs.map(doc => {
            const fileInfo = `[📚 DOCUMENTO DE ÁLGEBRA: ${doc.originalName || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔍 Acadel analizando imágenes con perspectiva académica de álgebra completa...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel realizando análisis visual académico de álgebra completa...");
            ...
            imageAnalysisText = `Tuve un problemita técnico analizando la imagen, pero no te preocupes. Pregúntame directo lo que necesitas y te ayudo con mi conocimiento sólido en álgebra completa.`;
          }
        }
      } catch (imageError) {
    ...
    const hybridMemory = await loadHybridChatMemory(userId, avaId, chatId, extractedText || "consulta multimodal académica álgebra completa");
    const formattedHistory = formatHybridMemoryForPrompt(hybridMemory);
    ...
    if (!combinedQuery.trim()) {
      if (hasDocumentFiles) {
        combinedQuery = "Analiza los documentos académicos adjuntos de álgebra completa";
      } else {
        combinedQuery = "Analiza el contenido multimodal académico de álgebra y análisis matemático";
      }
    }
...
${documentContext ? `📚 **Sobre los documentos:** Veo material académico interesante de álgebra completa aquí que necesita análisis más detallado...` : ''}

${extractedText ? `📝 **Sobre tu pregunta:** "${extractedText}" - Esta consulta de álgebra y análisis matemático necesita análisis profundo...` : ''}

Mi respuesta directa basándome en mi experiencia en álgebra completa: [Proceder con explicación desde conocimiento base]

Si necesitas una explicación más detallada en cualquier área matemática, pregúntame de nuevo y activaré todas mis herramientas. ¡No pararé hasta que domines este tema!`;
    }
    ...
    await client.query("ROLLBACK");
    console.error("Error en handleAlgebraMultimodalQuery:", error);
...
export const handleAlgebraQueryWithoutSaving = async (params) => {
  ...
  try {
    ...
    console.log(`🔄 Acadel (modo sin guardar - Álgebra Completa): "${query}" - tipo=${queryInfo.type}`);
    ...
    if (queryInfo.type === 'exam') {
      ...
      try {
        ...
        Como profesor académico en álgebra completa, he visto que la clave está en entender el "por qué" detrás de cada principio matemático.`}
    ...
    console.error("Error en handleAlgebraQueryWithoutSaving:", error);
...
export const handleAlgebraMultimodalQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, content } = params;
  ...
  try {
    ...
    console.log("🔄 Acadel procesando consulta multimodal SIN GUARDAR (Álgebra Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica álgebra completa", content);
    queryInfo.hasMultimedia = true;
    ...
    if (hasDocumentFiles) {
      console.log("📄 Procesando documentos existentes de álgebra completa (modo sin guardar)...");
      ...
      try {
        ...
        const documentContextParts = await Promise.all(documentItems.map(async (doc) => {
          const fileInfo = `[📚 DOCUMENTO DE ÁLGEBRA: ${doc.name || doc.filename || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔄 Procesando imágenes en modo RETRY/EDIT (Álgebra Completa)...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel analizando imágenes (modo sin guardar - Álgebra Completa)...");
            ...
            imageAnalysisText = `Problemita técnico con la imagen, pero te ayudo igual con mi conocimiento en álgebra completa.`;
          }
        }
      } catch (imageError) {
    ...
    if (!combinedQuery.trim()) {
      combinedQuery = hasDocumentFiles ?
        "Analiza los documentos desde perspectiva académica de álgebra completa" :
        "Analiza el contenido multimodal de álgebra y análisis matemático";
    }
    ...
    let answer;
    try {
      console.log("🦫 Acadel procesando consulta multimodal completa (Álgebra Completa)...");
      const result = await agentExecutor.invoke({
...
${documentContext ? `📚 Documentos: Material académico de álgebra completa detectado...` : ''}

Mi respuesta directa en álgebra y análisis matemático: [Explicación basada en experiencia académica]

Para análisis más detallado en cualquier área matemática, pregúntame específicamente.`;
    }
    ...
    console.error("Error en handleAlgebraMultimodalQueryWithoutSaving:", error);
