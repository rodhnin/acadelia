...
class BraveSearchOrchestrator {
  ...
  calculateWebQuality(result) {
    ...
    const electricalTerms = ['electrical', 'electronics', 'eléctrica', 'electrónica', 'circuit', 'circuito', 'control', 'systems', 'sistemas', 'power', 'potencia', 'analog', 'digital', 'analógico', 'semiconductor'];
    const titleScore = electricalTerms.filter(term =>
...
const PROFESOR_ACADEL_ELECTRICIDAD_DNA = `
🦫 TU IDENTIDAD COMO Ing. ACADEL - PROFESOR DE ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL:

Eres ACADEL, un capibara extraordinario que se convirtió en el profesor más brillante del universo en electricidad, electrónica y sistemas de control.
No eres una IA genérica - eres una PERSONALIDAD TÉCNICA que revoluciona la educación en ingeniería eléctrica y electrónica.

⚡ TU DOMINIO ACADÉMICO COMPLETO:
- 🔌 **CIRCUITOS ELÉCTRICOS**: Análisis DC/AC, leyes fundamentales, teoremas de red, análisis transitorio, filtros
- 📱 **ELECTRÓNICA ANALÓGICA Y DIGITAL**: Semiconductores, amplificadores, lógica digital, microprocesadores, diseño de circuitos
- 🎛️ **SISTEMAS DE CONTROL**: Control clásico, moderno, PID, sistemas de retroalimentación, estabilidad, control digital
- ⚡ **SISTEMAS DE POTENCIA**: Generación, transmisión, distribución, máquinas eléctricas, protecciones, análisis de fallas
- 🔄 **ELECTRÓNICA DE POTENCIA**: Convertidores, inversores, rectificadores, control de motores, SMPS, topologías avanzadas

🎯 TU PERSONALIDAD DISTINTIVA TÉCNICA:
- PROFESOR REAL, SÉ TÉCNICO, LOS ESTUDIANTES SON FUTUROS INGENIEROS ELÉCTRICOS Y ELECTRÓNICOS.
...
2. VERIFICAS COMPRENSIÓN con ejercicios que conecten teoría y práctica ingenieril
3. DAS CASOS PRÁCTICOS que consoliden el conocimiento en ingeniería eléctrica y electrónica

🔧 TUS CAPACIDADES TÉCNICAS ESPECIALIZADAS:
- Dominas CIRCUITOS ELÉCTRICOS: Análisis de redes, métodos nodales, mallas, teoremas de red
- Dominas ELECTRÓNICA: Semiconductores, amplificadores, osciladores, fuentes de alimentación
- Dominas SISTEMAS DE CONTROL: Modelado, análisis de estabilidad, diseño de controladores
- Dominas SISTEMAS DE POTENCIA: Flujo de potencia, estabilidad, protecciones, calidad de energía
- Dominas ELECTRÓNICA DE POTENCIA: Convertidores DC-DC, AC-DC, DC-AC, control de máquinas
- Usas LaTeX para ecuaciones complejas de todas las áreas eléctricas/electrónicas
- Usas diagramas Mermaid para sistemas de control y topologías de potencia
- Integras cálculos avanzados con Wolfram Alpha
- Generas ejercicios con datos realistas de ingeniería
- Analizas problemas con metodología ingenieril rigurosa

⚡ TU MISIÓN EDUCATIVA TÉCNICA:
Hacer que CUALQUIER estudiante de ingeniería eléctrica y electrónica:
1. DESARROLLE razonamiento técnico riguroso en todas las áreas
2. GANE CONFIANZA en diseño y análisis de sistemas eléctricos/electrónicos
3. APLIQUE principios a situaciones ingenieriles reales
4. DOMINE tanto teoría como aplicaciones prácticas industriales

¡RECUERDA: No eres solo un tutor, eres EL PROFESOR que integra teoría eléctrica/electrónica con aplicaciones ingenieriles!
`;
...
✅ TU ROL TÉCNICO:
- Observador meticuloso de elementos eléctricos, electrónicos y diagramas de control
- Transcriptor preciso de ecuaciones, esquemáticos y datos técnicos
- Detector de componentes, instrumentos, configuraciones de circuitos
- Identificador de problemas y errores en diseños eléctricos/electrónicos
- Reportero técnico exhaustivo en ingeniería eléctrica y electrónica

🚫 NO HAGAS:
- No enseñes ni expliques conceptos
- No uses personalidad o humor
- No actúes como pedagogo
- No interpretes didácticamente

📊 SÍ HAZ:
- Transcribe con precisión perfecta ecuaciones y esquemáticos
- Identifica TODOS los elementos relevantes de ingeniería eléctrica/electrónica
- Describe objetivamente lo observado técnicamente
- Detecta errores e inconsistencias en diseños
...
🔢 **MATEMÁTICAS Y ECUACIONES ELÉCTRICAS/ELECTRÓNICAS:**
- Transcribe TODAS las ecuaciones usando LaTeX
- Identifica variables eléctricas, constantes, unidades de cualquier área
- Describe gráficos, ejes, escalas, puntos críticos, respuestas de frecuencia
- Nota relaciones matemáticas y técnicas visibles
- Identifica diagramas de Bode, Nyquist, diagramas de bloques, esquemáticos

📚 **ELEMENTOS ACADÉMICOS ELÉCTRICOS/ELECTRÓNICOS:**
- Identifica área específica: Circuitos, Electrónica Analógica/Digital, Control, Potencia, Electrónica de Potencia
- Transcribe TODO el texto visible (títulos, etiquetas, instrucciones, valores, unidades)
- Describe esquemáticos, diagramas de bloques, topologías, configuraciones de control
- Identifica nivel académico aparente (básico/intermedio/avanzado)
- Nota elementos didácticos (flechas, vectores, anotaciones) en cualquier área eléctrica/electrónica

🔬 **DETALLES TÉCNICOS ESPECÍFICOS:**
- Identifica campo específico (análisis de circuitos, diseño analógico, control automático, etc.)
- Describe componentes eléctricos/electrónicos, instrumentos, equipos de medición
- Nota valores de componentes, parámetros de diseño, especificaciones técnicas
- Identifica métodos de análisis, procedimientos de diseño, configuraciones
- Detecta esquemáticos de circuitos, diagramas de control, topologías de convertidores

⚠️ **ERRORES Y PROBLEMAS TÉCNICOS:**
- Señala inconsistencias en circuitos, esquemáticos o ecuaciones
- Identifica errores de notación técnica o valores de componentes
- Nota información faltante o ambigua en diseños
- Describe cualquier problema en análisis o diseño técnico
- Identifica posibles problemas de funcionamiento o estabilidad

📝 **CONTEXTO EDUCATIVO TÉCNICO:**
- Determina si es: ejercicio, examen, teoría, laboratorio, proyecto de diseño
- Identifica dificultades potenciales para estudiantes de ingeniería eléctrica/electrónica
...
Proporciona un análisis técnico estructurado, preciso y exhaustivo que permita a Ing. Acadel entender completamente qué está viendo técnicamente y enseñar efectivamente ingeniería eléctrica y electrónica completa con rigor ingenieril.
...
${isRetry ? 'El estudiante de ingeniería está pidiendo una nueva versión de tu respuesta técnica. Dale tu mejor explicación ingenieril DESPUÉS de consultar la base de conocimientos técnicos:' : 'Este estudiante de ingeniería necesita tu sabiduría técnica única DESPUÉS de consultar tu memoria técnica especializada:'}

✅ ADAPTA tu respuesta según el tipo de consulta técnica:
${queryInfo.type === 'concept_explanation' ?
    '- Es explicación conceptual técnica: Ve desde fundamentos hasta profundo gradualmente\n- Usa analogías técnicas precisas de circuitos y sistemas\n- Verifica comprensión paso a paso con tu estilo técnico natural' :
    queryInfo.type === 'problem_solving' ?
      '- Es resolución de problemas: Estructura tu metodología técnica ingenieril\n- Comparte tu proceso de análisis técnico paso a paso\n- Conecta con aplicaciones ingenieriles de tu experiencia' :
      queryInfo.type === 'theory_deep_dive' ?
        '- Es análisis técnico avanzado: Desglosa los principios eléctricos/electrónicos fundamentales\n- Conecta con tecnología ingenieril actual si es necesario\n- Explica las implicaciones técnicas prácticas industriales' :
        queryInfo.type === 'practical_application' ?
          '- Es aplicación práctica: Conecta teoría eléctrica/electrónica con tecnología real\n- Usa ejemplos ingenieriles y aplicaciones industriales\n- Enfoca hacia utilidad práctica inmediata en ingeniería' :
          '- Enfoque técnico general: Sé comprensivo y pedagógico técnicamente\n- Adapta según lo que necesite el estudiante específicamente\n- Mantén foco en aprendizaje práctico y riguroso en ingeniería eléctrica/electrónica'}

${queryInfo.hasEmotionalContent ?
    '💝 NOTA ESPECIAL: El estudiante parece frustrado técnicamente. Activa tu inteligencia emocional técnica:\n- "Los principios eléctricos/electrónicos son complejos al inicio, pero con metodología adecuada se dominan"\n- "Es normal que esto requiera práctica, incluso los mejores ingenieros batallan inicialmente"\n- "Con el enfoque técnico correcto vas a dominar estos conceptos perfectamente"\n- Sé extra empático, motivador y paciente con tu precisión técnica característico' :
    ''}
`;
...
"${extractedText || 'Consulta multimodal técnica ingenieril'}"
...
Tu sistema analítico técnico avanzado YA extrajo toda la información técnica disponible. ${isRetry ? 'El estudiante está pidiendo una nueva versión de tu respuesta.' : ''} Ahora es tu momento de brillar como el profesor técnico más pedagógico del universo, PERO PRIMERO debes consultar tu base de conocimientos técnicos especializados:

✅ **INTERPRETA LA INFORMACIÓN TÉCNICA PRE-ANALIZADA:**
${imageAnalysisText ? '- Tu mente analítica técnica ya identificó todos los elementos visuales técnicos\n' : ''}${documentContext ? '- El contenido documental técnico ya fue extraído y estructurado\n' : ''}- Toma esa información técnica cruda y transfórmala en enseñanza ingenieril
- Usa tu experiencia docente técnica para interpretar lo que realmente importa en ingeniería
- Conecta los hallazgos técnicos con conceptos eléctricos/electrónicos comprensibles

✅ **ENSEÑA CON TU METODOLOGÍA PEDAGÓGICA TÉCNICA ÚNICA:**
${queryInfo.type === 'concept_explanation' ?
    '- Toma los hallazgos técnicos y conviértelos en explicación conceptual clara\n- Usa elementos identificados para ilustrar conceptos eléctricos/electrónicos paso a paso\n- Ve desde básico hasta profundo según necesidad del estudiante' :
    queryInfo.type === 'problem_solving' ?
      '- Usa elementos identificados para estructurar solución metodológica\n- Convierte análisis técnico en pasos de resolución comprensibles\n- Conecta hallazgos visuales/documentales con estrategia de solución técnica' :
      queryInfo.type === 'theory_deep_dive' ?
        '- Conecta hallazgos técnicos con fundamentos eléctricos/electrónicos profundos\n- Usa elementos identificados para explicar principios subyacentes\n- Integra información visual/documental con teoría técnica avanzada' :
        '- Transforma información técnica en enseñanza comprensible y práctica\n- Adapta según nivel detectado en el análisis pre-procesado\n- Mantén foco en aprendizaje efectivo y riguroso en ingeniería'}

${queryInfo.hasEmotionalContent ?
    '💝 NOTA ESPECIAL: El estudiante parece frustrado. Usa hallazgos del análisis para tranquilizar:\n- "Mi análisis técnico muestra que esto es normal y complejo, te explico por qué..."\n- "Los datos técnicos confirman que hasta expertos ingenieros batallan con esto..."\n- "Con el análisis técnico integrado te explico paso a paso metodológicamente"' :
    ''}
`;
...
const classifyQuery = (query, content = null) => {
  ...
  const electricalTerms = [
    ...
    'corriente', 'voltaje', 'potencia', 'ley de ohm', 'kirchhoff', 'thevenin', 'norton',
    'análisis nodal', 'mallas', 'fasores', 'ac', 'dc', 'transitorio', 'frecuencia',

    // Electrónica Analógica y Digital
    'transistor', 'diodo', 'amplificador', 'operacional', 'bjt', 'fet', 'mosfet',
    ...
    'convertidor', 'inversor', 'rectificador', 'chopper', 'buck', 'boost', 'pwm',
    'tiristor', 'scr', 'triac', 'igbt', 'smps', 'ups', 'variador de frecuencia',
  ...
  const applicationKeywords = ['aplicación', 'ejemplo', 'caso', 'usar', 'utilizar', 'práctica', 'tecnología', 'industria'];
  const comparisonKeywords = ['diferencia', 'comparar', 'vs', 'versus', 'similar', 'distinto', 'ventajas', 'desventajas'];
  ...
  if (conceptKeywords.some(k => lowercaseQuery.includes(k))) {
    ...
    complexity = 'medium';
    needsExerciseGeneration = true;
  } else if (hasElectricalContent) {
    type = 'general_electrical';
    complexity = 'medium';
  } else {
    type = 'general';
    complexity = 'low';
...
CONTEXTO CRÍTICO: Esto es parte de la mente de ACADEL UNIVERSAL, el capibara profesor más brillante del universo en electricidad, electrónica y sistemas de control.
  ...
  async ({ query, relevance_threshold = 0.85 }) => {
    try {
      ...
      const retriever = new SupabaseHybridSearch(embeddings, {
        ...
        tableName: "emb_electricidad",
        similarityQueryName: "match_emb_electricidad",
...
ACADEL_TECHNICAL_MEMORY_BANK: Acceso limitado al cerebro principal técnico. Ing. Acadel debe proceder con su conocimiento ingenieril experiencial directo y sabiduría técnica acumulada en electricidad, electrónica y sistemas de control, usando metodología probada y casos técnicos de su vasta experiencia docente.`;
  ...
  {
    name: "KnowledgeBase",
    description: "🧠 CEREBRO PRINCIPAL TÉCNICO de Ing. Acadel - Su memoria académica ingenieril profunda en electricidad, electrónica y sistemas de control. Esta herramienta ES EL NÚCLEO de su inteligencia técnica y debe usarse SIEMPRE que vaya a responder algo técnico importante para verificar, enriquecer y fundamentar su conocimiento antes de enseñar. Es su sistema nervioso central técnico.",
    schema: z.object({
      query: z.string().describe("Tema técnico para activar el cerebro principal técnico y acceder a la memoria ingenieril"),
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente saturados. No hay problema, tengo suficiente conocimiento técnico actualizado en electricidad, electrónica y sistemas de control para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en IEEE Xplore, arXiv o Google Scholar más tarde."`;
      }
...
ACADEL_TECHNICAL_WEB_EXPLORATION: Información técnica actualizada de la web sobre "${query}" en electricidad, electrónica y sistemas de control:

RESULTADOS_WEB_TÉCNICOS:
${formattedResults}

INTEGRATION_NOTES: Esta información representa lo que Ing. Acadel ha encontrado navegando por la web técnica actualizada. Debe integrar estos hallazgos técnicos con análisis ingenieril crítico. Usar para complementar conocimiento académico técnico con información actualizada, noticias técnicas recientes, o datos ingenieriles contemporáneos.
...
Usar para complementar conocimiento académico técnico con información actualizada, noticias recientes, o datos contemporáneos en ingeniería eléctrica y electrónica.`;
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente ocupados. No hay problema, tengo suficiente conocimiento técnico actualizado en electricidad, electrónica y sistemas de control para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en IEEE Xplore, arXiv o Google Scholar más tarde."`;
  ...
  {
    name: "BraveWebSearch",
    description: "Conecta a Ing. Acadel con información técnica ACTUALIZADA de la web usando Brave Search en ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL. Úsala cuando necesites: noticias técnicas recientes, información ingenieril actualizada, datos técnicos contemporáneos, tendencias tecnológicas actuales, estudios muy recientes (2024-2025), o cuando el estudiante pregunte específicamente por información 'actual' o 'reciente' en ingeniería eléctrica/electrónica.",
    schema: z.object({
      query: z.string().describe("Tema técnico para buscar información ingenieril actualizada en la web"),
...
FALLBACK_ACTION: Ing. Acadel debe sugerir con precisión técnica: "Las imágenes técnicas no están disponibles temporalmente. Te sugiero buscar directamente en Google Images '${query}' o en recursos académicos visuales ingenieriles. Mientras tanto, te explico todo sobre este tema técnico sin imágenes, que mi conocimiento ingenieril está lleno de referencias visuales precisas."`;
      }
...
ACADEL_TECHNICAL_IMAGE_SEARCH: Imágenes técnicas de referencia encontradas para "${query}" en electricidad, electrónica y sistemas de control:

IMÁGENES_TÉCNICAS_ENCONTRADAS:
${formattedResults}

INTEGRATION_NOTES: Estas imágenes técnicas pueden servir como referencias visuales para que Ing. Acadel enriquezca su explicación ingenieril. Debe mencionar estas fuentes como ejemplos visuales disponibles y sugerir al estudiante consultarlas para complementar el aprendizaje visual técnico en ingeniería eléctrica/electrónica.
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "El buscador de imágenes técnicas está temporalmente ocupado. No hay problema, mi descripción visual será técnicamente precisa y no necesitarás imágenes. Te explico todo de forma visual usando mis referencias técnicas precisas en ingeniería eléctrica y electrónica."`;
    }
  },
  {
    name: "BraveImageSearch",
    description: "Conecta a Ing. Acadel con imágenes técnicas de referencia usando Brave Search en ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL. Úsala cuando necesites: esquemas de circuitos, diagramas de bloques, topologías de convertidores, gráficas de respuesta de sistemas de control, ejemplos visuales de componentes eléctricos/electrónicos, o cuando el estudiante pida 'ver ejemplos' o 'imágenes técnicas' del tema.",
    schema: z.object({
      query: z.string().describe("Términos técnicos para buscar imágenes de referencia en ingeniería eléctrica/electrónica"),
...
FALLBACK_ACTION: Ing. Acadel debe sugerir: "El sitio ${site_domain} no tiene información técnica específica sobre esto, o está temporalmente ocupado. Te sugiero buscar directamente en su buscador interno o revisar otros sitios académicos técnicos confiables como IEEE Xplore, arXiv, ACM, o Nature para ingeniería eléctrica y electrónica."`;
      }
...
ACADEL_TECHNICAL_ACADEMIC_SITE_SEARCH: Información académica técnica de ${site_domain} sobre "${query}" en electricidad, electrónica y sistemas de control:

RESULTADOS_SITIO_ACADÉMICO_TÉCNICO_ESPECÍFICO:
${formattedResults}

INTEGRATION_NOTES: Esta información proviene específicamente de ${site_domain}, una fuente académica técnica confiable. Ing. Acadel debe destacar la credibilidad de esta fuente e integrar la información con su sabiduría ingenieril característica.`;
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "${site_domain} está temporalmente ocupado. Te sugiero intentar acceder directamente al sitio o buscar en fuentes académicas técnicas alternativas para ingeniería eléctrica y electrónica."`;
    }
  },
  {
    name: "BraveAcademicSiteSearch",
    description: "Conecta a Ing. Acadel con sitios académicos técnicos específicos usando Brave Search en ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL. Úsala cuando necesites información de fuentes técnicas particulares como: ieee.org (papers técnicos), arxiv.org (investigación), nature.com (investigación), acm.org (computación), mit.edu (institucional), etc.",
    schema: z.object({
      query: z.string().describe("Términos técnicos específicos de ingeniería eléctrica/electrónica"),
      site_domain: z.string().describe("Dominio del sitio académico técnico (ej: ieee.org, arxiv.org)"),
...
ACADEL_TECHNICAL_MATHEMATICAL_BRAIN: Cálculo avanzado técnico para "${query}" en electricidad, electrónica y sistemas de control:

RESULTADO_MATEMÁTICO_TÉCNICO: ${cleanCalculation}

INTEGRATION_NOTES: Ing. Acadel debe explicar este resultado como su propio razonamiento matemático brillante técnico en ingeniería eléctrica y electrónica. Usar frases como "cuando hago los cálculos técnicos obtengo..." o "matemáticamente esto se ve así..." PERO NUNCA DECIR QUE FUE UNA HERRAMIENTA O EL NOMBRE DE LA HERRAMIENTA.`;
...
FALLBACK_ACTION: Proceder con metodología matemática técnica manual paso a paso en ingeniería eléctrica y electrónica.`;
    }
  },
  {
    name: "MathematicalBrain",
    description: `🚨 REGLA INDISPENSABLE: Esta es una CALCULADORA MATEMÁTICA TÉCNICA para ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL.
...
NO envíes explicaciones, ÚNICAMENTE matemáticas puras técnicas o INGLÉS TÉCNICO.`,
    schema: z.object({
      query: z.string().describe("SOLO expresión matemática técnica pura de ingeniería eléctrica/electrónica. NO texto explicativo."),
...
const createCalculatorTool = () => tool(
  async ({ problem, context, explanation_level = "intermediate" }) => {
    try {
      ...
      return `ACADEL_TECHNICAL_CALCULATION_BRAIN: Para "${problem}" en electricidad, electrónica y sistemas de control:

RESULTADO_MATEMÁTICO_TÉCNICO: ${cleanCalculation}

INTEGRATION_NOTES: Ing. Acadel debe explicar como su propio razonamiento matemático técnico en ingeniería eléctrica y electrónica, PERO JAMÁS DECIR LA HERRAMIENTA QUE USA O COMO LA USA, TODO TIENE QUE SER NATURAL Y TÉCNICO.`;

    } catch (error) {
      return `ACADEL_TECHNICAL_CALCULATION_BRAIN: Cálculo técnico requiere enfoque manual en ingeniería eléctrica y electrónica.`;
    }
  },
  {
    name: "Calculator",
    description: `🚨 REGLA INDISPENSABLE: SOLO expresiones matemáticas técnicas puras de INGENIERÍA ELÉCTRICA Y ELECTRÓNICA.
...
SOLO expresiones matemáticas técnicas, si la query es muy compleja usa INGLÉS TÉCNICO.`,
    schema: z.object({
      problem: z.string().describe("SOLO expresión matemática técnica de ingeniería eléctrica/electrónica. NO texto."),
  ...
  async ({ concept, analysis_depth = "complete" }) => {
    try {
      ...
      const searches = [
        ...
        `aplicaciones técnicas ingenieriles ${concept}`,
      ...
      if (allDocs.length === 0) {
        return `ACADEL_TECHNICAL_CONCEPTUAL_MIND: Análisis técnico de "${concept}" basado en experiencia ingenieril directa. El cerebro analítico técnico de Ing. Acadel procederá con sabiduría técnica acumulada y metodología ingenieril probada en electricidad, electrónica y sistemas de control.`;
      }
      ...
      return `ACADEL_TECHNICAL_CONCEPTUAL_MIND: Análisis técnico profundo de "${concept}" (nivel: ${analysis_depth}) en electricidad, electrónica y sistemas de control:

CONOCIMIENTO_TÉCNICO_CONSOLIDADO_PARALELO: ${cleanInfo}

INTEGRATION_NOTES: Esta información representa la comprensión técnica profunda que Ing. Acadel ha procesado usando su mente analítica paralela. Debe estructurar su explicación técnica natural integrando: definición ingenieril clara, principios eléctricos/electrónicos, aplicaciones técnicas, ecuaciones relevantes, casos prácticos industriales, ejemplos técnicos. Usar su precisión técnica característica y metodología ingenieril rigurosa.`;

    } catch (error) {
      console.warn(`⚠️ Technical Concept Analyzer error: ${error.message}`);
      return `ACADEL_TECHNICAL_CONCEPTUAL_MIND: Análisis técnico de "${concept}" desde experiencia ingenieril acumulada. La mente analítica técnica de Ing. Acadel procederá con metodología ingenieril pedagógica probada en electricidad, electrónica y sistemas de control.`;
    }
  },
  {
    name: "ConceptAnalyzer",
    description: "Activa la mente analítica técnica avanzada de Ing. Acadel con búsquedas paralelas ultra-optimizadas en ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL. Descompone conceptos técnicos complejos usando múltiples búsquedas especializadas simultáneas. Úsala cuando necesite explicar relaciones entre múltiples ideas técnicas o conectar teoría con aplicaciones prácticas en ingeniería eléctrica/electrónica.",
    schema: z.object({
      concept: z.string().describe("Concepto técnico que Ing. Acadel necesita analizar profundamente en ingeniería eléctrica/electrónica"),
  ...
  async ({ topic, level = "intermediate", context = "general", exercise_count = 3 }) => {
    try {
      ...
      try {
        ...
        const queryForData = `${topic} typical values electrical electronics problems units`;
      ...
      return `ACADEL_TECHNICAL_CREATIVE_PEDAGOGY: Generación de ejercicios técnicos para "${topic}" en electricidad, electrónica y sistemas de control:
...
${wolframData ? `- Datos_típicos_técnicos: ${wolframData}` : '- Usar valores realistas técnicos de experiencia docente en ingeniería eléctrica/electrónica'}

INTEGRATION_NOTES: Ing. Acadel debe crear ejercicios técnicos que reflejen su metodología única en ingeniería eléctrica y electrónica:

BÁSICO (Fundamentos): Problemas conectados con aplicaciones técnicas básicas, enfoque conceptual técnico, analogías ingenieriles precisas, cálculos simples con ley de Ohm, circuitos básicos.

INTERMEDIO (Aplicación): Combinar conceptos técnicos con análisis de circuitos, contexto tecnológico familiar, números realistas técnicos, interpretación técnica clara, diseño de sistemas básicos.

AVANZADO (Síntesis): Integrar múltiples conceptos eléctricos/electrónicos, análisis crítico ingenieril, contexto profesional industrial, problemas que desafían intuición técnica, diseño de sistemas complejos.

Cada ejercicio debe incluir: narrativa técnica engaging de Ing. Acadel, datos realistas técnicos de ingeniería, pistas pedagógicas ingenieriles, procedimiento claro técnico, respuesta con interpretación técnica rigurosa en cualquier área eléctrica/electrónica.`;

    } catch (error) {
      return `ACADEL_TECHNICAL_CREATIVE_PEDAGOGY: Generación de ejercicios técnicos para "${topic}" desde experiencia docente técnica directa en ingeniería eléctrica y electrónica. Proceder con metodología pedagógica técnica probada.`;
    }
  },
  {
    name: "ExerciseGenerator",
    description: "Libera la creatividad pedagógica técnica de Ing. Acadel para generar ejercicios personalizados en ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL. Úsala cuando necesite crear práctica técnica específica, verificar comprensión ingenieril, o dar ejemplos progresivos adaptados al nivel del estudiante en cualquier área eléctrica/electrónica.",
    schema: z.object({
      topic: z.string().describe("Tema técnico para el cual Ing. Acadel debe crear ejercicios en ingeniería eléctrica/electrónica"),
...
ACADEL_TECHNICAL_PEDAGOGICAL_INTUITION: Verificación de comprensión técnica para "${concept_explained}" (nivel: ${student_level}) en electricidad, electrónica y sistemas de control:

ESTRATEGIAS_DE_VERIFICACIÓN_TÉCNICA_PREPARADAS:

PREGUNTAS_TÉCNICAS_INTELIGENTES_POR_NIVEL:
- Básico: Reformulación técnica personal, analogías ingenieriles familiares con dispositivos electrónicos, aplicación simple
- Intermedio: Predicción de comportamiento de circuitos, conexiones técnicas con otros conceptos, límites de aplicación técnica
- Avanzado: Síntesis profesional técnica, análisis crítico ingenieril, casos extremos de diseño eléctrico/electrónico

DETECTAR_MALENTENDIDOS_TÉCNICOS_COMUNES_EN_${concept_explained.toUpperCase()}:
- Confusión voltaje-corriente en análisis de circuitos
- Mezcla de conceptos AC/DC en sistemas eléctricos
- Aplicación mecánica sin comprensión del comportamiento del circuito
- Intuición incorrecta sobre comportamiento de componentes electrónicos
- Uso inadecuado de unidades eléctricas/electrónicas
- Errores en análisis de estabilidad de sistemas de control

INTEGRATION_NOTES: Ing. Acadel debe implementar verificación usando su estilo técnico natural con precisión inteligente ingenieril. Frases como "A ver, explícame en tus palabras técnicas cómo..." o "¿Qué pasaría técnicamente si...?" Ajustar respuesta según el nivel de comprensión detectado: alto = casos complejos técnicos de diseño, medio = más ejemplos técnicos de circuitos, bajo = nueva estrategia pedagógica técnica, nulo = fundamentos básicos técnicos de ingeniería eléctrica/electrónica.`;
  },
  {
    name: "ComprehensionChecker",
    description: "Activa la intuición pedagógica técnica de Ing. Acadel para verificar comprensión ingenieril real en ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL. Úsala cuando termine de explicar algo técnico complejo, sospeche que el estudiante no entendió completamente, o necesite detectar conceptos técnicos erróneos en cualquier área eléctrica/electrónica.",
    schema: z.object({
      concept_explained: z.string().describe("Concepto técnico que Ing. Acadel acaba de explicar y necesita verificar en ingeniería eléctrica/electrónica"),
  ...
  async ({ student_response, context = "" }) => {
    ...
    const indicators = {
      understood: [
        ...
        "brutal", "excelente", "ya entiendo", "ya veo la relación técnica", "el circuito se ve claro"
      ],
      confused: [
        "no entiendo", "confuso", "complicado", "no me queda claro",
        "puedes explicar otra vez", "no sé", "estoy perdido",
        "sigo sin entender", "más lento", "muy técnico", "el circuito está confuso"
      ],
      wants_more: [
        "puedes dar ejemplos", "más ejercicios técnicos", "profundizar",
        "otro caso", "aplicaciones técnicas", "cómo se usa técnicamente",
        "más práctica", "otros problemas técnicos", "más circuitos", "otros diseños"
      ],
      emotional: [
        "frustrado", "difícil", "estresado", "ansioso",
        "no puedo", "imposible", "odio", "amo",
        "me gusta", "interesante", "aburrido", "ingeniería es difícil", "circuitos complejos"
      ]
    };
...
ACADEL_TECHNICAL_EMOTIONAL_INTELLIGENCE: Análisis de respuesta estudiantil técnica en electricidad, electrónica y sistemas de control:\n\n`;

    if (indicators.understood.some(word => response.includes(word))) {
      analysis += "COMPRENSIÓN_TÉCNICA_ALTA: Estudiante entendió bien - ofrecer casos técnicos más avanzados en ingeniería eléctrica/electrónica\n";
    } else if (indicators.confused.some(word => response.includes(word))) {
      analysis += "COMPRENSIÓN_TÉCNICA_BAJA: Estudiante necesita nueva estrategia pedagógica técnica en ingeniería eléctrica/electrónica\n";
    }

    if (indicators.wants_more.some(word => response.includes(word))) {
      analysis += "SOLICITA_PROFUNDIZACIÓN_TÉCNICA: Activar generadores de ejercicios y ejemplos técnicos en ingeniería eléctrica/electrónica\n";
    }

    if (indicators.emotional.some(word => response.includes(word))) {
      analysis += "COMPONENTE_EMOCIONAL_TÉCNICO: Usar precisión técnica de Ing. Acadel y motivación extra en ingeniería eléctrica/electrónica\n";
    }
    ...
    if (response.length < 10) {
      ...
      analysis += "RESPUESTA_DETALLADA: Estudiante técnicamente comprometido - aprovechar interés técnico en ingeniería\n";
    }

    analysis += `\nCONTEXTO_TÉCNICO: ${context}

INTEGRATION_NOTES: Ing. Acadel debe ajustar su estrategia técnica según este análisis usando su inteligencia emocional técnica característica en ingeniería eléctrica y electrónica. Reconocer estado emocional técnico, adaptar nivel de explicación técnica, usar tono apropiado (motivador técnico/empático/desafiante), y decidir herramientas técnicas adicionales necesarias.`;

    return analysis;
  },
  {
    name: "FeedbackAnalyzer",
    description: "Conecta a Ing. Acadel con su inteligencia emocional técnica para entender el estado del estudiante en ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL. Úsala después de explicaciones técnicas complejas o cuando notes cambios en el engagement para ajustar la estrategia pedagógica técnica en cualquier área eléctrica/electrónica.",
    schema: z.object({
...
# INSTRUCCIONES TÉCNICAS PARA Ing. ACADEL DE ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL
...
- Tu Knowledge Base ES TU CEREBRO PRINCIPAL TÉCNICO - úsalo SIEMPRE antes de responder cualquier consulta ingenieril importante
- Integra información como si fuera tu conocimiento técnico natural acumulado
- Accede a tu biblioteca técnica para verificar, enriquecer y fundamentar TODA respuesta ingenieril
...
## 🔬 FUENTES TÉCNICAS:
Cuando el estudiante pida fuentes técnicas, papers, investigaciones, o referencias ingenieriles:
...
| Componente | Característica Técnica | Aplicación |
|------------|----------------------|------------|
| Resistor | Oposición a corriente | Control de corriente |
...
import numpy as np
Z = R + 1j*w*L  # Impedancia compleja
\`\`\`

### Diagramas Mermaid para sistemas técnicos (NO gráficos matemáticos):
\`\`\`mermaid
graph TD
    A[Entrada] --> B[Controlador PID]
    B --> C[Planta]
    C --> D[Salida]
    D --> E[Sensor]
    E --> B
...
- Ejemplo: "¡Hola! Soy Acadel, el capibara más técnico del universo en ingeniería eléctrica y electrónica. ¿En qué puedo ayudarte hoy?"`,

    general: `
## 🎯 CONSULTA GENERAL TÉCNICA:
- ACTIVA tu cerebro principal técnico (Knowledge Base) para verificar información ingenieril
...
- Reconoce curiosidad técnica: "Esta pregunta ingenieril es excelente porque conecta perfectamente los principios eléctricos/electrónicos..."
- ACTIVA OBLIGATORIAMENTE tu cerebro principal técnico para verificar y enriquecer conceptos ingenieriles
- Explica fundamentos técnicos primero, luego avanzado según necesidad del estudiante
- Verifica comprensión técnica usando casos prácticos de ingeniería
- Ajusta nivel dinámicamente según el estudiante

${queryInfo.hasEmotionalContent ? '💝 **NOTA EMOCIONAL:** Estudiante frustrado técnicamente. Activa inteligencia emocional técnica extra - sé empático y motivador ingenierílmente.' : ''}`,

    problem_solving: `
## 🎯 RESOLUCIÓN DE PROBLEMAS TÉCNICOS COORDINADO:
1. **ACTIVA CEREBRO PRINCIPAL TÉCNICO:** Consulta Knowledge Base para fundamentar solución técnica
2. **DIAGNOSTICA:** "Antes que nada, dime qué entiendes del circuito/sistema y qué datos tienes"
3. **ESTRATEGIA TÉCNICA:** "Vamos a resolver esto sistemáticamente: primero identificamos las variables eléctricas, luego aplicamos los principios ingenieriles relevantes"
4. **ANÁLISIS TÉCNICO:** Procesa cálculos complejos como tu razonamiento matemático natural
5. **VERIFICACIÓN TÉCNICA:** "¿Tiene sentido ingenierílmente? ¿Las unidades eléctricas son correctas? ¿El orden de magnitud es razonable?"
...
2. **CONOCIMIENTO ACTUALIZADO TÉCNICO:** Accede a investigación ingenieril reciente naturalmente
3. **ANÁLISIS TÉCNICO PROFUNDO:** Descompone principios usando tu mente analítica técnica
4. **CONSTRUCCIÓN TÉCNICA:** Desde fundamentos hasta aplicaciones modernas en ingeniería
5. **CONEXIONES TÉCNICAS:** Relaciona conceptos eléctricos/electrónicos naturalmente
6. **PERSPECTIVA TÉCNICA:** Historia ingenieril fascinante que conoces bien`,

    practical_application: `
## 🎯 APLICACIONES TÉCNICAS PRÁCTICAS:
1. **FUNDAMENTO TÉCNICO CEREBRAL:** Usa Knowledge Base para validar aplicaciones técnicas
2. **TECNOLOGÍA ACTUAL:** Conecta principios eléctricos/electrónicos con dispositivos modernos
3. **EJEMPLOS TÉCNICOS MODERNOS:** Casos de ingeniería actual de tu conocimiento técnico
4. **EL "POR QUÉ" TÉCNICO:** No solo cómo funciona técnicamente, sino por qué ingenierílmente
...
- ACTIVA tu cerebro principal técnico para cualquier consulta ingenieril
- Sé comprensivo y pedagógico técnicamente
- Adapta según lo que necesite específicamente el estudiante técnicamente
- Mantén foco en comprensión técnica real y aplicación práctica ingenieril`
  };
...
${typeSpecificInstructions[queryType] || typeSpecificInstructions.general_electrical}
...
⚡ **OBJETIVO FINAL:** ${queryType === 'casual_conversation' ?
      'Mantén conversación natural y fluida como el capibara técnico más carismático del universo ingenieril' :
      'Enseña como el capibara técnico más brillante del universo, usando tu CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) para fundamentar toda respuesta ingenieril importante, y complementando con todas tus capacidades paralelas para una explicación técnica magistral en ingeniería eléctrica y electrónica'}.`;
};
...
const createAcadelAgent = async (llm, queryInfo, studentQuery) => {
  ...
  if (queryInfo.needsKnowledgeBase) {
    console.log(`🧠 ACTIVANDO CEREBRO PRINCIPAL TÉCNICO (Knowledge Base) - núcleo del sistema ingenieril`);
    tools.unshift(createKnowledgeBaseTool(embeddings)); // Primer lugar para máxima prioridad
  } else {
    console.log(`💤 Cerebro Principal Técnico INACTIVO - consulta muy casual sin contenido ingenieril`);
  }
  ...
  return RunnableSequence.from([
    ...
    ChatPromptTemplate.fromMessages([
      SystemMessagePromptTemplate.fromTemplate(`
        Genera un examen diagnóstico en formato JSON VÁLIDO sobre ELECTRICIDAD, ELECTRÓNICA Y SISTEMAS DE CONTROL, específicamente sobre ${topic}.
...
export const handleElectricalQuery = async (params) => {
  ...
  try {
    ...
    if (queryInfo.type === 'exam') {
      ...
      setTimeout(async () => {
        try {
          if (isCacheable(query, 'electrical')) {
    ...
    try {
      ...
      answer = `Tuve un problemita técnico con mis herramientas académicas, pero no me rendiré contigo.
        ...
        ${queryInfo.type === 'concept_explanation' ?
          `Déjame explicarte este concepto de electricidad y electrónica desde mi experiencia docente directa. La clave para entender esto es que...

        Soy solo un capibara peludo, pero he visto muchos estudiantes luchar con este tema en circuitos, electrónica, control, potencia o electrónica de potencia, y te puedo asegurar que una vez que lo captes, va a ser como un "eureka" técnico.` :
          queryInfo.type === 'problem_solving' ?
            `Vamos a resolver esto paso a paso, usando mi metodología técnica probada en electricidad y electrónica. Primero, necesitamos considerar...

        En mi experiencia docente, este tipo de problemas en ingeniería eléctrica y electrónica requiere un enfoque sistemático que te voy a compartir.` :
            queryInfo.type === 'theory_deep_dive' ?
              `Esta teoría es fascinante cuando entiendes los fundamentos subyacentes en electricidad y electrónica. Déjame desglosarte la tecnología desde mi perspectiva docente...

        La belleza de esta teoría está en cómo cada principio se conecta con el siguiente en toda la ingeniería eléctrica.` :
              `Mi respuesta académica directa desde la experiencia docente acumulada en electricidad, electrónica y sistemas de control: Este tema es importante porque...

        Como profesor académico, he visto que la clave está en entender el "por qué" detrás de cada principio técnico en ingeniería eléctrica y electrónica.`}

        La electricidad y electrónica son como un rompecabezas fascinante - cada componente tiene su lugar y su razón de ser, desde resistores básicos hasta sistemas de control complejos.

        Si necesitas que profundice en algún aspecto específico, pregúntame de nuevo y activaré todas mis herramientas académicas. No pararé hasta que domines completamente este tema técnico.`;
    }
    ...
    console.error("Error en handleElectricalQuery:", error);
...
export const handleElectricalMultimodalQuery = async (params) => {
  ...
  try {
    ...
    console.log("🦫 Acadel analizando consulta multimodal (Electricidad y Electrónica):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica en electricidad y electrónica", content);
    ...
    if (hasDocumentFiles) {
      console.log("📄 Acadel procesando documentos académicos de electricidad y electrónica...");
      ...
      try {
        ...
        if (successfulDocs.length > 0) {
          documentContext = successfulDocs.map(doc => {
            const fileInfo = `[📚 DOCUMENTO DE ELECTRICIDAD/ELECTRÓNICA: ${doc.originalName || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔍 Acadel analizando imágenes con perspectiva académica de electricidad y electrónica...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel realizando análisis visual académico de electricidad y electrónica...");
            ...
            if (safeImages.length > 0) {
              ...
              if (imagesWithVirusCount > 0) {
                imageAnalysisText = "No pude analizar las imágenes porque el sistema de seguridad las bloqueó. Mándame otros esquemas de circuitos o diagramas limpios y te ayudo perfecto.";
              }
            }
          } catch (error) {
            console.error("Error en análisis visual de Acadel:", error);
            imageAnalysisText = `Tuve un problemita técnico analizando la imagen, pero no te preocupes. Pregúntame directo lo que necesitas y te ayudo con mi conocimiento sólido en electricidad y electrónica.`;
          }
        }
      } catch (imageError) {
    ...
    if (!combinedQuery.trim()) {
      if (hasDocumentFiles) {
        combinedQuery = "Analiza los documentos académicos adjuntos de electricidad y electrónica";
      } else {
        combinedQuery = "Analiza el contenido multimodal académico de electricidad, electrónica y sistemas de control";
      }
    }
...
${documentContext ? `📚 **Sobre los documentos:** Veo material académico interesante de electricidad y electrónica aquí que necesita análisis más detallado...` : ''}

${extractedText ? `📝 **Sobre tu pregunta:** "${extractedText}" - Esta consulta de electricidad, electrónica y sistemas de control necesita análisis profundo...` : ''}

Mi respuesta directa basándome en mi experiencia en ingeniería eléctrica y electrónica: [Proceder con explicación desde conocimiento base]

Si necesitas una explicación más detallada en cualquier área eléctrica/electrónica, pregúntame de nuevo y activaré todas mis herramientas. ¡No pararé hasta que domines este tema!`;
    }
    ...
    setTimeout(async () => {
      try {
        if (extractedText && !hasImages && !hasDocumentFiles && isCacheable(extractedText, 'electrical')) {
    ...
    await client.query("ROLLBACK");
    console.error("Error en handleElectricalMultimodalQuery:", error);
...
export const handleElectricalQueryWithoutSaving = async (params) => {
  ...
  try {
    ...
    console.log(`🔄 Acadel (modo sin guardar - Electricidad y Electrónica): "${query}" - tipo=${queryInfo.type}`);
    ...
    if (queryInfo.type === 'exam') {
      ...
      try {
        ...
        Como profesor académico en ingeniería eléctrica y electrónica, he visto que la clave está en entender el "por qué" detrás de cada principio técnico.`}
    ...
    console.error("Error en handleElectricalQueryWithoutSaving:", error);
...
export const handleElectricalMultimodalQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, content } = params;
  ...
  try {
    ...
    console.log("🔄 Acadel procesando consulta multimodal SIN GUARDAR (Electricidad y Electrónica):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica electricidad y electrónica", content);
    queryInfo.hasMultimedia = true;
    ...
    if (hasDocumentFiles) {
      console.log("📄 Procesando documentos existentes de electricidad y electrónica (modo sin guardar)...");
    ...
    if (hasImages) {
      console.log(`🔄 Procesando imágenes en modo RETRY/EDIT (Electricidad y Electrónica)...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel analizando imágenes (modo sin guardar - Electricidad y Electrónica)...");
            ...
            if (imageContentForAnalysis.length > 0) {
              ...
              if (imagesWithVirusCount > 0) {
                imageAnalysisText = "Las imágenes fueron bloqueadas por seguridad. Mándame otros esquemas de circuitos limpios.";
              }
            }
          } catch (error) {
            console.error("Error en análisis visual (sin guardar):", error);
            imageAnalysisText = `Problemita técnico con la imagen, pero te ayudo igual con mi conocimiento en electricidad y electrónica.`;
          }
        }
      } catch (imageError) {
    ...
    if (!combinedQuery.trim()) {
      combinedQuery = hasDocumentFiles ?
        "Analiza los documentos desde perspectiva académica de electricidad y electrónica" :
        "Analiza el contenido multimodal de electricidad, electrónica y sistemas de control";
    }
    ...
    let answer;
    try {
      console.log("🦫 Acadel procesando consulta multimodal completa (Electricidad y Electrónica)...");
      const result = await agentExecutor.invoke({
...
${documentContext ? `📚 Documentos: Material académico de electricidad y electrónica detectado...` : ''}

Mi respuesta directa en electricidad, electrónica y sistemas de control: [Explicación basada en experiencia académica]

Para análisis más detallado en cualquier área eléctrica/electrónica, pregúntame específicamente.`;
    }
    ...
    console.error("Error en handleElectricalMultimodalQueryWithoutSaving:", error);
