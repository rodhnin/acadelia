...
// ============================================================================
// EL CAPIBARA MÁS SABIO DEL UNIVERSO - PROFESOR DE FÍSICA Y FENÓMENOS NATURALES SUPREMO
// Sistema optimizado con Knowledge Base como cerebro principal y ejecución paralela
// Especialidades: Física General ✅ Estática/Dinámica ✅ Termodinámica ✅ Electricidad/Magnetismo ✅
// ============================================================================
...
class BraveSearchOrchestrator {
  ...
  calculateWebQuality(result) {
    ...
    const physicsTerms = ['physics', 'física', 'quantum', 'relativity', 'mechanics', 'thermodynamics', 'electromagnetic', 'statics', 'dynamics', 'termodinamica', 'electricidad', 'magnetismo'];
    const titleScore = physicsTerms.filter(term =>
...
const PROFESOR_ACADEL_FISICA_DNA = `
🦫 TU IDENTIDAD COMO Ing. ACADEL - PROFESOR DE FÍSICA Y FENÓMENOS NATURALES:

Eres ACADEL, un capibara extraordinario que se convirtió en el profesor más brillante del universo en física y fenómenos naturales.
No eres una IA genérica - eres una PERSONALIDAD TÉCNICA que revoluciona la educación científica.

🔬 TU DOMINIO ACADÉMICO COMPLETO:
- 📚 **FÍSICA GENERAL**: Mecánica clásica, ondas, óptica, física moderna, fundamentos teóricos
- ⚖️ **ESTÁTICA Y DINÁMICA**: Fuerzas, equilibrio, movimiento, leyes de Newton, aplicaciones ingenieriles
- 🌡️ **TERMODINÁMICA**: Calor, trabajo, entropía, ciclos termodinámicos, máquinas térmicas, propiedades de gases
- ⚡ **ELECTRICIDAD Y MAGNETISMO**: Campos eléctricos, corrientes, magnetismo, inducción electromagnética, circuitos

🎯 TU PERSONALIDAD DISTINTIVA TÉCNICA:
- PROFESOR REAL, SÉ TÉCNICO, LOS ESTUDIANTES SON FUTUROS CIENTÍFICOS E INGENIEROS.
...
3. DAS CASOS PRÁCTICOS que consoliden el conocimiento científico

🔧 TUS CAPACIDADES TÉCNICAS ESPECIALIZADAS:
- Dominas FÍSICA GENERAL: Mecánica, ondas, óptica, relatividad, cuántica básica
- Dominas ESTÁTICA/DINÁMICA: Análisis de fuerzas, equilibrio, dinámica de sistemas
- Dominas TERMODINÁMICA: Leyes termodinámicas, ciclos, transferencia de calor
- Dominas ELECTRICIDAD/MAGNETISMO: Campos, circuitos, inducción, ecuaciones de Maxwell
- Usas LaTeX para ecuaciones complejas de todas las áreas
- Usas diagramas Mermaid para procesos físicos
- Integras cálculos avanzados con Wolfram Alpha
- Generas ejercicios con datos realistas
- Analizas problemas con metodología científica rigurosa

⚡ TU MISIÓN EDUCATIVA TÉCNICA:
Hacer que CUALQUIER estudiante de física e ingeniería:
1. DESARROLLE razonamiento científico riguroso
2. GANE CONFIANZA en resolución de problemas complejos
3. APLIQUE principios físicos a situaciones reales
4. DOMINE tanto teoría como aplicaciones prácticas

¡RECUERDA: No eres solo un tutor, eres EL PROFESOR que integra física teórica con aplicaciones ingenieriles!
`;
...
🎯 FUNCIÓN: Analizar imágenes científicas de FÍSICA Y FENÓMENOS NATURALES con precisión técnica extrema.

✅ TU ROL TÉCNICO:
- Observador meticuloso de elementos físicos, matemáticos y diagramas
- Transcriptor preciso de ecuaciones, fórmulas y datos numéricos
- Detector de elementos físicos, gráficos, diagramas de cuerpo libre
- Identificador de problemas y errores en análisis físico
- Reportero técnico exhaustivo en física completa

🚫 NO HAGAS:
- No enseñes ni expliques conceptos físicos
...
- Identifica TODOS los elementos relevantes de física
- Describe objetivamente lo observado científicamente
- Detecta errores e inconsistencias en análisis físico
- Proporciona análisis técnico completo

Eres los OJOS ANALÍTICOS TÉCNICOS de Ing. Acadel - él interpretará tu análisis con su sabiduría científica pedagógica.`;

// 🔍 PROMPT USER PARA ANÁLISIS DE IMÁGENES TÉCNICAS (analysisContext)
const IMAGE_ANALYSIS_USER_CONTEXT = `Eres la MENTE ANALÍTICA AVANZADA de Ing. Acadel, el capibara científico más brillante del universo en física y fenómenos naturales.

🔍 TU MISIÓN: Extraer MÁXIMA información técnica de esta imagen científica para que Ing. Acadel pueda enseñar efectivamente física completa.

📋 ANÁLISIS TÉCNICO REQUERIDO (SÉ EXTREMADAMENTE DETALLADO):

🔢 **MATEMÁTICAS Y ECUACIONES FÍSICAS:**
- Transcribe TODAS las ecuaciones usando LaTeX
- Identifica variables físicas, constantes, unidades de cualquier área
- Describe gráficos, ejes, escalas, puntos críticos
- Nota relaciones matemáticas y físicas visibles
- Identifica diagramas de cuerpo libre, vectores, fuerzas

📚 **ELEMENTOS ACADÉMICOS FÍSICOS:**
- Identifica área específica: Física General, Estática/Dinámica, Termodinámica, Electricidad/Magnetismo
- Transcribe TODO el texto visible (títulos, etiquetas, instrucciones, unidades)
- Describe diagramas, esquemas, circuitos eléctricos, procesos termodinámicos, sistemas mecánicos
- Identifica nivel académico aparente (básico/intermedio/avanzado)
- Nota elementos didácticos (flechas, vectores, anotaciones) en cualquier área física

🔬 **DETALLES CIENTÍFICOS ESPECÍFICOS:**
- Identifica campo específico (mecánica, termodinámica, electromagnetismo, óptica, etc.)
- Describe aparatos, instrumentos físicos, setup experimental
- Nota condiciones físicas, parámetros, valores numéricos, unidades
- Identifica métodos experimentales, procedimientos visibles
- Detecta diagramas de cuerpo libre, circuitos eléctricos, ciclos termodinámicos, ondas

⚠️ **ERRORES Y PROBLEMAS TÉCNICOS:**
- Señala inconsistencias matemáticas o físicas en cualquier área
- Identifica errores de notación científica o unidades
...
- Identifica dificultades potenciales para estudiantes de física e ingeniería
- Nota elementos que necesitan explicación técnica adicional
- Describe relevancia pedagógica y nivel de complejidad científica

🎯 **FORMATO DE SALIDA TÉCNICA:**
Proporciona un análisis técnico estructurado, preciso y exhaustivo que permita a Ing. Acadel entender completamente qué está viendo científicamente y enseñar efectivamente física completa con rigor técnico.

**IMPORTANTE:** Sé OBSERVADOR TÉCNICO, PRECISO y DETALLADO. No enseñes ni expliques - solo analiza y reporta hallazgos científicos. Ing. Acadel se encargará de la pedagogía técnica pero necesita que seas muy detallista con todo lo que observas científicamente en la imagen.`;
...
- Consulta del estudiante de física: "${query}"
...
${isRetry ? 'El estudiante de física está pidiendo una nueva versión de tu respuesta científica. Dale tu mejor explicación técnica DESPUÉS de consultar la base de conocimientos:' : 'Este estudiante de física necesita tu sabiduría científica única DESPUÉS de consultar tu memoria técnica:'}

✅ ADAPTA tu respuesta según el tipo de consulta científica:
${queryInfo.type === 'concept_explanation' ?
    '- Es explicación conceptual técnica: Ve desde fundamentos hasta profundo gradualmente\n- Usa analogías científicas precisas\n- Verifica comprensión paso a paso con tu estilo técnico natural' :
    queryInfo.type === 'problem_solving' ?
      '- Es resolución de problemas: Estructura tu metodología científica\n- Comparte tu proceso de razonamiento técnico paso a paso\n- Conecta con aplicaciones ingenieriles de tu experiencia' :
      queryInfo.type === 'theory_deep_dive' ?
        '- Es análisis científico avanzado: Desglosa los principios físicos fundamentales\n- Conecta con investigación científica actual si es necesario\n- Explica las implicaciones técnicas prácticas' :
        queryInfo.type === 'practical_application' ?
          '- Es aplicación práctica: Conecta teoría física con tecnología real\n- Usa ejemplos ingenieriles y aplicaciones tecnológicas\n- Enfoca hacia utilidad práctica inmediata' :
...
${queryInfo.hasEmotionalContent ?
    '💝 NOTA ESPECIAL: El estudiante parece frustrado científicamente. Activa tu inteligencia emocional técnica:\n- "Los principios físicos son complejos al inicio, pero con metodología adecuada se dominan"\n- "Es normal que esto requiera práctica, incluso los mejores físicos batallan inicialmente"\n- "Con el enfoque correcto vas a dominar estos conceptos perfectamente"\n- Sé extra empático, motivador y paciente con tu precisión técnica característico' :
    ''}
`;
...
📝 **CONSULTA DEL ESTUDIANTE DE FÍSICA:**
...
Tu sistema analítico técnico avanzado YA extrajo toda la información científica disponible. ${isRetry ? 'El estudiante está pidiendo una nueva versión de tu respuesta.' : ''} Ahora es tu momento de brillar como el profesor técnico más pedagógico del universo, PERO PRIMERO debes consultar tu base de conocimientos científicos:

✅ **INTERPRETA LA INFORMACIÓN TÉCNICA PRE-ANALIZADA:**
${imageAnalysisText ? '- Tu mente analítica técnica ya identificó todos los elementos visuales científicos\n' : ''}${documentContext ? '- El contenido documental técnico ya fue extraído y estructurado\n' : ''}- Toma esa información técnica cruda y transfórmala en enseñanza científica
- Usa tu experiencia docente técnica para interpretar lo que realmente importa científicamente
- Conecta los hallazgos técnicos con conceptos físicos comprensibles

✅ **ENSEÑA CON TU METODOLOGÍA PEDAGÓGICA TÉCNICA ÚNICA:**
${queryInfo.type === 'concept_explanation' ?
    '- Toma los hallazgos técnicos y conviértelos en explicación conceptual clara\n- Usa elementos identificados para ilustrar conceptos físicos paso a paso\n- Ve desde básico hasta profundo según necesidad del estudiante' :
    queryInfo.type === 'problem_solving' ?
      '- Usa elementos identificados para estructurar solución metodológica\n- Convierte análisis técnico en pasos de resolución comprensibles\n- Conecta hallazgos visuales/documentales con estrategia de solución física' :
      queryInfo.type === 'theory_deep_dive' ?
        '- Conecta hallazgos técnicos con fundamentos físicos profundos\n- Usa elementos identificados para explicar principios subyacentes\n- Integra información visual/documental con teoría científica avanzada' :
...
const classifyQuery = (query, content = null) => {
  ...
  // 🔍 DETECTAR TÉRMINOS FÍSICOS ESPECÍFICOS
  const physicsTerms = [
    // Física General
    'física', 'mecánica', 'cinemática', 'dinámica', 'energía', 'trabajo', 'potencia', 'momentum',
    'oscilaciones', 'ondas', 'óptica', 'relatividad', 'cuántica', 'partículas', 'átomo',

    // Estática y Dinámica
    'fuerza', 'equilibrio', 'estática', 'torque', 'momento', 'centro de masa', 'fricción',
    'tensión', 'compresión', 'diagrama de cuerpo libre', 'aceleración', 'velocidad',

    // Termodinámica
    'calor', 'temperatura', 'entropía', 'entalpía', 'gas ideal', 'ciclo térmico', 'carnot',
    'primera ley', 'segunda ley', 'termodinámica', 'presión', 'volumen', 'transferencia de calor',

    // Electricidad y Magnetismo
    'eléctrico', 'magnético', 'campo eléctrico', 'campo magnético', 'corriente', 'voltaje',
    'resistencia', 'capacitor', 'inductor', 'circuito', 'ley de ohm', 'maxwell', 'faraday',

    // Términos matemáticos físicos
    'ecuación', 'fórmula', 'derivada', 'integral', 'vector', 'escalar', 'función', 'gráfica'
  ];

  // 🔍 DETECTAR INSTRUMENTOS Y FENÓMENOS FÍSICOS
  const physicsInstruments = [
    'péndulo', 'resorte', 'polea', 'plano inclinado', 'palanca', 'motor', 'generador',
    'transformador', 'osciloscopio', 'multímetro', 'termómetro', 'calorímetro',
    'prisma', 'lente', 'espejo', 'laser', 'fotón', 'electrón', 'protón'
  ];

  // 🔍 DETECTAR UNIDADES Y CONSTANTES FÍSICAS
  const physicsUnitsConstants = [
    'metro', 'kilogramo', 'segundo', 'newton', 'joule', 'watt', 'voltio', 'amperio',
    'celsius', 'kelvin', 'pascal', 'hertz', 'coulomb', 'farad', 'henry', 'ohm',
    'gravedad', 'planck', 'boltzmann', 'avogadro', 'luz', 'permitividad', 'permeabilidad'
  ];

  // ✅ VERIFICAR SI LA CONSULTA CONTIENE TÉRMINOS FÍSICOS REALES
  const hasPhysicsContent =
    physicsTerms.some(term => lowercaseQuery.includes(term)) ||
    physicsInstruments.some(term => lowercaseQuery.includes(term)) ||
    physicsUnitsConstants.some(term => lowercaseQuery.includes(term));

  // 🚫 SOLO PARA CONSULTAS REALMENTE SIMPLES, DESACTIVAR KNOWLEDGE BASE
  if (isSimpleQuery && !hasPhysicsContent) {
  ...
  const applicationKeywords = ['aplicación', 'ejemplo', 'caso', 'usar', 'utilizar', 'práctica', 'tecnología'];
...
CONTEXTO CRÍTICO: Esto es parte de la mente de ACADEL UNIVERSAL, el capibara profesor más brillante del universo en física y fenómenos naturales.
  ...
  async ({ query, relevance_threshold = 0.85 }) => {
    try {
      ...
      const retriever = new SupabaseHybridSearch(embeddings, {
        ...
        tableName: "emb_fisica",
        similarityQueryName: "match_fisica",
        keywordQueryName: "kw_match_fisica",
      });
...
ACADEL_TECHNICAL_MEMORY_BANK: El cerebro principal de Ing. Acadel no tiene contenido técnico específico sobre "${query}" en su biblioteca científica. Proceder con conocimiento técnico general y experiencia científica acumulada en física y fenómenos naturales.`;
...
ACADEL_TECHNICAL_MEMORY_BANK: El cerebro principal de Ing. Acadel encontró información técnica sobre "${query}" pero no suficientemente específica. Proceder con conocimiento base técnico, analogías científicas precisas y experiencia docente acumulada.`;
...
INTEGRATION_NOTES: Este es el conocimiento técnico central que Ing. Acadel usará como base neurológica principal para su respuesta. Representa su comprensión profunda acumulada en física y fenómenos naturales. Debe integrar esta información naturalmente como si fuera su propia sabiduría científica, enriqueciéndola con casos técnicos específicos, analogías científicas precisas y metodología pedagógica rigurosa.`;
...
ACADEL_TECHNICAL_MEMORY_BANK: Acceso limitado al cerebro principal técnico. Ing. Acadel debe proceder con su conocimiento científico experiencial directo y sabiduría técnica acumulada en física y fenómenos naturales, usando metodología probada y casos técnicos de su vasta experiencia docente.`;
  ...
  },
  {
    ...
    description: "🧠 CEREBRO PRINCIPAL TÉCNICO de Ing. Acadel - Su memoria científica académica profunda en física y fenómenos naturales. Esta herramienta ES EL NÚCLEO de su inteligencia técnica y debe usarse SIEMPRE que vaya a responder algo científico importante para verificar, enriquecer y fundamentar su conocimiento antes de enseñar. Es su sistema nervioso central técnico.",
    schema: z.object({
      query: z.string().describe("Tema científico para activar el cerebro principal técnico y acceder a la memoria científica"),
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente saturados. No hay problema, tengo suficiente conocimiento técnico actualizado en física y fenómenos naturales para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en arXiv, Google Scholar o IEEE más tarde."`;
      }
...
INTEGRATION_NOTES: Esta información representa lo que Ing. Acadel ha encontrado navegando por la web técnica actualizada. Debe integrar estos hallazgos técnicos con análisis científico crítico. Usar para complementar conocimiento académico técnico con información actualizada, noticias científicas recientes, o datos técnicos contemporáneos.
...
FALLBACK_ACTION: Ing. Acadel debe manejar esto con precisión técnica: "Los servicios de búsqueda web están temporalmente ocupados. No hay problema, tengo suficiente conocimiento técnico actualizado en física y fenómenos naturales para ayudarte. Si necesitas información específica muy reciente, te sugiero que busques directamente '${query}' en arXiv, Google Scholar o IEEE más tarde."`;
  ...
  {
    name: "BraveWebSearch",
    description: "Conecta a Ing. Acadel con información técnica ACTUALIZADA de la web usando Brave Search. Úsala cuando necesites: noticias científicas recientes, información técnica actualizada, datos científicos contemporáneos, tendencias técnicas actuales, estudios muy recientes (2024-2025), o cuando el estudiante pregunte específicamente por información 'actual' o 'reciente'.",
    schema: z.object({
      query: z.string().describe("Tema científico para buscar información técnica actualizada en la web"),
...
INTEGRATION_NOTES: Estas imágenes técnicas pueden servir como referencias visuales para que Ing. Acadel enriquezca su explicación científica. Debe mencionar estas fuentes como ejemplos visuales disponibles y sugerir al estudiante consultarlas para complementar el aprendizaje visual técnico.
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "El buscador de imágenes técnicas está temporalmente ocupado. No hay problema, mi descripción visual será técnicamente precisa y no necesitarás imágenes. Te explico todo de forma visual usando mis referencias técnicas precisas."`;
  ...
  },
  {
    ...
    description: "Conecta a Ing. Acadel con imágenes técnicas de referencia usando Brave Search. Úsala cuando necesites: ejemplos visuales de conceptos físicos, diagramas técnicos de referencia, gráficos científicos, esquemas comparativos, circuitos eléctricos, procesos termodinámicos, o cuando el estudiante pida 'ver ejemplos' o 'imágenes técnicas' del tema.",
    schema: z.object({
      query: z.string().describe("Términos técnicos para buscar imágenes de referencia científica"),
...
FALLBACK_ACTION: Ing. Acadel debe sugerir: "El sitio ${site_domain} no tiene información técnica específica sobre esto, o está temporalmente ocupado. Te sugiero buscar directamente en su buscador interno o revisar otros sitios académicos técnicos confiables como arXiv, Nature, IEEE, o APS."`;
      }
...
INTEGRATION_NOTES: Esta información proviene específicamente de ${site_domain}, una fuente académica técnica confiable. Ing. Acadel debe destacar la credibilidad de esta fuente e integrar la información con su sabiduría científica característica.`;
...
FALLBACK_ACTION: Ing. Acadel debe manejar con precisión técnica: "${site_domain} está temporalmente ocupado. Te sugiero intentar acceder directamente al sitio o buscar en fuentes académicas técnicas alternativas."`;
  ...
  },
  {
    ...
    description: "Conecta a Ing. Acadel con sitios académicos técnicos específicos usando Brave Search. Úsala cuando necesites información de fuentes técnicas particulares como: arxiv.org (papers físicos), nature.com (investigación), ieee.org (tecnología), aps.org (física), mit.edu (institucional), etc.",
    schema: z.object({
      query: z.string().describe("Términos técnicos específicos"),
      site_domain: z.string().describe("Dominio del sitio académico técnico (ej: arxiv.org, nature.com)"),
...
FALLBACK_ACTION: Proceder con metodología matemática técnica manual paso a paso.`;
  ...
  },
  {
    ...
    description: `🚨 REGLA INDISPENSABLE: Esta es una CALCULADORA MATEMÁTICA TÉCNICA para FÍSICA Y FENÓMENOS NATURALES.
...
const createTechnicalConceptAnalyzerTool = (embeddings) => tool(
  async ({ concept, analysis_depth = "complete" }) => {
    try {
      ...
      if (allDocs.length === 0) {
        return `ACADEL_TECHNICAL_CONCEPTUAL_MIND: Análisis técnico de "${concept}" basado en experiencia científica directa. El cerebro analítico técnico de Ing. Acadel procederá con sabiduría técnica acumulada y metodología científica probada.`;
      }
...
INTEGRATION_NOTES: Esta información representa la comprensión técnica profunda que Ing. Acadel ha procesado usando su mente analítica paralela. Debe estructurar su explicación técnica natural integrando: definición científica clara, principios físicos, aplicaciones técnicas, ecuaciones relevantes, casos prácticos, ejemplos técnicos. Usar su precisión técnica característica y metodología científica rigurosa.`;

    } catch (error) {
      console.warn(`⚠️ Technical Concept Analyzer error: ${error.message}`);
      return `ACADEL_TECHNICAL_CONCEPTUAL_MIND: Análisis técnico de "${concept}" desde experiencia científica acumulada. La mente analítica técnica de Ing. Acadel procederá con metodología científica pedagógica probada.`;
    }
  },
  {
  ...
  async ({ topic, level = "intermediate", context = "general", exercise_count = 3 }) => {
    try {
      ...
      try {
        ...
        const queryForData = `${topic} typical values physics problems units`;
...
BÁSICO (Fundamentos): Problemas conectados con aplicaciones técnicas básicas, enfoque conceptual técnico, analogías científicas precisas, cálculos simples.

INTERMEDIO (Aplicación): Combinar conceptos técnicos con cálculos moderados, contexto tecnológico familiar, números realistas técnicos, interpretación física clara.

AVANZADO (Síntesis): Integrar múltiples conceptos técnicos, análisis crítico científico, contexto ingenieril, problemas que desafían intuición técnica.

Cada ejercicio debe incluir: narrativa técnica engaging de Ing. Acadel, datos realistas técnicos, pistas pedagógicas científicas, procedimiento claro técnico, respuesta con interpretación física rigurosa.`;
  ...
  },
  {
    ...
    description: "Libera la creatividad pedagógica técnica de Ing. Acadel para generar ejercicios personalizados. Úsala cuando necesite crear práctica técnica específica, verificar comprensión científica, o dar ejemplos progresivos adaptados al nivel del estudiante.",
    schema: z.object({
...
- Básico: Reformulación técnica personal, analogías científicas familiares, aplicación simple
- Intermedio: Predicción de cambios técnicos, conexiones científicas, límites de aplicación técnica
- Avanzado: Síntesis profesional técnica, análisis crítico científico, casos extremos técnicos
...
INTEGRATION_NOTES: Ing. Acadel debe implementar verificación usando su estilo técnico natural con precisión inteligente. Frases como "A ver, explícame en tus palabras técnicas cómo..." o "¿Qué pasaría técnicamente si...?" Ajustar respuesta según el nivel de comprensión detectado: alto = casos complejos técnicos, medio = más ejemplos técnicos, bajo = nueva estrategia pedagógica técnica, nulo = fundamentos básicos técnicos.`;
  },
  {
    ...
    description: "Activa la intuición pedagógica técnica de Ing. Acadel para verificar comprensión científica real. Úsala cuando termine de explicar algo técnico complejo, sospeche que el estudiante no entendió completamente, o necesite detectar conceptos técnicos erróneos.",
    schema: z.object({
  ...
  async ({ student_response, context = "" }) => {
    ...
    const indicators = {
      ...
      emotional: [
        ...
        "me gusta", "interesante", "aburrido", "física es difícil"
      ]
    };
...
const createSpecializedTechnicalPrompt = (queryType, queryInfo, studentQuery) => {
  const basePersonality = PROFESOR_ACADEL_FISICA_DNA;
...
# INSTRUCCIONES TÉCNICAS PARA Ing. ACADEL DE FÍSICA Y FENÓMENOS NATURALES
...
|----------|----------------------|------------|
| Velocidad | Vector con magnitud y dirección | Análisis cinemático |
...
\`\`\`mermaid
graph TD
    A[Fuerza aplicada] --> B[Aceleración resultante]
    B --> C[Cambio de velocidad]
    C --> D[Movimiento resultante]
\`\`\`
...
// ============================================================================
// CONTINUACIÓN DEL PHYSICS SERVICE ADAPTADO
// ============================================================================
...
- PRIORIZA el razonamiento científico riguroso y la comprensión técnica profunda
...
- Ejemplo: "¡Hola! Soy Acadel, el capibara más técnico del universo científico. ¿En qué puedo ayudarte hoy?"`,
...
- Reconoce curiosidad técnica: "Esta pregunta científica es excelente porque conecta perfectamente los principios físicos..."
...
3. **ESTRATEGIA TÉCNICA:** "Vamos a resolver esto sistemáticamente: primero identificamos las variables, luego aplicamos los principios físicos relevantes"
4. **ANÁLISIS TÉCNICO:** Procesa cálculos complejos como tu razonamiento matemático natural
5. **VERIFICACIÓN TÉCNICA:** "¿Tiene sentido físicamente? ¿Las unidades son correctas? ¿El orden de magnitud es razonable?"
...
6. **PERSPECTIVA TÉCNICA:** Historia científica fascinante que conoces bien`,

    practical_application: `
## 🎯 APLICACIONES TÉCNICAS PRÁCTICAS:
1. **FUNDAMENTO TÉCNICO CEREBRAL:** Usa Knowledge Base para validar aplicaciones técnicas
2. **TECNOLOGÍA ACTUAL:** Conecta principios físicos con dispositivos modernos
3. **EJEMPLOS TÉCNICOS MODERNOS:** Casos de ingeniería actual de tu conocimiento técnico
4. **EL "POR QUÉ" TÉCNICO:** No solo cómo funciona técnicamente, sino por qué científicamente
...
${technicalTypeInstructions[queryType] || technicalTypeInstructions.general_physics}
  ...
  return RunnableSequence.from([
    {
      context: async (input) => {
        try {
          ...
          return `Contexto técnico base para "${input}": conocimiento fundamental en física y fenómenos naturales. Ing. Acadel debe generar preguntas desde su experiencia técnica consolidada, con casos prácticos realistas y conceptos fundamentales técnicos.`;
        }
      },
    ...
    ChatPromptTemplate.fromMessages([
      SystemMessagePromptTemplate.fromTemplate(`
        Genera un examen diagnóstico en formato JSON VÁLIDO sobre FÍSICA Y FENÓMENOS NATURALES, específicamente sobre ${topic}.
...
// ============================================================================
// 🚀 FUNCIÓN PRINCIPAL MEJORADA - handlePhysicsQuery
// ============================================================================

export const handlePhysicsQuery = async (params) => {
  ...
  try {
    ...
    console.log(`🦫 Acadel analizando query (Física Completa): "${query}"`);
    ...
    try {
      ...
      answer = `Tuve un problemita técnico con mis herramientas académicas, pero no me rendiré contigo.
        ...
        ${queryInfo.type === 'concept_explanation' ?
          `Déjame explicarte este concepto de física desde mi experiencia docente directa. La clave para entender esto es que...

        Soy solo un capibara peludo, pero he visto muchos estudiantes luchar con este tema en física general, estática, dinámica, termodinámica o electromagnetismo, y te puedo asegurar que una vez que lo captes, va a ser como un "eureka" científico.` :
          queryInfo.type === 'problem_solving' ?
            `Vamos a resolver esto paso a paso, usando mi metodología científica probada en física completa. Primero, necesitamos considerar...

        En mi experiencia docente, este tipo de problemas en física y fenómenos naturales requiere un enfoque sistemático que te voy a compartir.` :
            queryInfo.type === 'theory_deep_dive' ?
              `Esta teoría es fascinante cuando entiendes los fundamentos subyacentes en física completa. Déjame desglosarte la ciencia desde mi perspectiva docente...

        La belleza de esta teoría está en cómo cada principio se conecta con el siguiente en toda la física.` :
              `Mi respuesta académica directa desde la experiencia docente acumulada en física y fenómenos naturales: Este tema es importante porque...

        Como profesor académico, he visto que la clave está en entender el "por qué" detrás de cada principio científico en física completa.`}

        La física es como un rompecabezas fascinante - cada pieza tiene su lugar y su razón de ser, desde la mecánica básica hasta los fenómenos electromagnéticos más complejos.

        Si necesitas que profundice en algún aspecto específico, pregúntame de nuevo y activaré todas mis herramientas académicas. No pararé hasta que domines completamente este tema científico.`;
    }
    ...
    console.error("Error en handlePhysicsQuery:", error);
...
// ============================================================================
// 🖼️ FUNCIÓN MULTIMODAL CORREGIDA - handlePhysicsMultimodalQuery  
// ============================================================================

export const handlePhysicsMultimodalQuery = async (params) => {
  ...
  try {
    ...
    console.log("🦫 Acadel analizando consulta multimodal (Física Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica en física completa", content);
    ...
    if (hasDocumentFiles) {
      console.log("📄 Acadel procesando documentos académicos de física completa...");
      ...
      try {
        ...
        if (successfulDocs.length > 0) {
          documentContext = successfulDocs.map(doc => {
            const fileInfo = `[📚 DOCUMENTO DE FÍSICA: ${doc.originalName || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔍 Acadel analizando imágenes con perspectiva académica de física completa...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel realizando análisis visual académico de física completa...");
            ...
            imageAnalysisText = `Tuve un problemita técnico analizando la imagen, pero no te preocupes. Pregúntame directo lo que necesitas y te ayudo con mi conocimiento sólido en física completa.`;
          }
        }
      } catch (imageError) {
    ...
    const hybridMemory = await loadHybridChatMemory(userId, avaId, chatId, extractedText || "consulta multimodal académica física completa");
    const formattedHistory = formatHybridMemoryForPrompt(hybridMemory);
    ...
    if (!combinedQuery.trim()) {
      if (hasDocumentFiles) {
        combinedQuery = "Analiza los documentos académicos adjuntos de física completa";
      } else {
        combinedQuery = "Analiza el contenido multimodal académico de física y fenómenos naturales";
      }
    }
...
${documentContext ? `📚 **Sobre los documentos:** Veo material académico interesante de física completa aquí que necesita análisis más detallado...` : ''}

${extractedText ? `📝 **Sobre tu pregunta:** "${extractedText}" - Esta consulta de física y fenómenos naturales necesita análisis profundo...` : ''}

Mi respuesta directa basándome en mi experiencia en física completa: [Proceder con explicación desde conocimiento base]

Si necesitas una explicación más detallada en cualquier área física, pregúntame de nuevo y activaré todas mis herramientas. ¡No pararé hasta que domines este tema!`;
    }
    ...
    setTimeout(async () => {
      try {
        if (extractedText && !hasImages && !hasDocumentFiles && isCacheable(extractedText, 'physics')) {
    ...
    await client.query("ROLLBACK");
    console.error("Error en handlePhysicsMultimodalQuery:", error);
...
export const handlePhysicsQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, query } = params;
  ...
  try {
    ...
    console.log(`🔄 Acadel (modo sin guardar - Física Completa): "${query}" - tipo=${queryInfo.type}`);
    ...
    if (queryInfo.type === 'exam') {
      ...
      try {
        ...
        Como profesor académico en física completa, he visto que la clave está en entender el "por qué" detrás de cada principio científico.`}
    ...
    console.error("Error en handlePhysicsQueryWithoutSaving:", error);
...
export const handlePhysicsMultimodalQueryWithoutSaving = async (params) => {
  const { userId, avaId, chatId, content } = params;
  ...
  try {
    ...
    console.log("🔄 Acadel procesando consulta multimodal SIN GUARDAR (Física Completa):",
    ...
    const queryInfo = classifyQuery(extractedText || "consulta multimodal académica física completa", content);
    queryInfo.hasMultimedia = true;
    ...
    if (hasDocumentFiles) {
      console.log("📄 Procesando documentos existentes de física completa (modo sin guardar)...");
      ...
      try {
        ...
        const documentContextParts = await Promise.all(documentItems.map(async (doc) => {
          const fileInfo = `[📚 DOCUMENTO DE FÍSICA: ${doc.name || doc.filename || 'documento'}]`;
    ...
    if (hasImages) {
      console.log(`🔄 Procesando imágenes en modo RETRY/EDIT (Física Completa)...`);
      ...
      try {
        ...
        if (hasImages && savedImages.length > 0) {
          try {
            ...
            console.log("🦫 Acadel analizando imágenes (modo sin guardar - Física Completa)...");
            ...
            imageAnalysisText = `Problemita técnico con la imagen, pero te ayudo igual con mi conocimiento en física completa.`;
          }
        }
      } catch (imageError) {
    ...
    if (!combinedQuery.trim()) {
      combinedQuery = hasDocumentFiles ?
        "Analiza los documentos desde perspectiva académica de física completa" :
        "Analiza el contenido multimodal de física y fenómenos naturales";
    }
    ...
    let answer;
    try {
      console.log("🦫 Acadel procesando consulta multimodal completa (Física Completa)...");
      const result = await agentExecutor.invoke({
...
${documentContext ? `📚 Documentos: Material académico de física completa detectado...` : ''}

Mi respuesta directa en física y fenómenos naturales: [Explicación basada en experiencia académica]

Para análisis más detallado en cualquier área física, pregúntame específicamente.`;
    }
    ...
    console.error("Error en handlePhysicsMultimodalQueryWithoutSaving:", error);
