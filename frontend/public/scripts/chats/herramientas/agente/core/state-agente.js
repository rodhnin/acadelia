/**
 * state.js - Módulo optimizado para gestionar el estado global del chat de Agente/Matemáticas
 */

// Estado global de la aplicación
const state = {
  userId: null,
  herramientaId: 2, // ID específico para la herramienta de Agente
  currentChatId: null,
  isProcessing: false,
  chats: new Map(),
  isMathPanelOpen: false, // Estado específico para el panel matemático
  lastInteraction: Date.now(),
  mathHistory: [], // Historial de expresiones matemáticas usadas (para sugerencias)
  preferences: {
    mathNotation: 'latex', // Por defecto usamos LaTeX
    autoPreview: true,
    favorites: []
  }
};
