...
import { getState, getAvaId } from '../core/state-teorico.js';
import { API_ROUTES, URL_CONFIG, getAppConfig } from '../core/config-teorico.js';
import {
  addEvent,
  removeEvent,
  removeAllEvents,
...
import { isChatProblematic } from './chat-error-handler-teorico.js';
