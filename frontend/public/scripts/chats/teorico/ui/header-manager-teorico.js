...
import { updateChatTitle } from '../api/chat-teorico.js';
import { handleNewChat, handleDeleteChat } from '../core/chat-controller-teorico.js';
...
export async function updateHeaderForChat(chatId, silentErrors = false) {
  try {
    ...
    const uiModule = await import('./ui-manager-teorico.js');
