...
import { LATEX_PATTERNS } from '../core/config-matematico.js';
import { renderMath } from './mathjax-config.js';
import { wrapWithDelimiters, processTrigFunctions } from './latex-utils.js';
import {
  createElement,
  setManagedTimeout,
